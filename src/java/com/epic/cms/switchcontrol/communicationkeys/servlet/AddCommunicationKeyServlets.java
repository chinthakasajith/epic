 ...
 * @author asela
 */
public class AddCommunicationKeyServlets extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (validateUserInput(keybean)) {
                        ...
                        try {
                            successInsert = insertCommunicationKeyDetails(keybean);
                            if (successInsert) {
                                this.getKeyBeanList();
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            keybean = new KeyBean();
            System.out.println("id))))) " + request.getParameter("keyid"));
    ...
    public boolean insertCommunicationKeyDetails(KeyBean keyBean) throws Exception {
        boolean success = false;
        try {
            keyManager = new KeyManager();
            success = keyManager.insertCommunicationKeyDetails(keyBean, systemAuditBean);
        } catch (SQLException ex) {
            throw ex;
        }
        return success;

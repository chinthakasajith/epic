 ...
 * @author nalin
 */
public class LoadUpdateResponceCodeMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (ResponceCodeBean newResponceBean : responceList) {

                            if (newResponceBean.getResponceCode().equals(responceCode)) {
                                responceBean = newResponceBean;
                            }
                        }

 ...
 * @author admin
 */
public class UpdateResponceCodeMgtServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (setUserInputToBean(request)) {
                            if (validateUserInput(responceBean)) {
                                ...
                                try {
                                    successUpdate = this.updateResponceCode(responceBean, systemAuditBean);

                                    if (successUpdate) {

                                        request.setAttribute("successMsg", MessageVarList.RESPONCE_CODE_SUCCESS_UPDATE + " " + responceBean.getResponceCode());
    ...
    public boolean updateResponceCode(ResponceCodeBean responceBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            responceManager = new ResponceCodeMgtManager();
            success = responceManager.updateResponceCode(responceBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update Responce Code. Responce Code :" + responceBean.getResponceCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

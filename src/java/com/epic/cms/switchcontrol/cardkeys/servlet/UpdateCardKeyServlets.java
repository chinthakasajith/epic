 ...
 * @author asela
 */
public class UpdateCardKeyServlets extends HttpServlet {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        if (validateUserInput(keybean)) {
                            ...
                            try {
                                successInsert = updateCardKeyDetails(keybean);
                                if (successInsert) {
                                    this.getKeyBeanList();
    ...
    public boolean updateCardKeyDetails(CardKeybean keyBean) throws Exception {
        boolean success = false;
        try {
            keyManager = new CardKeyManager();
            success = keyManager.updateCardKeyDetails(keyBean, systemAuditBean);
        } catch (SQLException ex) {
            throw ex;
        }
        return success;

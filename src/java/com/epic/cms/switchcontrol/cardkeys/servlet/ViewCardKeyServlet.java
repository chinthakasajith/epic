 ...
 * @author asela
 */
public class ViewCardKeyServlet extends HttpServlet {

    private RequestDispatcher rd;
    private SessionVarList sessionVarlist = null;
    private SessionUser sessionUser = null;
    private SystemUserManager systemUserManager = null;
    private String url = "/switch/cardkeys/viewcardkeymanagment.jsp";
            ...
            try {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        for (CardKeyProfilebean cardKeyProfilebean : profilebean) {
    ...
    private void getProfileKeyBeanList(int cardKeyId) throws Exception {
        try {
            keyManager = new CardKeyManager();
            profilebean = keyManager.getProfileKeyBeanList(cardKeyId);
        } catch (Exception ex) {
            throw ex;
        }
    }

 ...
 * @author nalin
 */
public class UpdateAtmPVVAPanelServlet extends HttpServlet {
        ...
        try {
            ...
            if (pvva.length() == 16) {
                if (UserInputValidator.isHexxx(pvva)) {
                    ...
                    try {
                        String KVC = securityModule.getServerMsg(StatusVarList.PVVA_A_PREFIX + pvva).substring(4);
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM PVVA and PVVA KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author nalin
 */
public class UpdateAtmCVVAPanelServlet extends HttpServlet {
        ...
        try {
            ...
            if (cvva.length() == 16) {
                if (UserInputValidator.isHexxx(cvva)) {
                    ...
                    try {
                        String KVC = securityModule.getServerMsg(StatusVarList.CVVA_A_PREFIX + cvva).substring(4);
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM CVVA and CVVA KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author nisansala
 */
public class UpdateAtmPVVPanelServlet extends HttpServlet {
        ...
        try {
            ...
            if (pvvb.length() == 32) {
                if (UserInputValidator.isHexxx(pvvb)) {
                    ...
                    try {
                        KVC = securityModule.getServerMsg(StatusVarList.PVVA_B_PREFIX + pvvb).substring(4);
                         ...
                         String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_ATM);
                          ...
                          if (chanelId == null) {
                            ...
                            if (keyMgtmanager.isChanelAvailable(chanelId)) {
                                 keyMgtmanager.updatePVV(pvvb, KVC, chanelId,systemAuditBean);
                            }else{
                                  keyMgtmanager.addPVV(pvvb, KVC, chanelId,systemAuditBean);
                            }
...
//                rd.forward(request, response);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM PVV and PVV KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

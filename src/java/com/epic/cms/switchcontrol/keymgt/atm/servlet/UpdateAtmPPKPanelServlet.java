 ...
 * @author nalin
 */
public class UpdateAtmPPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM PPK and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

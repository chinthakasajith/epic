 ...
 * @author mahesh_m
 */
public class UpdatePVVBPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PVVB and PVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author mahesh_m
 */
public class UpdateCVVBPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA CVVB and CVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author mahesh_m
 */
public class LoadMaestroKeyMgtServlet extends HttpServlet {
    ...
    private String url = "/switch/keymanagement/maestrokeymanagement.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.MAESTRO_KEY_MGT;

 ...
 * @author mahesh_m
 */
public class UpdateMaestroCVVBPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MAESTRO CVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

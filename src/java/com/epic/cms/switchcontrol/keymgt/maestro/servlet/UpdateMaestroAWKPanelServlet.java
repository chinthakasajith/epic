 ...
 * @author mahesh_m
 */
public class UpdateMaestroAWKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MAESTRO AWK and AWK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

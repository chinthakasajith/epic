 ...
 */
package com.epic.cms.switchcontrol.keymgt.master.servlet;
 ...
 * @author mahesh_m
 */
public class UpdateMasterPVVBPanelServlet extends HttpServlet {
                ...
                if (UserInputValidator.isHexxx(pvvb)) {
                    ...
                    try {
                        ...
                        this.setAudittraceValue(request);
                         ...
                         String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_MASTER);
...
//                rd.forward(request, response);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MASTER PVVB and PVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author asela
 */
public class UpdateCreditProprietaryZMKPanelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (zmk.length() == 32) {
                if (UserInputValidator.isHexxx(zmk)) {
                    securityModule = new ConnectionToSecurityModule();
                    try {
                        String KVC = securityModule.getServerMsg(StatusVarList.ZMK_PREFIX + zmk).substring(4);
                        ...
                        if (chanelId == null) {
                            ...
                            if (keyMgtmanager.isChanelAvailable(chanelId)) {
                                keyMgtmanager.updateZMK(zmk, KVC, chanelId, systemAuditBean);
                            } else {
                                keyMgtmanager.addZMK(zmk, KVC, chanelId, systemAuditBean);
                            }
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update CIRRUS ZMK and ZMK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

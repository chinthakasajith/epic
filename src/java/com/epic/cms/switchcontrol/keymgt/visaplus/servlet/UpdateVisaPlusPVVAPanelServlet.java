 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusPVVAPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS PVVA and PVVA KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

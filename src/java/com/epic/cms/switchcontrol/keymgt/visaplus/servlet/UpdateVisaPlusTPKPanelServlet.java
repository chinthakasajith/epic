 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusTPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS TPK and TPK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusZMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS ZMK and ZMK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

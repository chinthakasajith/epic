 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusAWKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS AWK and AWK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

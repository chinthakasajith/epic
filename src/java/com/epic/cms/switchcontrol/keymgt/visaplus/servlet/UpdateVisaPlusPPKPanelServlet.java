 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusPPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS PPK and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

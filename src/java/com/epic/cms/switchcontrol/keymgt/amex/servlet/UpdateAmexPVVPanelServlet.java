 ...
 * @author nisansala
 */
public class UpdateAmexPVVPanelServlet extends HttpServlet {
        ...
        try {
            ...
            if (pvv.length() == 32) {
                if (UserInputValidator.isHexxx(pvv)) {
                    ...
                    try {
                        String KVC = securityModule.getServerMsg(StatusVarList.PVVA_B_PREFIX + pvv).substring(4);
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update AMEX PVV and PVV_KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

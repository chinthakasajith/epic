 ...
 */
package com.epic.cms.switchcontrol.keymgt.amex.servlet;
 ...
 * @author mahesh_m
 */
public class UpdateAmexPVVBPanelServlet extends HttpServlet {
                ...
                if (UserInputValidator.isHexxx(pvvb)) {
                    ...
                    try {
                        ...
                        this.setAudittraceValue(request);
                         ...
                         String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_AMEX);
...
//                rd.forward(request, response);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update AMEX PVVB and PVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.AMEX_KEY_MGT);

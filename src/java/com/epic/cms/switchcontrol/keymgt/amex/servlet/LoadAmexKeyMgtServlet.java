 ...
 * @author mahesh_m
 */
public class LoadAmexKeyMgtServlet extends HttpServlet {
    ...
    private String url = "/switch/keymanagement/amexkeymanagement.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.AMEX_KEY_MGT;

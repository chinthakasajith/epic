 ...
 * @author mahesh_m
 */
public class UpdateAmexTPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update AMEX TPK and TPK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author nisansala
 */
public class LoadViewFailAlertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.FAILALERT;
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROR_LOAD_FAIL_ALERTS);

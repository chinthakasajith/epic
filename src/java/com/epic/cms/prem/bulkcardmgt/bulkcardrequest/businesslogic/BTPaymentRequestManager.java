 ...
 * @author sajith_g
 */
public class BTPaymentRequestManager {

    private Connection CMSCon;
    private BTPaymentRequestPersistance btPaymentRequestPersistance = null;
    ...
    public List<ECMSOnlineTransBean> getOnlineTransReq(ECMSOnlineTransBean eCMSOnlineTransBean) throws Exception {
        try {
            btPaymentRequestPersistance = new BTPaymentRequestPersistance();
            CMSCon = DBConnectionToOnlineDB.getConnection();
            CMSCon.setAutoCommit(false);
            OnlineTransReqList = btPaymentRequestPersistance.getOnlineTransReq(CMSCon, eCMSOnlineTransBean);
    ...
    public Boolean insertBTPayReq(BTPaymentRequestBean bean, SystemAuditBean systemAuditBean) throws SQLException, Exception {
        String batchId = "";
        try {
            ...
            CMSCon.setAutoCommit(false);
            btPaymentRequestPersistance = new BTPaymentRequestPersistance();
            maxReqId = btPaymentRequestPersistance.insertBTPayReq(bean, CMSCon);

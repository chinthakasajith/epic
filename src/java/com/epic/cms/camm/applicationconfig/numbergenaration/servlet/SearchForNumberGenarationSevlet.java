 ...
 * @author janaka_h
 */
@WebServlet(name = "SearchForNumberGenarationSevlet", urlPatterns = {"/SearchForNumberGenarationSevlet"})
public class SearchForNumberGenarationSevlet extends HttpServlet {
    ...
    private NumberGenarationSearchBean isValildateSeachBean(NumberGenarationSearchBean searchBean) {
        ...
        if (!searchBean.getNameOnCard().isEmpty()) {
            ...
            if (!validater.isNonNumericNonSpecialString(searchBean.getNameOnCard())) {
    ...
    private List<NumberGenarationDataBean> searchNumberGenarationList(NumberGenarationSearchBean searchBean) throws Exception {
      try {
            ...
            searchList = manager.numberGenarationSearch(searchBean);

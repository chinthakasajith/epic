...
////import testingpackege.exampleSessionBean;

/**
 *
 * @author upul
 */
public class AddCreditScoreRuleDefineServlet extends HttpServlet {
     ...
     */
////    @EJB
////    private exampleSessionBean sessionBean;
        ...
        try {
            ...
            if (this.isValidTaskByUser(sessionVarlist.getUserPageTaskList(), taskCode)) {
                ...
                if (this.validateCreditScoreValues()) {
                    ...
                    if (this.insertCreditScoreRule(scoreRuleBean) == 1) {

                        request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.INSERT_CREDITSCORE_RULE_SUCCESS);
                        ...
                        request.setAttribute(MessageVarList.JSP_ERROR, MessageVarList.INSERT_CREDITSCORE_RULE_ERROR);
                        //response.sendRedirect(request.getContextPath() + "/controlpanel/systemusermgt/viewsectionpage.jsp");
...
//////            }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add CreditScore Rule. Rule code: " + uniqueId + " by: " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            if (scoreRuleBean.getRuleCode().contentEquals("") || scoreRuleBean.getRuleCode().length() <= 0) {
                ...
                if (!(scoreRuleBean.getCondition().contentEquals("7"))) {
                    ...
                    if (scoreRuleBean.getValue().contentEquals("") || scoreRuleBean.getValue().length() <= 0) {
                        ...
                        isValidate = false;
                        errorMessage = MessageVarList.CREDITSCORE_VALUE_INVALID + " " + dataType.toLowerCase();
     ...
     * @throws Exception 
     */
    public int insertCreditScoreRule(CreditScoreRuleBean creditScoreRuleBean) throws Exception {
        int success = -1;;
        try {

            defineManagement = new CreditScoreRuleDefineManagement();
            success = defineManagement.insertNewCreditScoreRule(creditScoreRuleBean, systemAuditBean);

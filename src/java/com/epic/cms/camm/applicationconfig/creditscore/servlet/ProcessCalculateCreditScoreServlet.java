 ...
 * @author ayesh
 */
public class ProcessCalculateCreditScoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String searchValues = request.getParameter("searchArray");
            ...
            for (int i = 0; i < searchArray.length; i++) {
                ...
                CardApplicationBean cardApplicationBean =cardScoreManager.getCardApplicationBean(searchArray[i]); 
                int value = creditScoreObj.getCreditScore(searchArray[i],cardApplicationBean);

 ...
 * @author prageeth_s
 */
public class LoadCardAgainstFDApproveDetailsServlet extends HttpServlet {
    ...
    private String url = "/camm/applicationconfirmation/cardAgainstFDapplicationapproveview.jsp";
    ...
    private void getCardApplicationDetails(String applicationId) throws Exception {
        try {
            ...
            if (cardApplicationList.getCreditScore() == null) {
                cardApplicationList.setCreditScore("0");
            }

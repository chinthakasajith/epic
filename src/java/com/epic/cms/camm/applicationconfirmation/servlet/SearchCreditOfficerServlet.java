 ...
 * @author mahesh_m
 */
public class SearchCreditOfficerServlet extends HttpServlet {
    ...
    private String url = "/camm/applicationconfirmation/creditofficertableview.jsp";
...
//            rd.forward(request, response);
    ...
    private void searchAssignApplication(SearchAssignAppBean searchBean) throws Exception {
        ...
        try {
            ...
            confirmationManager = new ApplicationConfirmationManager();
            searchList = confirmationManager.getAllSearchList(searchBean);

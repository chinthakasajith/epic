 ...
 * @author prageeth_s
 */
public class SearchCreditOfficerReviewAndConfirmServlet extends HttpServlet {
...
//                        this.setAudittraceValue(request);
                        if (!confirmationManager.isLetterAvailable(appliactionId)) {
...
//            rd.forward(request, response);
    ...
    private void searchAssignApplication(SearchAssignAppBean searchBean) throws Exception {
        ...
        try {
            searchBean.setIsSearchForReviewAndConfirmation(Boolean.TRUE);
            //set current user role
            searchBean.setCurrentUserRole(sessionUser.getUserRole());
            confirmationManager = new ApplicationConfirmationManager();
            searchList = confirmationManager.getReviewAndConfirmSearchList(searchBean);

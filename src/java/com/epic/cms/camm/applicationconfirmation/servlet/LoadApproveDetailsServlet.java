 ...
 * @author mahesh_m
 */
public class LoadApproveDetailsServlet extends HttpServlet {
...
////                    System.out.println(format.valueToString(creditLimit));
                    ...
                    //creditOfficeRecLimit=
                    // String creditOfficeRecLimitFormatted=df.format((double) creditOfficeRecLimit);

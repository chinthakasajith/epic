 ...
 * @author chanuka
 */
public class UpdateAssignDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.DATAASSIGNUPDATE;
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        this.getDataCaptureUserList(cardCategory);
                    ...
                    if(appAssignBean!=null&& appAssignBean.getCardCategory()!=null){
                        this.getAllIdentificationType();
                        request.setAttribute("identificationList", identificationList);
                    }
                    ...
                    if (this.validateUserInput(appAssignBean, request)) {
                        ...
                        if (this.updateAssignApplication(appAssignBean, systemAuditBean)) {
                            ...
                            rd = getServletContext().getRequestDispatcher("/LoadAssignDataSearchServlet");
                        } else {
...
//        appAssignBean.setAssignStatus(assignStatus);
    ...
    private void getDataCaptureUserList(String cat) throws Exception {
        try {
    ...
    private void setAudittraceValue(HttpServletRequest request, String old, String newV) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.DATAASSIGNUPDATE);

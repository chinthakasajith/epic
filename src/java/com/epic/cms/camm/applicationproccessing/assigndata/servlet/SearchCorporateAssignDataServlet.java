 ...
 * @author asela
 */
public class SearchCorporateAssignDataServlet extends HttpServlet {
    ...
    private String url = "/camm/assigningdata/corporateassignupdate.jsp";
...
//            String domainType = request.getParameter("domainType").trim();
            ...
            searchBean.setApplicationDomain(StatusVarList.CREDIT);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Search card applications User by " + sessionVarlist.getCMSSessionUser().getUserName());

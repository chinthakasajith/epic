 ...
 * @author badrika
 */
public class LoadCorporateCardApplicationServlet extends HttpServlet {
    ...
    private CorporateCardManager corpCardManager;
    ...
    private void getCardCategoriesList() throws Exception {
        try {

            corpCardManager = new CorporateCardManager();
            cardCategoryLst = corpCardManager.getCardCategories();
        } catch (Exception ex) {
            throw ex;
        }
    }

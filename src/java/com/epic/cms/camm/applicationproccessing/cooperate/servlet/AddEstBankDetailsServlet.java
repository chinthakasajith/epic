 ...
 * @author badrika
 */
public class AddEstBankDetailsServlet extends HttpServlet {
        ...
        try {
            ...
            if (sessionVarlist.getSessionBankDetailList() != null) {
                int isadd=0;
                    ...
                    isadd = cdcmanager.insertBankDetailList(sessionVarlist.getSessionBankDetailList(),sessionVarlist.getApplicationId(), systemAuditBean);
                ...
                if (isadd == 1) {
                    ...
                    rd = getServletContext().getRequestDispatcher("/SearchCorporateCardApplicationServlet");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddEstBankDetailsServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

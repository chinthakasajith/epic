 ...
 * @author prageeth_s
 */
public class CorporateVerifyApplicantDetailsServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    Map<String, Boolean> verificationPointValidationMap= configVerificationPointValidationMap("C");
                    ...
                    if (this.validateUserInput(checkedApplicantBean,verificationPointValidationMap)) {
                        ...
                        if (this.isExistCardApplication(checkedApplicantBean.getApplicationId())) {
                            ...
                            this.updateVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_CORPORATE_VERIFY_COMPELTE,appHistoryBean, systemAuditBean);
                            ...
                            this.setAudittraceValue(request);
                            this.insertVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_CORPORATE_VERIFY_COMPELTE, appHistoryBean,systemAuditBean);
    ...
    public void setUserInputToBean(HashMap<String, FileItem> formMap) throws Exception {
        ...
        String empDetails, salaryConfirm, empNic, lengthService, empStatus, fullName, nic, homeTelNo,
                ...
                docsuretyAgreementForm,docboardResolutionForm;
        ...
        try {
            ...
            if (formMap.get("checksuretyAgreementForm") != null) {
                docsuretyAgreementForm = "YES";
            } else {
                docsuretyAgreementForm = "NO";
            }
            ...
            checkedApplicantBean.setSuretyAgreementForm(docsuretyAgreementForm);
    ...
    public boolean validateUserInput(CheckedApplicantDetailsBean checkedBean ,Map<String, Boolean> verificationPointValidationMap) throws Exception {
        ...
        try {
            ...
            if (verificationPointValidationMap.get("SURETYAGREEMENTFORM") != null && verificationPointValidationMap.get("SURETYAGREEMENTFORM")) {
                if (checkedBean.getSuretyAgreementForm().contentEquals("NO")) {
                    isValid = false;
                    errorMessage = MessageVarList.SURETYAGREEMENTFORM_VERIFY_NOTMATCH;
                    selectedTab = "1";
                }
            }

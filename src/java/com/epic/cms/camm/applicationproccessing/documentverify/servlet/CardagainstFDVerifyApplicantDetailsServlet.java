 ...
 * @author prageeth_s
 */
public class CardagainstFDVerifyApplicantDetailsServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    Map<String, Boolean> verificationPointValidationMap= configVerificationPointValidationMap("F");
                    ...
                    if (this.validateUserInput(checkedApplicantBean,verificationPointValidationMap)) {
                        ...
                        if (this.isExistCardApplication(checkedApplicantBean.getApplicationId())) {
                            ...
                            this.updateVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_FIXED_VERIFY_COMPELTE,appHistoryBean, systemAuditBean);
                            ...
                            this.setAudittraceValue(request);
                            this.insertVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_FIXED_VERIFY_COMPELTE, appHistoryBean,systemAuditBean);

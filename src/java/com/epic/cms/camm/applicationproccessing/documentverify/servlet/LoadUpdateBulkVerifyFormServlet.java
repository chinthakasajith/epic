 ...
 * @author chanuka
 */
public class LoadUpdateBulkVerifyFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < uploadedDocumentTypeList.size(); i++) {
                ...
                if (uploadedDocumentTypeList.get(i).getDocumentType().equals("sign")) {
                    sessionVarlist.setPersonalSignatureBean(uploadedDocumentTypeList.get(i));
                }
//                if (uploadedDocumentTypeList.get(i).getDocumentType().equals("NIC")) {
//                    sessionVarlist.setJointSignatureBean(uploadedDocumentTypeList.get(i));
//                }
//                if (uploadedDocumentTypeList.get(i).getDocumentType().equals("sign")) {
//                    sessionVarlist.setJointSignatureBean(uploadedDocumentTypeList.get(i));
//                }

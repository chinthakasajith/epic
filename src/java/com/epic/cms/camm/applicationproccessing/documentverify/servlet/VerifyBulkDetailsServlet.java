 ...
 * @author chanuka
 */
public class VerifyBulkDetailsServlet extends HttpServlet {
    ...
    private String url = "/camm/documentverification/bulkverifyviewhome.jsp";
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (option.equals("verify")) {
                        ...
                        if (this.validateUserInput(verifyBean)) {


                            if (this.isExistCardApplication(verifyBean.getApplicationId())) {

                                this.setAudittraceValue(request,"Verify");
                                ...
                                rd = request.getRequestDispatcher("/LoadBulkCardVerifySearchServlet");
                            } else {
                    ...
                    if (option.equals("reject")) {
                        ...
                        if (this.isExistCardApplication(verifyBean.getApplicationId())) {
                            ...
                            this.setAudittraceValue(request,"Reject");
    ...
    public void setUserInputToBean(HttpServletRequest request) throws Exception {
        String appliactionId,id, name, accNo;
        try {
            
            appliactionId = request.getParameter("appliactionid");
            ...
            verifyBean.setApplicationId(appliactionId);
    ...
    public boolean validateUserInput(DebitVerifyBean cardBean) throws Exception {
        boolean isValidate = true;

        try {
            
            if (cardBean.getAccontNo().contentEquals("NO")) {
                isValidate = false;
    ...
    private void setAudittraceValue(HttpServletRequest request,String option) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription(option +" bulk card application " + verifyBean.getApplicationId() + " by " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.BULKVERIFYHOME);

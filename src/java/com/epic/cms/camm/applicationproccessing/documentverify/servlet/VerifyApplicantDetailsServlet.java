 ...
 * @author chanuka
 */
public class VerifyApplicantDetailsServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    String staffStatus="";
                    if(formMap.get("staffStatus")!=null){
                        staffStatus=formMap.get("staffStatus").getString();
                    }
                    Map<String, Boolean> verificationPointValidationMap= configVerificationPointValidationMap("M",staffStatus);
                    ...
                    if (this.validateUserInput(checkedApplicantBean,verificationPointValidationMap)) {
                        ...
                        if (this.isExistCardApplication(checkedApplicantBean.getApplicationId())) {
                            ...
                            this.updateVerifyDetailsOfApplication(checkedApplicantBean, "VCOM",appHistoryBean, systemAuditBean);
                            ...
                            this.setAudittraceValue(request);
                            this.insertVerifyDetailsOfApplication(checkedApplicantBean, "VCOM", appHistoryBean,systemAuditBean);
    ...
    public boolean validateUserInput(CheckedApplicantDetailsBean checkedBean ,Map<String, Boolean> verificationPointValidationMap) throws Exception {
        ...
        try {
            ...
            if (cribFile == null) {
                isValid = false;
                errorMessage = MessageVarList.CRIBFILE_UPLOAD_FAIL;
                selectedTab = "2";
            }
            ...
            if (verificationPointValidationMap.get("DOCSTAFFDECFORM")!=null && verificationPointValidationMap.get("DOCSTAFFDECFORM")) {
    ...
    private Map<String, Boolean> configVerificationPointValidationMap(String cardCategoryCode, String staffStats) throws Exception{
        ...
        try{    
            ...
            if (staffStats != null && staffStats.equals("YES")) {
                for (VerificationPointsBean bean : verificationPointsBeanList) {
                    if (bean.getIsStaff() != null && bean.getIsStaff().equals("YES")) {
                        map.put(bean.getFieldName(), bean.getIsMandatory());
                    }
                }
            }else{
                for (VerificationPointsBean bean : verificationPointsBeanList) {
                    if(bean.getIsStaff()==null || bean.getIsStaff().equals("NO") || bean.getIsStaff().isEmpty()){
                        map.put(bean.getFieldName(), bean.getIsMandatory());
                    }

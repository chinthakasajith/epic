 ...
 * @author prageeth_s
 */
public class CorporateOnholdApplicationDetailsServlet extends HttpServlet {
    ...
    public void setUserInputToBean(HashMap<String, FileItem> formMap) {
        ...
        String empDetails, salaryConfirm, empNic, lengthService, empStatus, fullName, nic, homeTelNo,
                ...
                docUtiityBill, docMarriageCertificate, docBirthCertificate,docSalarySlip1,
                docSalarySlip2,docStaffDecForm,docBankStatement,collateralConfirmationLetter,

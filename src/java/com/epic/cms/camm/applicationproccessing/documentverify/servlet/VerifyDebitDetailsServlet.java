 ...
 * @author chanuka
 */
public class VerifyDebitDetailsServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (option.equals("onhold")) {
                        ...
                        if (this.isExistCardApplication(verifyBean.getApplicationId())) {
                            ...
                            this.setAudittraceValue(request, "Onhold");
    ...
    public void setUserInputToBean(HttpServletRequest request) throws Exception {
        String appliactionId, docid, id, name, accNo;
        try {
    ...
    private void setAudittraceValue(HttpServletRequest request, String option) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription(option + " debit card application, application id: " + verifyBean.getApplicationId() + " by " + sessionVarlist.getCMSSessionUser().getUserName());

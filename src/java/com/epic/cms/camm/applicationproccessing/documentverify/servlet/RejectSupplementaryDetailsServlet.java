 ...
 * @author chanuka
 */
public class RejectSupplementaryDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.isExistCardApplication(checkedSupplementaryBean.getApplicationId())) {
                        ...
                        this.updateVerifyDetailsOfApplication(checkedSupplementaryBean, "VREJ", systemAuditBean);
                        ...
                        this.setAudittraceValue(request);
                        this.insertVerifyDetailsOfApplication(checkedSupplementaryBean, "VREJ", systemAuditBean);

                        //request.setAttribute("selectedtab", "2");
                        //request.setAttribute("successMsg3", MessageVarList.SUCCES_DOC_REJECT);
            ...
            request.setAttribute("selectedtab", "2");
            request.setAttribute("errorMsg3", MessageVarList.ERROR_ONHOLD_DOC);
            rd = request.getRequestDispatcher(url);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Reject credit card application, application id: " + checkedSupplementaryBean.getApplicationId() + " by " + sessionVarlist.getCMSSessionUser().getUserName());

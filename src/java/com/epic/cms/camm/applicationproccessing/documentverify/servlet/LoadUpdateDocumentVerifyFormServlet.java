 ...
 * @author chanuka
 */
public class LoadUpdateDocumentVerifyFormServlet extends HttpServlet {
...
//    private String url = "/camm/documentverification/imageviewhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getBankApplicationVerifyDetails("M"); 
    ...
    private void getAllDetailsCustomer(String applicationId) throws Exception {
        ...
        try {
            ...
            verifyCusDetailsBean = documentVerifyManager.getAllVerifyCustomerDetails(applicationId,"M");

 ...
 * @author chanuka
 */
public class SearchDocumentVerifyServlet extends HttpServlet {
    ...
    private String url = "/camm/documentverification/documentverifyhome.jsp";
...
//////                        this.setAudittraceValue(request);
    ...
    private void searchAssignApplication(SearchDocumentVerifyBean searchBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            searchList = documentVerifyManager.getAllDocumentVerifyList(searchBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Search document verification User by " + sessionVarlist.getCMSSessionUser().getUserName());

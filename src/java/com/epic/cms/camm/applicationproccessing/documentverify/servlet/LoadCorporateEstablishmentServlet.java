 ...
 * @author ruwan_e
 */
public class LoadCorporateEstablishmentServlet extends HttpServlet {
    ...
    private String url = "/camm/documentverification/corporateestablishment.jsp";
//    private String url = "/camm/documentverification/imageviewhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // get Application Verification Details
            this.getApplicantVerificationDetails(applicationId);
    ...
    private void getAllDetailsCustomer(String applicationId) throws Exception {

        try {

            documentVerifyManager = new DocumentVerifyManager();
            verifyCusDetailsBean = documentVerifyManager.getAllVerifyCustomerDetails(applicationId,"C");
    ...
    private void getVerificationPoints() throws Exception {

        try {

            documentVerifyManager = new DocumentVerifyManager();
            verificationPointsBeanList = documentVerifyManager.getVerificationPoints("C");
    ...
    private void getApplicantVerificationDetails(String applicationId) throws Exception {
        try {

            documentVerifyManager = new DocumentVerifyManager();
            applicationVerificationBean = documentVerifyManager.getApplicantVerificationDetails(applicationId);
            sessionVarlist.setApplicationVerificationBean(applicationVerificationBean);

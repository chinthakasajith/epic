 ...
 * @author prageeth_s
 */
public class LoadCArdAgainstFDApplicationCheckingServlet extends HttpServlet {
    ...
    private String url = "/camm/applicationchecking/cardAgainstFDApplicationchecking.jsp";

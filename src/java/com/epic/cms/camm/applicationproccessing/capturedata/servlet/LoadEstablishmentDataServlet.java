 ...
 * @author prageeth_s
 */
public class LoadEstablishmentDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                ...
                establishmentDetailsBean = (EstablishmentDetailsBean) request.getAttribute("establishmentDetailsBean");
...
//            rd = getServletContext().getRequestDispatcher(url);
    ...
    public List<AssetLiabilityTypeBean> getAssetsLiabilityTypeList() throws Exception {
        try { 
            assetsLiabilityTypeList = manager.getAssetsLiabilityTypeList();
        } catch (Exception ex) {
            throw ex;
        }
    ...
    public List<AssetBean> getAssetsList() throws Exception {
        try { 
            assetsList = manager.getAssetsList();
        } catch (Exception ex) {
            throw ex;
        }
        return assetsList;
    ...
    public List<LiabilityBean> getLiabilityList() throws Exception {
        try { 
            liabilityList = manager.getLiabilityList();
        } catch (Exception ex) {
            throw ex;
        }

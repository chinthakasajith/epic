 ...
 * @author janaka_h
 */
public class RemoveIncomeDataToSessionServlet extends HttpServlet {
...
//
            ...
            for (int j = 0; j < sessionVarlist.getSessionIncomeList().size(); j++) {
                if (sessionVarlist.getSessionIncomeList().get(j).getIncomeCatogaryCode().equals(request.getParameter("category"))) {
...
//            this.getAllDocumentDetails(appliactionId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveIncomeDataToSessionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

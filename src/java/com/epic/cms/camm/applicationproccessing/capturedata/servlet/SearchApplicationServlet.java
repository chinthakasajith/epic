...
public class SearchApplicationServlet extends HttpServlet {
    ...
    private ApplicationCheckingManager applicationChecking;
    ...
    private void searchAssignApplication(SearchAssignAppBean searchBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            applicationChecking = new ApplicationCheckingManager();
            searchList = applicationChecking.getAllSearchList(searchBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setSectionCode(SectionVarList.APPLICATIONCHEKING);

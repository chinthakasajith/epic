...
//
            ...
            expenseBean.setRemark(request.getParameter("remark3"));
...
//
            ...
            if (invalidExpenseBean ==null) {
                ...
                if (isAdd == 1) {
                    ...
                    checkingManager.addRemarks(applicationId, "3", expenseBean.getRemark(), expenseBean.getLastUpdateduser());

                    this.loadDefaultApplicationStatus(applicationId, request);
                    request.setAttribute("successMsg", "Sucssesfully updated Customer income and expenses details.");
                    ...
                    this.loadDefaultApplicationStatus(applicationId, request);
                    request.setAttribute("errorMsg", "Faild upadti Customer employment details.");
...
//-------------------------------------------------------------------------------------------------------
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateIncomeExpensesServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 * @author janaka_h
 */
public class ApplicationCompleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                if (cardAppCategoryCode != null && cardAppCategoryCode.equals(StatusVarList.CARD_AGAINST_FD_CODE)) {
            ...
            if (cardAppCategoryCode.equals(StatusVarList.CARD_CATEGORY_MAIN)) {
            ...
            if (invalidRecBean == null) {
                ...
                int isAdd = manager.insertSignatureAndComplete(sessionVarlist.getApplicationId(), sessionVarlist.getApplicationId() + "_SIGNATURE.JPG", systemAuditBean, recDetailsBean,cardAppCategoryCode);

                if (isAdd == 1) {
                    request.setAttribute("successMsg", "Application initiation process completed successfully");
                    rd = getServletContext().getRequestDispatcher("/SearchUserAssignDataServlet");
//                    rd.forward(request, response);
                    ...
                    if (sessionVarlist.getCardCategory().equals(StatusVarList.MAIN)) {
                        ...
                        rd = getServletContext().getRequestDispatcher(url);
                    } else if (sessionVarlist.getCardCategory().equals(StatusVarList.CARD_AGAINST_FD)) {
                        ...
                        rd = getServletContext().getRequestDispatcher(url);
                    } else if (sessionVarlist.getCardCategory().equals(StatusVarList.ESTABLISHMENT)) {
...
//            this.getAllDocumentDetails(appliactionId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ApplicationCompleteServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

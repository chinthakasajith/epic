 ...
 * @author prageeth_s
 */
public class LoadEstablishmentApplicationCheckingServlet extends HttpServlet {
    ...
    private String url = "/camm/applicationchecking/establishmentApplicationchecking.jsp";
        ...
        try {
            ...
            try {
                ...
                if (checkOutStatus) {
                    ...
                    request.setAttribute("establishmentAssetList", establishmentAssetList);
                    request.setAttribute("establishmentLiabilityList", establishmentLiabilityList);
     ...
     private void getEmployementDetails(String applicationId) throws Exception {
        try {
            ...
            if(employementDetails.getAnnualTurnOver() == null){
                employementDetails.setAnnualTurnOver("-");
            }
            ...
            if(employementDetails.getNetProfit() == null){
                employementDetails.setNetProfit("-");
            }

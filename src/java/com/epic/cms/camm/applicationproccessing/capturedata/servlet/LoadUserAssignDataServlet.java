 ...
 * @author chanuka
 */
public class LoadUserAssignDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (back != null) {
                ...
                sessionVarlist.setUserAssignAppBeanList(null);
            }

            this.getAllPriorityLevelList();
            this.getCreditCardCategoryList();
    ...
    private void getCreditCardCategoryList() throws Exception {
        try {

            cardTypeManager = CardTypeMgtManager.getInctance();
            cardCategoryLst = cardTypeManager.getCreditCardCategory();
        } catch (Exception ex) {
            throw ex;
        }
    }

 ...
 * @author janaka_h
 */
public class SearchUserModifyDataServlet extends HttpServlet {
    ...
    private String url = "/camm/capturedata/applicationModifySearch.jsp";
...
//                        this.setAudittraceValue(request);
                        ...
                        this.userModufyApplicationsSearch(searchBean, systemAuditBean);
    ...
    private void userModufyApplicationsSearch(SearchUserAssignAppBean searchBean, SystemAuditBean systemAuditBean) throws Exception {

        try {

            captureDataManager = new CaptureDataManager();
            searchList = captureDataManager.userModifyApplicationsSearch(searchBean, systemAuditBean);
            sessionVarlist.setUserAssignAppBeanList(searchList);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Search user assigned card applications User by " + sessionVarlist.getCMSSessionUser().getUserName());

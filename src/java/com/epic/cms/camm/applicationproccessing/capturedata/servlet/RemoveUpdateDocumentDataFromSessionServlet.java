 ...
 * @author janaka_h
 */
public class RemoveUpdateDocumentDataFromSessionServlet extends HttpServlet {
...
//
            ...
            for (int j = 0; j < sessionVarlist.getSessionDocumentList().size(); j++) {
                if (sessionVarlist.getSessionDocumentList().get(j).getFileName().equals(request.getParameter("filename"))) {
                    sessionVarlist.getSessionDocumentList().remove(j);
                    break;
                }
...
//                sessionVarlist.setSessionDocumentList(documentDetailsBeanLst);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveUpdateDocumentDataFromSessionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

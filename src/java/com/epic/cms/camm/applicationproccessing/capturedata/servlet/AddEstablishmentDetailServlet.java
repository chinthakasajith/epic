 ...
 * @author prageeth_s
 */
public class AddEstablishmentDetailServlet extends HttpServlet {
...
//                    
                    ...
                    request.setAttribute("successMsg", MessageVarList.ADD_ESTABLISHMENT_SUCCESS);
    ...
    private void loadDefaultApplicationStatus(String appliactionId, HttpServletRequest request) throws Exception {
        ...
        if (appStatusBean != null) {
            ...
            if (appStatusBean.getApplicationStatus().equals(StatusVarList.APP_INITIATE) || appStatusBean.getApplicationStatus().equals(StatusVarList.APP_PROCESS)) {
                ...
                LoadApplicationStatus.loadDefaultEstablishmentApplicationStatus(appliactionId, sessionVarlist, request, Boolean.FALSE,idbean,null);
            }

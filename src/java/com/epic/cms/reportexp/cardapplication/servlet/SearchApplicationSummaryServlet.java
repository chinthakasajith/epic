 ...
 * @author nisansala
 */
public class SearchApplicationSummaryServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    this.getApplicationSummary(inputBean);
                    request.setAttribute("appBean", inputBean);

                    request.setAttribute("searchList", searchList);
                    //set to session to use in jasper report
                    sessionVarlist.setAppSummaryReport(searchList);
    ...
    public void setUserInputToBean(HttpServletRequest request) {
        ...
        inputBean = new ApplicationSummaryBean();
        ...
        inputBean.setStatusCode(request.getParameter("status"));
        inputBean.setFromDate(request.getParameter("fromdate"));
        inputBean.setToDate(request.getParameter("todate"));
        //input bean is set to session
        sessionVarlist.setAppSumBean(inputBean);   
    }

 ...
 * @author nalin
 */
public class ViewApplicationCreditScoreBreakDownServlet extends HttpServlet {
    ...
    private String url = "/reportexp/cardapplication/viewapplicationcreditscorebreakdown.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getApplicationCreditScoreDetails(applicationID);
    ...
    private void getApplicationCreditScoreDetails(String applicationId) throws Exception {
        ...
        try {
            ...
            creditScoreList = crditScoreManager.getApplicationCreditScoreDetails(applicationId);

 ...
 * @author nisansala
 */
public class SearchCardStatusReportServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    this.getUser();
                    request.setAttribute("embossUser", userList);
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROR_CD_STATUS_REPORT);

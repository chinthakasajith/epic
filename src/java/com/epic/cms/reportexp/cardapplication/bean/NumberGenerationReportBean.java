 ...
 * @author asela
 */
public class NumberGenerationReportBean {
    ...
    private String cardDomainDes;
    private String ganeratedDate;
    ...
    public void setCardStatusDes(String cardStatusDes) {
        this.cardStatusDes = cardStatusDes;
    }
    ...
    public String getCardDomainDes() {
        return cardDomainDes;
    }

    public void setCardDomainDes(String cardDomainDes) {
        this.cardDomainDes = cardDomainDes;
    }

    public String getGaneratedDate() {
        return ganeratedDate;
    }

    public void setGaneratedDate(String ganeratedDate) {
        this.ganeratedDate = ganeratedDate;
    }
    ...
    public void setIdTypeDes(String idTypeDes) {
        this.idTypeDes = idTypeDes;
    }

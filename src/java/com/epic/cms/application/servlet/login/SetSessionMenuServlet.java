 ...
 * @author janaka_h
 */
public class SetSessionMenuServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (!userManager.validateUserSession(CMSSessionUser.getUserName(), sessionObj.getId())) {
            ...
            sessionVarList.setLoggedApplicationDes(userManager.getapplicationDes(applicationType));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SetSessionMenuServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

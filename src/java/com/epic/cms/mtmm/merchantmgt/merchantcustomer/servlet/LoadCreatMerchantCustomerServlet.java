 ...
 * @author nalin
 */
public class LoadCreatMerchantCustomerServlet extends HttpServlet {
        ...
        try {
            try {
                ...
                try {
                    ...
                    merchantBean.setRedempoint(this.getCommonParaRedemValue());
    ...
    private String getCommonParaRedemValue() throws Exception {
        String redemPoint = null;
        try {

            merCusManager = new MerchantCustomerManager();
            redemPoint = merCusManager.getCommonParaRedemValue();

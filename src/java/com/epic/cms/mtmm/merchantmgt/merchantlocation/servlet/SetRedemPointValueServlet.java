 ...
 * @author nalin
 */
public class SetRedemPointValueServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String merchantCusNum = request.getParameter("selectMerchantCus");
            ...
            try {
                ...
                redemPoint = merchantLocManager.getRedemPointValue(merchantCusNum);
               
                
                
                jCombo.put("combo1", redemPoint);
                out.print(jCombo);
            } catch (Exception e) {
            }

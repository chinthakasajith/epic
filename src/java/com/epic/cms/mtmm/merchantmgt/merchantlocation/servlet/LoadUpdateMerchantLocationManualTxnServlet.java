 ...
 * @author nalin
 */
public class LoadUpdateMerchantLocationManualTxnServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getMerchantManualTerminalData(merchantId);
    ...
    private MerchantLocManualTxnBean getMerchantManualTerminalData(String merchantId) throws Exception {
        try {

            merchantLocManager = new MerchantLocationManager();
            manualBean = new MerchantLocManualTxnBean();

            manualBean = merchantLocManager.getMerchantManualTerminalData(merchantId);

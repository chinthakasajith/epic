 ...
 * @author nalin
 */
public class ProceedVoidTxnServlet extends HttpServlet {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.VOID_TRANSACTION);
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            voidBean.setMerchantID(request.getParameter("merchantID").trim());
            voidBean.setMerchantName(request.getParameter("merchantName").trim());
            voidBean.setTerminalID(request.getParameter("terminalID").trim());

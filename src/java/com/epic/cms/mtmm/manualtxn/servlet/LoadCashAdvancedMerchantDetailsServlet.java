 ...
 * @author nalin
 */
public class LoadCashAdvancedMerchantDetailsServlet extends HttpServlet {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            ...
                            if (this.validateUserInput(merchantID)) {
                                ...
                                this.getTerminalTxnInfo(this.getCommonManualTerminal(), cashAdvancedBean.getMerchantID());
                                this.getCardTypes();
                                this.getCurrency();
    ...
    private SaleTxnBean getMerchantDetails(String merchantID) throws Exception {
        ...
        try {
            ...
            cashAdvancedBean = saleTxnManager.getMerchantDetails(merchantID);

        } catch (Exception ex) {
            throw ex;
        }
        return cashAdvancedBean;

 ...
 * @author nalin
 */
public class LoadSaleTxnInfoServlet extends HttpServlet {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            ...
                            if (this.validateUserInput(saleTxnBean.getMerchantID())) {
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            saleTxnBean.setMerchantID(request.getParameter("merchantID"));
            saleTxnBean.setMerchantName(request.getParameter("merchantName"));
            saleTxnBean.setTerminalID(request.getParameter("terminalID"));

 ...
 * @author nalin
 */
public class ViewSaleTxnServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            detailsBean = saleTxnManager.getTxnDetails(txnId, tid, mid);

            sessionObj.setAttribute("detailsBean", detailsBean);

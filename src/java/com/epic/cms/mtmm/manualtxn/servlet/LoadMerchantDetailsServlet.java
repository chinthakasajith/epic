 ...
 * @author nalin
 */
public class LoadMerchantDetailsServlet extends HttpServlet {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            ...
                            if (this.validateUserInput(merchantID)) {
                                ...
                                this.getTerminalTxnInfo(this.getCommonManualTerminal(), saleTxnBean.getMerchantID());
                                this.getCardTypes();
                                this.getCurrency();
    ...
    private SaleTxnBean getMerchantDetails(String merchantID) throws Exception {
        ...
        try {
            ...
            saleTxnBean = saleTxnManager.getMerchantDetails(merchantID);

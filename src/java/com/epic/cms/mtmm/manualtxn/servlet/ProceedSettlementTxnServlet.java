 ...
 * @author nalin
 */
public class ProceedSettlementTxnServlet extends HttpServlet {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.SETTLEMENT_TRANSACTION);
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            settlementBean.setMerchantID(request.getParameter("merchantID").trim());
            settlementBean.setMerchantName(request.getParameter("merchantName").trim());
            settlementBean.setTerminalID(request.getParameter("terminalID").trim());

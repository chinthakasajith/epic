 ...
 * @author nalin
 */
public class LoadSettlementMerchantDetailsServlet extends HttpServlet {
    ...
    private SaleTxnBean settlememtBean = null;
    private HashMap<String, String> terminalList = null;
    private String errorMessage = null;
    private SaleTxnManager saleTxnManager = null;
    private List<SaleTxnBean> settlememtList = null;
    private String url = "/mtmm/manualtxn/settlementtxnhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                try {
                    ...
                    String pageCode = PageVarList.SETTLEMENT_TRANSACTION;
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            ...
                            if (this.validateUserInput(merchantID)) {
                                ...
                                this.getManualTerminalTxnInfoToSettle(this.getCommonManualTerminal(), merchantID);

                                request.setAttribute("settlememtBean", settlememtBean);
                                request.setAttribute("settlememtList", settlememtList);
     ...
     private SaleTxnBean getMerchantDetails(String merchantID) throws Exception {
        ...
        try {
            settlememtBean = new SaleTxnBean();
            saleTxnManager = new SaleTxnManager();

            settlememtBean = saleTxnManager.getMerchantDetails(merchantID);

        } catch (Exception ex) {
            throw ex;
        }
        return settlememtBean;
    ...
    private List<SaleTxnBean> getManualTerminalTxnInfoToSettle(String terminalID, String merchantId) throws Exception {
        ...
        try {
            settlememtList = new ArrayList<SaleTxnBean>();
            saleTxnManager = new SaleTxnManager();

            settlememtList = saleTxnManager.getManualTerminalTxnInfoToSettle(terminalID, merchantId);

        } catch (Exception ex) {
            throw ex;
        }
        return settlememtList;

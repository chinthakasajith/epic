...
/**
 * to search terminal data as needed
 * @author nisansala
 */
public class SearchTerminalDataCaptureServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.validateUserInput(terminalBean, request)) {
    ...
    public boolean validateUserInput(TerminalDataCaptureBean terminalBean, HttpServletRequest request) throws Exception {
        ...
        if (!UserInputValidator.isAlphaNumeric(terminalBean.getTerminalID())) {
        isValid = false;
        errorMessage = MessageVarList.TERMINAL_MGT_TRMNLID_INVALID;
        }
        else if (!UserInputValidator.isAlphaNumeric(terminalBean.getMerchantID())) {
        isValid = false;
        errorMessage = MessageVarList.TERMINAL_ALLOCATION_INVALID_MERCHANTID;
        }
        else if (!UserInputValidator.isAlphaNumeric(terminalBean.getName())) {
        isValid = false;

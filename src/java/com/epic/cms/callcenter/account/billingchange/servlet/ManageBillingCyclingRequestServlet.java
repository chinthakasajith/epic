...
package com.epic.cms.callcenter.account.billingchange.servlet;
 ...
 * @author sajith_g
 */
public class ManageBillingCyclingRequestServlet extends HttpServlet {
    ...
    private EasyPaymentRequestManager easyPaymentRequestManager;
    String errorMessage = "";
    List<ECMSOnlineTransBean> BillingCyclingReqList = null;
    ...
    String url = "/callcenter/account/billingcyclingrequest.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.BILLINGCYCLE_CHANGE_REQUEST;
                    ...
                    try {
                        ...
                        if (validateUserInput(eCMSOnlineTransBean)) {
                            ...
                            try {
                                ...
                                request.setAttribute("easyPaymentReqList", BillingCyclingReqList);
    ...
    private void getAllCardTrnByCardNo(ECMSOnlineTransBean eCMSOnlineTransBean) throws Exception {
        try {
            ...
            BillingCyclingReqList = easyPaymentRequestManager.getOnlineTransReq(eCMSOnlineTransBean);
        } catch (Exception ex) {
            throw ex;
        }
    }
    ...
    public boolean validateUserInput(ECMSOnlineTransBean eCMSOnlineTransBean) throws Exception {
        ...
        try {
            if (eCMSOnlineTransBean.getToAmount().contentEquals("") && !eCMSOnlineTransBean.getFromAmount().contentEquals("")) {
                isValidate = false;
                errorMessage = MessageVarList.EPR_AMOUNT_NULL;
            }
            if (!eCMSOnlineTransBean.getToAmount().contentEquals("") && eCMSOnlineTransBean.getFromAmount().contentEquals("")) {
                isValidate = false;
                errorMessage = MessageVarList.EPR_AMOUNT_NULL;

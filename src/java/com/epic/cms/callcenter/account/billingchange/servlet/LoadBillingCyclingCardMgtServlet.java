 ...
 * @author sajith_g
 */
public class LoadBillingCyclingCardMgtServlet extends HttpServlet {
    ...
    private List<ECMSOnlineTransBean> easyPaymentReqList;
    private SessionVarList sessionVarlist;
    HttpSession sessionObj;
    private SessionUser sessionUser;
    private String errorMessage = null;
    private List<String> userTaskList;
    private String url = "/callcenter/account/billingcyclingrequest.jsp";
    ...
    private void getAllCardTrnByCardNo(ECMSOnlineTransBean eCMSOnlineTransBean) throws Exception {
        try {
            ...
            easyPaymentReqList = easyPaymentRequestManager.getOnlineTransReq(eCMSOnlineTransBean);
        } catch (Exception ex) {
            throw ex;
        }
    }

 ...
 * @author badrika
 */
public class SearchCallCenterMgtServlet extends HttpServlet {

    //private FilledDataBean filledBean = null;
    private CustomerSearchBean searchbean = null;
    private SystemUserManager systemUserManager;
    private SessionVarList sessionVarlist;
    private SessionUser sessionUser;
    private RequestDispatcher rd;
    private String url = "/callcenter/callcentersearch/customersearchbasicview.jsp";
    ...
    public boolean validateUserInput(CustomerSearchBean bean) throws Exception {
        ...
        try {
            ...
            if (bean.getCardnumber().equals("") && bean.getAccount().equals("") && bean.getNic().equals("")
                    && bean.getPassport().equals("") && bean.getCif().equals("")) {
                isValidate = false;
    ...
    private void searchCustomer() throws Exception {
        try {
            ...
            if(cardList!=null && cardList.size()==1 ){
                String cardCategoryCode= cardList.get(0).getCardCatCode(); 
                
                if(cardCategoryCode.equals(StatusVarList.CARD_CATEGORY_SUPPLEMENTARY)||
...
//            System.out.println("fffffff "+ cardList.get(0).getOnlinetxnList().get(0).getTxnAmount());
    ...
    private void setCallHistoryRecord(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            callhistoryBean.setOperation(TaskVarList.VERIFY);//task code

 ...
 * @author badrika
 */
public class UpdateMerchantLocationMgtServlet extends HttpServlet {
...
//                errorMessage = MessageVarList.POSTAL_CODE_NULL;
            ...
            } else if (!UserInputValidator.isAlpha(merchantLocBean.getCpLastName())) {
                isValidate = false;
            ...
            } else if (!UserInputValidator.isNumeric(merchantLocBean.getTpNumber())) {
                isValidate = false;
            ...
            } else if (!UserInputValidator.isNumeric(merchantLocBean.getFax())) {
                isValidate = false;
            ...
            } else if (!UserInputValidator.isAlphaNumeric(merchantLocBean.getAccountNumber())) {
                isValidate = false;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update : '" + merchantLocBean.getMerchantId() + "' Merchant Location ID by : " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.CALLCENTER_MERCHANT_LOCATION_UPDATE);

 ...
 * @author nalin
 */
public class LoadTerminalTxnExpServlet extends HttpServlet {
...
//            JSONArray data = new JSONArray(); //data that will be shown in the table
           ...
           CallCenterTerminalMgtManager obj = new CallCenterTerminalMgtManager();
...
//            searchSQL += " LIMIT " + param.iDisplayStart + ", " + param.iDisplayLength;
            ...
            iTotalRecords = obj.getTerminalTxnCount(searchSQL, terminalId);
            List<TransactionBean> samples = new ArrayList<TransactionBean>();
            try {
                int end = param.iDisplayLength + param.iDisplayStart;
                samples = obj.getTerminalTxnExpDetails(searchSQL, param.iDisplayStart, end,terminalId);
                if (!param.sSearchKeyword.equals("") ) {
            ...
            Logger.getLogger(LoadTerminalTxnExpServlet.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();

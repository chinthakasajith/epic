 ...
 * @author nalin
 */
public class LoadCallCenterMerchantSearchServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    String terminalId = sessionVarlist.getTerminalId();
                    ...
                    if (isTerminalAllocated(terminalId)) {//terminal Id previously not allocated
                        if (isTerminalActive(terminalId)) {
                            ...
                            rd = getServletContext().getRequestDispatcher("/ViewMerchantMgtServlet?section=ACCTER&id=" + terminalId);
                        } else {
                        ...
                        rd = getServletContext().getRequestDispatcher("/ViewMerchantMgtServlet?section=ACCTER&id=" + terminalId+"&mid="+merchantId);
                    }

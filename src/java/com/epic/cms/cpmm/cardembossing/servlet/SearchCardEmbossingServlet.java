 ...
 * @author chanuka
 */
public class SearchCardEmbossingServlet extends HttpServlet {
...
//////                        this.getAllMASTERCardToEmboss(StatusVarList.CREDIT);
                        this.getAllVISACardToEmboss(StatusVarList.CREDIT);

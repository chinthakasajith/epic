...
public class GetProductByTypeServlet extends HttpServlet {
    ...
    private String embossType = "", cardDomain = "";
    private String url = "/cpmm/cardembossing/cardembossingsearchhome.jsp";
    private String url2 = "/cpmm/cardembossing/debitembossingsearchhome.jsp";
    private String url3 = "/cpmm/cardembossing/bulkembossingsearchhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cardDomain = request.getParameter("hiddencarddomain");
            ...
            if (cardDomain.equals("CREDIT")) {

                rd = getServletContext().getRequestDispatcher(url);
            }
            if (cardDomain.equals("DEBIT")) {

                rd = getServletContext().getRequestDispatcher(url2);
            }
            if (cardDomain.equals("BULK")) {

 ...
 * @author mahesh_m
 */
public class GeneratePinMailServlet extends HttpServlet {
...
//            }
    ...
    private void setAudittraceValue(HttpServletRequest request, String cardNumber) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Generated Pin Mail For Card Number: " + cardNumber + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.PINMAIL);

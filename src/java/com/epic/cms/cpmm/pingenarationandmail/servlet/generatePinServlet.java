...
//                        Boolean onlineUpdateStatus = updateOnleCard(ePPKPin, PVV, OFFSET, pinMethod, CVV, cardNumber);
                        ...
                        if (CardUpdateStatus) {
                            ...
                            request.setAttribute("successMsg", MessageVarList.SUCCES_PIN_AND_PVC_CVV);
                        } else {
...
//            String CVVData = ANB + expDate;
    ...
    public Boolean getPinBlockAndPvv() throws SecurityModuleException {
        try {
        ...
        } catch (SecurityModuleException ex) {
            throw ex;
        } catch (Exception e) {
            LogFileCreator.writePinGenerationErrorToLog(e);
            return false;
    ...
    private void setAudittraceValue(HttpServletRequest request, String cardNumber) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Generated Pin Card Number: " + cardNumber + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.PINGENERATIONANDMAIL);

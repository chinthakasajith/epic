 ...
 * @author mahesh_m
 */
public class SearchDebitPingenerationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.DEBITPINGENERATION;
...
//            searchBean.setEmbossType(embossType);
    ...
    private void getAllPinGenerationList() throws Exception {
        try {
            ...
            pinAndmailManager = new PinGenerationAndmailManager();
            cardEmbossingVISAList = pinAndmailManager.getAllPinGenerationList(searchBean, DataTypeVarList.CARD_DOMAIN_DEBIT);

 ...
 * @author badrika
 */
public class DeleteBillingStatementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            oldValue = cmsbillingStmtBean.getProfileCode() + "|" + cmsbillingStmtBean.getDescription() + "|" + cmsbillingStmtBean.getGracePeroid() + "|"
                    ...
                    + cmsbillingStmtBean.getStatus() + "|" + cmsbillingStmtBean.getLastUpdatedTime() + "|" + sessionVarlist.getCMSSessionUser().getUserName();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Delete Billing Statement Profile. Profile Code: " + id + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public int deleteProfile(String id) throws Exception {
        try {
            billingStatementProfileManager = new BillingStatementProfileManager();
            int i = billingStatementProfileManager.deleteProfile(id, systemAuditBean);
            return i;
        } catch (Exception e) {
            throw e;
        }

 ...
 * @author badrika
 */
public class DeleteTransactionProfileServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (TransactionProfileBean bean : tranProfileList) {
                if (bean.getProfileCode().equals(id)) {
                    oldValue = bean.getProfileCode() + "|" + bean.getDescription() + "|" + bean.getStatus() + "|" + bean.getLastUpdatedTime() + "|" + sessionVarlist.getCMSSessionUser().getUserName();
                }
            }
            ...
            boolean success = deleteProfile(id);

            if (success) {

                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.PROFILE_DELETE_SUCCESS);
            }
            this.getTransactionProfileDetails();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Delete Transaction Profile. Profile Code: " + id + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public boolean deleteProfile(String id) throws Exception {
        try {
            transactionProfileManager = new TransactionProfileManager();
            boolean result = transactionProfileManager.deleteProfile(id, systemAuditBean);
            return result;
        } catch (Exception e) {
            throw e;
        }

 ...
 * @author badrika
 */
public class LoadTransactionProfileServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    String pageCode = PageVarList.TRANSACTIONPROFILE;
            ...
            sessionVarlist.setTransactionTypeList(transactionList);
    ...
    private void getStatus() throws Exception {
        try {
            ...
            transactionProfileManager=new TransactionProfileManager();
            statusList = transactionProfileManager.getStatusList();
    ...
    private void getTransactionTypes() throws Exception {
        try {

            transactionProfileManager=new TransactionProfileManager();
            transactionList = transactionProfileManager.getTransactionTypes();

 ...
 * @author mahesh_m
 */
public class UpdateInterestProfileMgtServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (interestBean != null) {
                            ...
                            request.setAttribute("notAssignedTransactionTypes", notAssignedTransactionTypes);
                            request.setAttribute("assignedTransactions", assignedTransactions);

 ...
 * @author nalin
 */
public class RemoveCommissionProfileTxnServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (int k = 0; k < sessionVarlist.getCommissionTxnList().size(); k++) {

                            if (sessionVarlist.getCommissionTxnList().get(k).getTxnType().equals(txnCode)) {

                                sessionVarlist.getCommissionTxnList().remove(k);
                                remove = true;
                                break;
                            }
                        }
                        if (remove) {
                            request.setAttribute("successMsg",MessageVarList.TRANSACTION_SUCCESSFULLY_REMOVED);
                        }

 ...
 * @author nalin
 */
public class LoadUpdateCommissionProfileServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                String ComisProfileCode = request.getParameter("profileCode");
                ...
                for (CommissionProfileBean newcomisBean : comisList) {

                    if (newcomisBean.getComProfileCode().equals(ComisProfileCode)) {

 ...
 * @author nisansala
 */
public class DeleteListenerTxnMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        List<OnlineTxnTypeBean> assignList = listenMgr.getAssignTxn(listenerId);
                        String oldVar = "";
                        for (OnlineTxnTypeBean onlineTxnTypeBean : assignList) {
                            oldVar += onlineTxnTypeBean.getDescription() + ",";
                        }

                        oldValue = listenerId + "|" + oldVar + "|" + sessionVarlist.getCMSSessionUser().getUserName();

                        this.setAudittraceValue(request ,listenerId);
                        
                        int delResult = listenMgr.deleteListenerTxn(listenerId, systemAuditBean);
                        ...
                        if (delResult != 0) {
                            ...
                            request.setAttribute("successMsg", " " + MessageVarList.SECURITY_QUES_MGT_SUCCESS_DELETE + " txn ");
     ...
     * @throws Exception 
     */
    private void setAudittraceValue(HttpServletRequest request,String listenerId) throws Exception {

        try {
            systemAuditBean = new SystemAuditBean();
            ////get unique Id from the page.It may be the primary key---------------
            String uniqueId = listenerId;
            ...
            //set description 
            systemAuditBean.setDescription("Delete Listener Txn. Listener Txn Code: '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

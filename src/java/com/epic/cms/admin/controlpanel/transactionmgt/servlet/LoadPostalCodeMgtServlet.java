 ...
 * @author mahesh_m
 */
public class LoadPostalCodeMgtServlet extends HttpServlet {
    ...
    private List<PostalCodeBean> postalCodeBeanList;
...
//                        sessionVarlist.setCountryCodeList(countryCodeList);
     ...
     private void getDataFromPostalCodeTable() throws Exception {
        try {
            postalCodeBeanList = new ArrayList<PostalCodeBean>();
            postalCodeManager = new PostalCodeManager();
            postalCodeBeanList = postalCodeManager.getPostalCodeDetails();
        } catch (Exception e) {
            throw e;
        }
    }

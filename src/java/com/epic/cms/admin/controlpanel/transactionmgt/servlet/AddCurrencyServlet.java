...
public class AddCurrencyServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (validateUserInput(currencyBean)) {
                            ...
                            try {
                                successInsert = inserCurrency(currencyBean, systemAuditBean);
                                request.setAttribute("successMsg", MessageVarList.CURRENCY_SUCCESS_ADD + " code: " + currencyBean.getCurrencyAlphaCode());
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            newValue = currencyBean.getCurrencyCode() + "|" + currencyBean.getExponent() + "|"
                    + currencyBean.getCurrencyAlphaCode() + "|" + currencyBean.getCurrencyDes() + "|"
                    + currencyBean.getLastUpdatedUser() + "|" + currencyBean.getStatus();
    ...
    public boolean validateUserInput(CurrencyBean currency) throws Exception {
        ...
        try {
            ...
            if (currency.getCurrencyCode().contentEquals("") || currency.getCurrencyCode().length() <= 0) {
                ...
                isValidate = false;
                errorMessage = MessageVarList.CURRENCY_CODE_IN_3;
    ...
    public boolean inserCurrency(CurrencyBean currency, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            success = currencyManager.inserCurrency(currency, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Currency. Currency Code: " + currencyBean.getCurrencyCode() + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

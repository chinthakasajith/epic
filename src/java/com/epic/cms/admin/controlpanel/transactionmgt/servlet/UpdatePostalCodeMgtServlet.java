 ...
 * @author mahesh_m
 */
public class UpdatePostalCodeMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (PostalCodeBean postalCodeBean : sessionVarlist.getPostalCodeDetailList()) {
                            if (postalCodeBean.getPostalCode().equals(postalCode)) {
                                postal = postalCodeBean;
                            }
                        }

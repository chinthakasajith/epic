 ...
 * @author nisansala
 */
public class UpdateListenerTxnMgtServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (validateUserInput(listenerId, assignedList)) {
                            ...
                            try {
                                ...
                                successInsert = listenMgr.updateListenerTxn(listenerId, assignedList, systemAuditBean);
                                if (successInsert) {
                                    request.setAttribute("successMsg", MessageVarList.SUCCESS_UPDATE);
                                    rd = getServletContext().getRequestDispatcher("/LoadListenerTxnMgtServlet");
                                } else {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update Listener Txn: Listener Txn Code '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author ayesh
 */
public class DeleteCountryMgtServlet extends HttpServlet {
    ...
    private CountryMgtBean oldBean = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (CountryMgtBean bean : CountryMgtManager.getCountryManager().getAllCountryInfo()) {
                if (String.valueOf(bean.getCountryCode()).equals(code)) {
                    oldBean = bean;
                }
            }

            oldValue = oldBean.getCountryCode() + "|"
            ...
            boolean row = false;
            try {
                countryCode = Integer.parseInt(code);
            } catch (Exception e) {
                flag = false;
            }
            ...
            if (flag) {
                ...
                row = CountryMgtManager.getCountryManager().deleteCountry(countryCode, systemAuditBean);
            }
            if (row) {
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.COUNTRYMGT_DELETE_SUCCESS + " code: " + String.valueOf(countryCode));
            }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Country. Country Code: " + uniqueId + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

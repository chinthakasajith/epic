 ...
 * @author mahesh_m
 */
public class UpdateConfiremedPostalCodeMgtServlet extends HttpServlet {
    ...
    private PostalCodeManager postalManager;
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (validateUserInput(postalCodeBean)) {
                            ...
                            successInsert = updatePostal(postalCodeBean, systemAuditBean);
                            request.setAttribute("successMsg", MessageVarList.POSTAL_SUCCESS_UPDATE);
                            rd = getServletContext().getRequestDispatcher("/LoadPostalCodeMgtServlet");
                        } else {
                            request.setAttribute("postal", postalCodeBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update " + postalCodeBean.getCountryCode() + " Country Code by " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public boolean updatePostal(PostalCodeBean postal, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            postalManager = new PostalCodeManager();
            success = postalManager.updatePostal(postal, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;

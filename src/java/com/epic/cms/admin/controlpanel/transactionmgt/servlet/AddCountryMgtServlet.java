...
/**
 * this servlet use for add new country
 * @author ayesh
 */
public class AddCountryMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            countryBean.setCountryCode(request.getParameter("counrtCode"));
            countryBean.setFrdVal(request.getParameter("frdValue"));
            
            newValue = countryBean.getAlphaFirst() + "|" + countryBean.getAlphaSecond() + "|"
         + countryBean.getLastUpdateUser() + "|" + countryBean.getDescription() + "|" + countryBean.getRegion() + "|"
         + countryBean.getFrdVal() + "|" + countryBean.getCountryCode();           
            ...
            if (CountryMgtManager.getCountryManager().isValidInput(countryBean)) {
                ...
                row = CountryMgtManager.getCountryManager().insertNewCountry(countryBean, systemAuditBean);
            }

            if (row) {
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.COUNTRYMGT_ADD_SUCCESS + " code: " + countryBean.getCountryCode());
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Country. Country Code: " + uniqueId + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

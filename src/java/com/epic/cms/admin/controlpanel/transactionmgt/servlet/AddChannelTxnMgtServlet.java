 ...
 * @author nisansala
 */
public class AddChannelTxnMgtServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (validateUserInput(channelId, assignedList)) {
                            ...
                            try {
                                ...
                                successInsert = channelMgr.insertChannelTxn(channelId, assignedList, systemAuditBean);
                                if (successInsert) {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Channel Txn. Channel Txn Code: '" + uniqueId + "'  by: " + sessionVarlist.getCMSSessionUser().getUserName());

...
public class AddUserRoleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateUserInput(userRoleBean)) {
                ...
                insertUserRole(userRoleBean, systemAuditBean);

                request.setAttribute("successMsg", userRoleBean.getUserRoleCode() + " " + MessageVarList.USERROLE_SUCCESS_ADD);
    ...
    public void setUserInputToBean(HttpServletRequest request) {
        ...
        userRoleBean.setUserLevelID(userLevelID);
    ...
    public boolean insertUserRole(UserRoleBean userRoleBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            success = systemUserRoleManager.insertUserRole(userRoleBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add userrole privilage. privilage code: " + userRoleBean.getUserRoleCode() + " by: " + sessionVarlist.getCMSSessionUser().getUserName());

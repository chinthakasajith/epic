 ...
 * @author ayesh
 */
public class ViewSectionMgtUpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                try {
                    String pageCode = PageVarList.SECTION;
            ...
            String secionId = request.getParameter("id");

            for (SectionBean bean : SectionManager.getInstance().getAllSection()) {
                if (bean.getSectionCode().equals(secionId)) {
                    secBean = bean;
                }
            ...
            List<SectionBean> allSectionList = SectionManager.getInstance().getAllSection();

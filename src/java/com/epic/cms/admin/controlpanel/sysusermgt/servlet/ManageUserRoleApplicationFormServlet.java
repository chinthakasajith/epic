 ...
 * @author chanuka
 */
public class ManageUserRoleApplicationFormServlet extends HttpServlet {
...
//            request.setAttribute("notassigned", fromSectionList);
//            request.setAttribute("assigned", toSectioinList);

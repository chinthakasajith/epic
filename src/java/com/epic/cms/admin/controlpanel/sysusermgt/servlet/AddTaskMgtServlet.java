 ...
 * @author mahesh_m
 */
public class AddTaskMgtServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    try {
                        ...
                        if (validateUserInput(taskBean)) {
                            ...
                            try {
                                successInsert = inserTask(taskBean, systemAuditBean);
                                request.setAttribute("successMsg", taskBean.getTaskCode() + " " + MessageVarList.TASK_SUCCESS_ADD);
    ...
    public boolean inserTask(TaskBean task, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            success = taskManager.inserTask(task, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            String uniqueId = request.getParameter(taskBean.getTaskCode());
            ...
            //set description 
            systemAuditBean.setDescription("Add task, task code : " + taskBean.getTaskCode() + " by " + sessionVarlist.getCMSSessionUser().getUserName());

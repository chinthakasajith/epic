 ...
 * @author janaka_h
 */
public class LoadSystemUserServlet extends HttpServlet {
    ...
    private String url = "/administrator/controlpanel/systemusermgt/viewallsystemusers.jsp";
            ...
            try {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        sessionVarlist.setUserList(userList);
...
//            rd = getServletContext().getRequestDispatcher(url);
    ...
    private List<StatusBean> getStatusList() throws Exception {
        systemUserManager = new SystemUserManager();
        statusList = systemUserManager.getStatusByUserRole(StatusVarList.GENESTATUSCAT);
        return statusList;
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LoadSystemUserServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

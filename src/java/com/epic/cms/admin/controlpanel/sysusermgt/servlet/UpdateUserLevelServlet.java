...
public class UpdateUserLevelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (UserLevelBean userBean : userLevelList) {
                if (userBean.getUserLevelID().equals(userLevelID)) {
                    userLevelBean = userBean;
                    break;
                }
            }
            if (userLevelBean != null) {
                ...
                String oldValue = userLevelBean.getUserLevelID()+ "|" + userLevelBean.getDescription() + "|" + userLevelBean.getStatusCode()+"|"+userLevelBean.getLastUpdatedUser()+"|"+userLevelBean.getLastUpdatedTime();

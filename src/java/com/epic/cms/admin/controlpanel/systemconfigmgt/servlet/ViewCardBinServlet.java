 ...
 * @author chanuka
 */
public class ViewCardBinServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (CardBinBean CMScardProductBean : cardBinBeanLst) {
                if (CMScardProductBean.getBinNumber().equals(cardBinNumber)) {
                    cardBinBean = CMScardProductBean;
                }
            }
            if (cardBinBean != null) {

 ...
 * @author badrika
 */
public class UpdateBankMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = bankMgtManager.viewSelectedBank(id);
            if (bean != null) {
                request.setAttribute("bankBean", bean);

                String oldValue = bean.getBankCode() + "|" + bean.getBankName() + "|" + bean.getStatusDes();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateBankMgtLoadServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

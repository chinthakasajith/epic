 ...
 * @author sajith
 */
public class UpdateAlertMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = alertMgtManager.viewSelectedAlert(id);
            if (bean != null) {
                request.setAttribute("alertBean", bean);

                String oldValue = bean.getAlertType()+ "|" + bean.getDescription()+ "|" + bean.getStatus();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateAlertMgtLoadServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

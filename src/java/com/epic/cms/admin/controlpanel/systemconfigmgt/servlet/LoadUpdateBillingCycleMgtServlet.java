...
/**
 * this class load values before updating
 * @author nisansala
 */
@WebServlet(name = "LoadUpdateBillingCycleMgtServlet", urlPatterns = {"/LoadUpdateBillingCycleMgtServlet"})
public class LoadUpdateBillingCycleMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (billBean != null) {
                            String oldValue = billBean.getBillCycleCode() + "|" + billBean.getBillDate() + "|"

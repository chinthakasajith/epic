 ...
 * @author nalin
 */
public class LordUpdateServiceCodeMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        this.setOldUpdateValue(serviceBean);
                        if (serviceBean != null) {
...
//                sessionVarlist.setUserPageTaskList(userTaskList);
    ...
    private void setOldUpdateValue(ServiceCodeBean oldBean) throws Exception {
        String oldValue = null;
        try {

            oldValue = oldBean.getServiceCode() + "|" + oldBean.getDescription() + "|" + oldBean.getInternationalStatus() + "|"
                    + oldBean.getAtmStatus() + "|" + oldBean.getPinStatus() + "|" + oldBean.getAuthStatus() + "|"
                    + oldBean.getStatus();

            serviceBean.setOldValue(oldValue);
        } catch (Exception ex) {
            throw ex;

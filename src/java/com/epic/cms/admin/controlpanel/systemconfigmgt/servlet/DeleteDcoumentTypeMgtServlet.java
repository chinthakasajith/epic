 ...
 * @author ayesh
 */
public class DeleteDcoumentTypeMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (DocumentTypeMgtManager.getInstance().isAlreadyExist(id)) {
                ...
                oldValue = docBean.getDocCode() + "|"  + docBean.getDocName() + "|" + docBean.getVerifyCat() + "|" + docBean.getPostFix() + "|" + docBean.getStatus() ; 
      
                
                this.setAudittraceValue(request);
                row = DocumentTypeMgtManager.getInstance().deleteDocumentType(id, systemAuditBean);
            }
            if (row == 1) {
                request.setAttribute(MessageVarList.JSP_SUCCESS,
                        MessageVarList.DOCUMENT_TYPE_DELETE_SUCCESS);
            }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Delete Document Type. Document Type Code: '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

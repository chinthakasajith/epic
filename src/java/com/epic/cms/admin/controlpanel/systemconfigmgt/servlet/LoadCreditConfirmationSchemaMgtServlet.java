 ...
 * @author chinthaka_r
 */
public class LoadCreditConfirmationSchemaMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        this.getDataFromCreditLimitSchemaTable();
                       
                        sessionVarlist.setCreditLimitSchemaList(schemaDetails);
                        sessionObj.setAttribute(SessionVarName.SESSION_OBJ, sessionVarlist);
                        
                        this.getLastMaxLimitFromCreditLimitSchemaTable();
                        request.setAttribute("lastMaxLimit", lastMaxLimit);
    ...
    private void getDataFromCreditLimitSchemaTable() throws Exception {
        try {
            creditConfirmationSchemaManager = new CreditConfirmationSchemaManager();
            schemaDetails = creditConfirmationSchemaManager.getSchemaDetails();
        } catch (Exception e) {
            throw e;
        }
    }
    //get last max limit from table
    private void getLastMaxLimitFromCreditLimitSchemaTable() throws Exception{
        try {
            creditConfirmationSchemaManager =new CreditConfirmationSchemaManager();
            if(creditConfirmationSchemaManager.getLastMaxLimit()!=null){
                lastMaxLimit=creditConfirmationSchemaManager.getLastMaxLimit();
            }else{
                lastMaxLimit="0";
            }
        } catch (Exception e) {

 ...
 * @author jeevan
 */
public class ViewTerminalManufacServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = terminalMgtManager.viewSelectedData(id);
            System.out.println("********** " + bean.getManufactureCode() + " " + bean.getDescription());

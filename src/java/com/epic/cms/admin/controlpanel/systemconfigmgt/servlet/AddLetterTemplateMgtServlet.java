 ...
 * @author chanuka
 */
public class AddLetterTemplateMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.validateUserInput(tmpLetterBean, tmpBodyBean)) {
                ...
                success = DocumentTypeMgtManager.getInstance().addNewLetterFormat(systemAuditBean, tmpLetterBean);
                ...
                if (success > 0) {
                    ...
                    request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.LETTER_TEMPLATE_ADD_SUCCESS + " Code: " + tmpLetterBean.getTemplateCode());
...
//            letterFormat += titleFormatString;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Add Letter Template. Template Code: " + uniqueId + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author ayesh
 */
public class UpdateApplicationRejectLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute(RequestVarList.APP_REJECT_REASON_DATABEAN, arrbean);

            String oldV = arrbean.getReasonCode() + "|" + arrbean.getDescription();
            request.setAttribute("oldval", oldV);
            
            request.setAttribute(RequestVarList.APP_REJECT_REASON_DATABEAN, ApplicationRejectReasonManager.getInstance().getSelectedRejectReason(id));

 ...
 * @author ruwan_e
 */
public class LoadUpdateQueueServlet extends HttpServlet {
    ...
    QueueBean queueBean;
    private String url = "/administrator/controlpanel/systemconfigmgt/collection/queuemanagementhome.jsp";
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        caseTypeBeanList = queueManager.getNotAssignedCases(queueBean.getCode());

                        assignedCaseTypeBeans = queueManager.getAssignedCases(queueBean.getCode());

                        if (queueBean != null) {
                            request.setAttribute("operationtype", "update");
                            request.setAttribute("queueBean", queueBean);
...
//                            final ArrayList<CaseTypeBean> cases = getCases();
                            ...
                            String oldValue = queueBean.getCode();

 ...
 * @author nalin
 */
public class AddServiceCodeMgtServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (validateUserInput(serviceBean)) {
                            ...
                            try {
                                successInsert = serviceCodeInsert(serviceBean, systemAuditBean);

                                if (successInsert) {

                                    request.setAttribute("successMsg", MessageVarList.SERVICE_CODE_SUCCESS_ADD + " " + serviceBean.getServiceCode());
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            newValue = serviceBean.getServiceCode() + "|" + serviceBean.getDescription() + "|" + serviceBean.getInternationalStatus() + "|"
                    + serviceBean.getAtmStatus() + "|" + serviceBean.getPinStatus() + "|" + serviceBean.getAuthStatus() + "|" + serviceBean.getStatus() + "|" + serviceBean.getLastUpdatedUser();
    ...
    public boolean serviceCodeInsert(ServiceCodeBean serviceBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            /// call service Code methode

            serviceManager = new ServiceCodeMgtManager();
            success = serviceManager.serviceCodeInsert(serviceBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Service Code. Service Code :" + serviceBean.getServiceCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

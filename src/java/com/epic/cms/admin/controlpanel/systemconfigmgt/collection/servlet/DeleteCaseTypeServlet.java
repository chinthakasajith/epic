...
public class DeleteCaseTypeServlet extends HttpServlet {
    ...
    private String url = "/LoadCaseMgtServlet";
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        //call the delete case method
                        boolean delResult = this.deleteCase(caseTypeCode,systemAuditBean);

                        //if the deletion is success, proceed
                        if (delResult) {
                            this.getAllCases();
                            request.setAttribute("caseList", caseList);
                            request.setAttribute("successMsg", " " + "Successfully deleted Case Type Code "+ caseTypeCode);
    ...
    private boolean deleteCase(String caseTypeCode,SystemAuditBean systemAuditBean) throws Exception {
        caseMgtManager = new CaseMgtManager();
        boolean success = false;
        success = caseMgtManager.deleteCase(caseTypeCode,systemAuditBean);
        return success;
    }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Case Type. Case Type Code: '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

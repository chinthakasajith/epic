 ...
 * @author chanuka
 */
public class LoadCommonFileDownloadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            fileTypeList = new HashMap<String, String>();

            fileTypeList.put("EMBOSS", "Emboss");
            fileTypeList.put("ENCODE", "Encode");
            fileTypeList.put("EMV", "Emv");
            fileTypeList.put("STATEMENT", "Statement");
            fileTypeList.put("LETTER", "Letter");

            sessionVarlist.setFileTypeList(fileTypeList);
    ...
    private void getAllUserList() throws Exception {
        try {
            ...
            usersList = appAssignManager.getAllUserList(PageVarList.COMMONFILEDOWNLOAD);

 ...
 * @author ruwan_e
 */
public class LoadCommonConfigurationsServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    try {
                        ...
                        request.setAttribute(RequestVarList.CC_USER_ROLE_LIST, CommonConfigurationManager.getInstance().getUserrolelist());
//                        request.setAttribute(RequestVarList.CC_ACCUMULATION_POINT_VALUE, CommonConfigurationManager.getInstance().);
//                        request.setAttribute(RequestVarList.CC_REDEMPTION_POINT_VALUE, out);

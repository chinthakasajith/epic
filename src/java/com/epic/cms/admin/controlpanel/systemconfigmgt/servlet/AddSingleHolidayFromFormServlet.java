 ...
 * @author upul
 */
public class AddSingleHolidayFromFormServlet extends HttpServlet {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add " + uniqueId + " date as a holiday  by " + sessionVarlist.getCMSSessionUser().getUserName());

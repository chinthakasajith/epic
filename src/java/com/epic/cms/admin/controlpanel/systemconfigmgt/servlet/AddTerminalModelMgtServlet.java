 ...
 * @author jeevan
 */
public class AddTerminalModelMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.validateUserInputBean(bean)) {
                this.setAudittraceValue(request);

                try {
                    success = this.inserModelData();
            ...
            if (success > 0) {
                ...
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.MODEL_CODE_ADD_SUCCESS + " code " + bean.getModelCode());
            }
    ...
    private boolean validateUserInputBean(TerminalModelBean bean) throws Exception {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Add Terminal Model. Code: " + uniqueId + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    private int inserModelData() throws Exception {
        try {

            terminalModelMgtManager = new TerminalModelMgtManager();
            int i = terminalModelMgtManager.inserModelData(systemAuditBean, bean);
            return i;

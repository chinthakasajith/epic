 ...
 * @author badrika
 */
public class UpdateHotlistReasonMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String oldV = request.getParameter("oldvalue");
            ...
            if (this.validateUserInput(reasonBean)) {
                ...
                this.setAudittraceValue(request, oldV, newV);
            ...
            if (success > 0) {
                ...
                this.getHotlistReasons();
                request.setAttribute("reasonList", reasonList);
                rd = request.getRequestDispatcher("/LoadHotlistReasonMgtServlet");
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.REASON_UPDATE_SUCCESS);
     ...
     * @throws Exception 
     */
    public int updateReason() throws Exception {
        try {
            reasonMgtManager = new HotlistReasonMgtManager();
            int i = reasonMgtManager.updateReason(systemAuditBean, reasonBean);
            return i;
        } catch (Exception e) {
            throw e;
        }
    ...
    private void setValuesToBean(HttpServletRequest request) throws Exception {
        try {
            ...
            newV = reasonBean.getReasonCode() + "|" + reasonBean.getDescription() + "|" + reasonBean.getStatusDes();
     ...
     * @throws Exception 
     */
    private void setAudittraceValue(HttpServletRequest request, String old, String newVal) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Update Hot List Reason. Reason Code: " + uniqueId + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

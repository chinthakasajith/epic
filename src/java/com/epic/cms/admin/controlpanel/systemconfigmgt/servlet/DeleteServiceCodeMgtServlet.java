 ...
 * @author nalin
 */
public class DeleteServiceCodeMgtServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    serviceBean.setServiceCode(serviceCode);
                    ...
                    //get relevent data for update 
                    for (ServiceCodeBean newServiceBean : serviceList) {

                        if (newServiceBean.getServiceCode().equals(serviceCode)) {
                            oldValue = newServiceBean.getServiceCode() + "|" + newServiceBean.getDescription() + "|" + newServiceBean.getInternationalStatus() + "|"
                                    + newServiceBean.getAtmStatus() + "|" + newServiceBean.getPinStatus() + "|" + newServiceBean.getAuthStatus() + "|" + newServiceBean.getStatus() + "|" + sessionVarlist.getCMSSessionUser().getUserName();
                    ...
                    try {
                        successDelete = serviceCodeDelete(serviceBean, systemAuditBean);

                        if (successDelete) {
                            request.setAttribute("successMsg", MessageVarList.SERVICE_CODE_SUCCESS_DELETE + " " + serviceCode);
    ...
    public boolean serviceCodeDelete(ServiceCodeBean serviceBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            serviceManager = new ServiceCodeMgtManager();
            success = serviceManager.serviceCodeDelete(serviceBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Service Code. Service Code :" + serviceBean.getServiceCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

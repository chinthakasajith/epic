 ...
 * @author jeevan
 */
public class UpdateTerminalModelMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bean != null) {
                ...
                String oldValue = bean.getModelCode() + "|" + bean.getModelDesc() + "|"
                        + bean.getStatus() + "|" + bean.getDescription();
                System.out.println("********** " + oldValue);
                request.setAttribute("oldval", oldValue + "_____ " + bean.getManufactureCode());
            }

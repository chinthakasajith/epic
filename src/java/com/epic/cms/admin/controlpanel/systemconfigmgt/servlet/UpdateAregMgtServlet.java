 ...
 * @author jeevan
 */
public class UpdateAregMgtServlet extends HttpServlet {
        ...
        try {
            ...
            if (this.validateUserInput(bean)) {
                ...
                try {
                    ...
                    success = this.updateAreaMgtInfo();
...
//                rd = getServletContext().getRequestDispatcher("/ChangeAreaMgtServlet");
//                
//                this.getProvinceType(request.getParameter("provinceType")); //
//                request.setAttribute("districtList", areaBeanList);
//
...
//                request.setAttribute("provinceList", areaBeanList);
                ...
                rd = request.getRequestDispatcher("/LoadAreaMgtServlet");
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.AREA_MGT_UPDATE_SUCCESS + " Code : " + bean.getAreaCode());
...
//            else if (!UserInputValidator.isAlphaNumericWithSpace(bean.getAreaDescription())) {
//                isValidate = false;
//                errorMessage = MessageVarList.AREA_DESC_INVALID;
//
//            } 
    ...
    private void setValuesToBean(HttpServletRequest request) throws Exception {
        try {
            ...
            bean.setAreaDescription(request.getParameter("areadis").trim());
    ...
    private void setAudittraceValue(HttpServletRequest request, String oldValue, String newValue) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Update Area Management. Code: " + uniqueId + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    private int updateAreaMgtInfo() throws Exception {
        try {
            areaMgtManager = new AreaMgtManager();
            int i = areaMgtManager.updateAreaMgtInfo(systemAuditBean, bean);
            return i;
        } catch (Exception ex) {
            throw ex;
        }

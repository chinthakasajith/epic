...
/**
 * to add a new security question for issuing section
 * @author nisansala
 */
public class AddSecurityQuestionServlet extends HttpServlet {
...
//            }
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            newValue = questionBean.getQuestionNo() + "|" + questionBean.getQuestion() + "|" + questionBean.getPriorityLevel() + "|"
                    + questionBean.getIssueAcquireStatus() + "|" + questionBean.getQuestionType() + "|" + questionBean.getCardCategory() + "|"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddSecurityQuestionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

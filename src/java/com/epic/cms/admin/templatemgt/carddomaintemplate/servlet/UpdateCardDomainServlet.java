 ...
 * @author chanuka
 */
public class UpdateCardDomainServlet extends HttpServlet {
        ...
        try {
            ...
            if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                ...
                if (this.validateUserInput(cardDomainBean, request)) {
                    ...
                    if (this.updateCardDomain(cardDomainBean, systemAuditBean)) {
                        rd = getServletContext().getRequestDispatcher("/LoadCardDomainTempMgtServlet");
                        request.setAttribute("successMsg", MessageVarList.SUCCESS_UPDATE_CARDDOMAIN_GENERAL);
                    } else {
                        rd = getServletContext().getRequestDispatcher(url);
                        request.setAttribute("errorMsg", MessageVarList.ERROR_UPDATE_CARDDOMAIN);
                    }
...
//        cardDomainBean.setInterestProfileCode(interestFeeCode);
        ...
        newValue = cardDomainBean.getTemplateCode() + "|" + cardDomainBean.getTemplateName() + "|" + cardDomainBean.getStatus() + "|" + cardDomainBean.getCustemplateCode() + "|" + cardDomainBean.getValidFrom() + "|" + cardDomainBean.getValidTo() + "|" + cardDomainBean.getCardDomainCode()+ "|" + cardDomainBean.getCardTypeCode() + "|"
    ...
    private boolean updateCardDomain(CardDomainBean cardDomainBean, SystemAuditBean systemAuditBean) throws Exception {

        try {

            domainManager = new CardDomainMgtManager();
            success = domainManager.updateCardDomain(cardDomainBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update Card Domain Template. Card Domain Template Code: '" + cardDomainBean.getTemplateCode() + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

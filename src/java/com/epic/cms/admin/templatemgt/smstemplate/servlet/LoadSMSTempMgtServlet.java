 ...
 * @author sajith
 */
public class LoadSMSTempMgtServlet extends HttpServlet {

    private RequestDispatcher rd;
    private SystemUserManager systemUserManager;
    private SMSConfMgtManager smsTempMgtManager;
    private SessionVarList sessionVarlist;
    HttpSession sessionObj;
    private SessionUser sessionUser;
    private List<StatusBean> statusList;
    private List<SMSBean> searchList;
    ...
    private void searchEmailConfMgt() throws Exception {
        ...
        try {
            ...
            smsTempMgtManager = new SMSConfMgtManager();
            searchList = smsTempMgtManager.getSMSConfs();
        } catch (Exception ex) {
            throw ex;

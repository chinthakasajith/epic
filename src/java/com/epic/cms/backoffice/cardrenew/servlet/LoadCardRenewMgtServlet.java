 ...
 * @author badrika
 */
public class LoadCardRenewMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                try {
                    String pageCode = PageVarList.CARD_RENEW;
            ...
            List<CardTypeMgtBean> cdTypeList = CreditScoreRecommandManager.getInstance().getAllCardType();
            sessionVarlist.setCdTypeList(cdTypeList);

            List<CardCategoryBean> cardCategoryLst = CardTypeMgtManager.getInctance().getAllCardCategory();

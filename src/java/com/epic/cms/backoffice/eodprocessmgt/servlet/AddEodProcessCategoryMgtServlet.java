 ...
 * @author nalin
 */
public class AddEodProcessCategoryMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (validateUserInput(categoryBean)) {
                            ...
                            try {
                                String categoryId = eodProcessCategoryInsert(categoryBean, systemAuditBean);

                                if (!categoryId.isEmpty()) {

                                    request.setAttribute("successMsg", MessageVarList.EOD_PROCESS_CATEGORY_SUCCESS_ADD+" "+ categoryId);
      ...
      public boolean validateUserInput(EodProcessCategoryBean categoryBean) throws Exception {
       ...
       public String eodProcessCategoryInsert(EodProcessCategoryBean categoryBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            categoryManager = new EodProcessCategoryManager();
            CategoryId = categoryManager.eodProcessCategoryInsert(categoryBean, systemAuditBean);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
           // systemAuditBean.setDescription("Add: '" + serviceBean.getServiceCode() + "' Service Code by : " + sessionVarlist.getCMSSessionUser().getUserName());

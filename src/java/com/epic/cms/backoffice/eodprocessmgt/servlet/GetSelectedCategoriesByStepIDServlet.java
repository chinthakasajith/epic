 ...
 * @author badrika
 */
public class GetSelectedCategoriesByStepIDServlet extends HttpServlet {
    ...
    private List<EodProcessCategoryBean> selectedCategoryList;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                selectedCategoryList = proCatFlowManager.getSelectedCategoryList(stepId);
                request.setAttribute("selectedCatList", selectedCategoryList);

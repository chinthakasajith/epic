 ...
 * @author jeevan
 */
public class LoadIncomingFileUploadServlet extends HttpServlet {
...
//                    if (request.getParameter("drpvalue")!=null) {
//                        String fileType = request.getParameter("drpvalue");
//                        request.setAttribute("drpvalue", fileType);
//                    }
                    ...
                    this.getAllFileTypesBin();
                    request.setAttribute("filellList", fileTypeList2);  //****
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROR_APP_LOAD);
    ...
    private void getAllFileTypes() throws Exception {
        try {
            ...
            fileTypeList = fileTypeManager.getAllFileTypes();
        } catch (Exception ex) {
            throw ex;
        }
    }
    ...
    private void getAllFileTypesBin() throws Exception {
        try {
            fileTypeManager = new FileTypeManager();
            fileTypeList2 = fileTypeManager.getAllFileTypesBin();
        } catch (Exception ex) {
            throw ex;
        }
    }

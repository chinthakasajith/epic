...
import com.epic.cms.backoffice.installementpayment.persistance.BTPaymentConfirmPersistence;
 ...
 * @author sajith_g
 */
public class BTPaymentConfirmManager {
    private Connection CMSCon, CMSOnline;
    private BTPaymentConfirmPersistence perobj;
    private List<BTPaymentConfirmBean> requestList;
    private SystemAuditManager sysAuditManager;

    public List<BTPaymentConfirmBean> searchRequests(BTPaymentConfirmBean filledBean) throws SQLException, Exception {

        try {
            perobj = new BTPaymentConfirmPersistence();
    ...
    public boolean approveRequest(BTPaymentConfirmBean filledBean, SystemAuditBean systemAuditBean) throws SQLException, Exception {
    ...
    public boolean rejectRequest(BTPaymentConfirmBean filledBean, SystemAuditBean systemAuditBean) throws SQLException, Exception {
        boolean successInsert = false;
        try {
            perobj = new BTPaymentConfirmPersistence();
            sysAuditManager = new SystemAuditManager();

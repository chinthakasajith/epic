...
import com.epic.cms.backoffice.installementpayment.persistance.EasyPaymentConfirmPersistence;
 ...
 * @author Badrika
 */
public class EasyPaymentConfirmManager {

    private Connection CMSCon, CMSOnline;
    private EasyPaymentConfirmPersistence perobj;
    private List<EasyPaymentConfirmBean> requestList;
    private SystemAuditManager sysAuditManager;

    public List<EasyPaymentConfirmBean> searchRequests(EasyPaymentConfirmBean filledBean) throws SQLException, Exception {

        try {
            perobj = new EasyPaymentConfirmPersistence();
    ...
    public boolean approveRequest(EasyPaymentConfirmBean filledBean, SystemAuditBean systemAuditBean) throws SQLException, Exception {
    ...
    public boolean rejectRequest(EasyPaymentConfirmBean filledBean, SystemAuditBean systemAuditBean) throws SQLException, Exception {
        boolean successInsert = false;
        try {
            perobj = new EasyPaymentConfirmPersistence();
            sysAuditManager = new SystemAuditManager();

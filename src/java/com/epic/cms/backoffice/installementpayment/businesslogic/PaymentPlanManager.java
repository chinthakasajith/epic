...
public class PaymentPlanManager {
    ...
    private PaymentPlanPersistance paymentplanPerObj = null;
    ...
    public boolean insertPaymentPlan(PaymentPlanBean paymentPlan, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            paymentplanPerObj = new PaymentPlanPersistance();
     ...
     * @throws Exception
     */
    public List<PaymentPlanBean> getAllPaymentPlans() throws Exception {
        try {
            paymentplanPerObj = new PaymentPlanPersistance();
            CMSCon = DBConnection.getConnection();
            CMSCon.setAutoCommit(false);
     ...
     * @throws Exception
     */
    public List<PaymentPlanBean> getAllActivePaymentPlans() throws Exception {
        try {
            paymentplanPerObj = new PaymentPlanPersistance();
            CMSCon = DBConnection.getConnection();
            CMSCon.setAutoCommit(false);
     ...
     * @throws Exception
     */
    public boolean updatePaymentPlan(PaymentPlanBean paymentPlan, SystemAuditBean systemAuditBean) throws Exception {
        boolean success = false;
        try {
            paymentplanPerObj = new PaymentPlanPersistance();
            sysAuditManager = new SystemAuditManager();

 ...
 * @author sajith_g
 */
public class AddPaymentPlanServlet extends HttpServlet {
     ...
     * @throws Exception
     */
    public boolean insertPaymentPlan(PaymentPlanBean paymentPlan, SystemAuditBean systemAuditBean) throws Exception {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add payment plan privilage. privilage code: " + paymentPlanBean.getPaymentplancode() + " by: " + sessionVarlist.getCMSSessionUser().getUserName());

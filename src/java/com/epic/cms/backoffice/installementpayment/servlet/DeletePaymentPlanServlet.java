 ...
 * @author sajith_g
 */
public class DeletePaymentPlanServlet extends HttpServlet {
    ...
    private PaymentPlanBean paymentPlanBean = null;
    private SystemAuditBean systemAuditBean = null;
    private String errorMessage = null;
    private List<String> userTaskList;
    String paymentplanCode = null;
    private String url = "/backoffice/installementpayment/paymentplanhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String pageCode = PageVarList.PAYMENTPLAN;
            ...
            paymentPlanBean = new PaymentPlanBean();
            paymentPlanBean.setPaymentplancode(paymentplanCode);
            
            this.getAllPaymentPlans();
            
            for(PaymentPlanBean bean: paymentPlanList){
            ...
            if (delResult) {
                request.setAttribute("successMsg", paymentplanCode + " " + MessageVarList.PAYMENTPLAN_SUCCESS_DELETE);
                sessionObj.setAttribute(SessionVarName.SESSION_OBJ, sessionVarlist);
                rd = getServletContext().getRequestDispatcher("/LoadPaymentPlanMgtServlet");
            }
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROR_DELETE_PAYMENTPLAN);
     ...
     * @throws Exception 
     */
    public boolean deletePaymentPlan(PaymentPlanBean paymentPlan, SystemAuditBean systemAuditBean) throws Exception {
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete payment plan privilage. privilage code :" + paymentPlanBean.getPaymentplancode()+ " by :" + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.PAYMENTPLAN);

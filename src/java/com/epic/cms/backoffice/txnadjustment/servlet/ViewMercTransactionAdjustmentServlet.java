 ...
 * @author ruwan_e
 */
public class ViewMercTransactionAdjustmentServlet extends HttpServlet {

    private SystemUserManager systemUserManager;
    private SessionVarList sessionVarlist;
    private SessionUser sessionUser;
    private RequestDispatcher rd;
    private String url = "backoffice/txnadjustment/viewmerctxnadjustment.jsp";
    private TransactionAdjustmentManager tam;
    private List<TransactionAdjustment> taList;
    private TransactionAdjustment adjustment;
    /** 
...
//            }
            ...
            tam = new TransactionAdjustmentManager();
            taList = tam.getTransactionAdjustmentsByParty(TransactionAdjustmentParty.MERCHANT);
            adjustment = tam.getTransactionAdjustmentById(id);
            
            request.setAttribute("taList", taList);

            if (adjustment != null) {

//                request.setAttribute("operation_type", "view");
                request.setAttribute("taBean", adjustment);

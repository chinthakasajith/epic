 ...
 * @author sajith_g
 */
public class AddLOCPaymentPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateUserInput(paymentPlanBean)) {
                ...
                request.setAttribute("successMsg", paymentPlanBean.getPlancode()+ " " + MessageVarList.PAYMENTPLAN_SUCCESS_ADD);
    ...
    public void setUserInputToBean(HttpServletRequest request) {
        ...
        newValue = paymentPlanBean.getPlancode()+ "|" + paymentPlanBean.getDescription() + "|" + paymentPlanBean.getDuration() + "|" + paymentPlanBean.getInterestrate() + "|" + paymentPlanBean.getStatusCode() + "|" + paymentPlanBean.getLastUpdatedUser() + "|" + paymentPlanBean.getCreatedTime();
    ...
    public boolean insertPaymentPlan(LoadOnCardPaymentPlanBean paymentPlan, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            success = loanOnCardPlanManager.insertPaymentPlan(paymentPlan, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add load on card payment plan privilage. privilage code: " + paymentPlanBean.getPlancode()+ " by: " + sessionVarlist.getCMSSessionUser().getUserName());
   ...
   private void getAllPaymentPlan() throws Exception {
        try {
            loanOnCardPlanManager = new LoanOnCardPlanManager();
            paymentPlanList = loanOnCardPlanManager.getAllPaymentPlans();
        } catch (Exception ex) {
            throw ex;
        }
    }

 ...
 * @author badrika
 */
public class ApprovedPermLimitIncrementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.validateUserInput(permBean)) {
                ...
                this.searchCards();
                sessionVarlist.setPermBeanList(cardList);
    ...
    private void setValuesToBean(HttpServletRequest request) throws Exception {
        try {
            ...
            permBean.setIncType(request.getParameter("incType"));
    ...
    private boolean validateUserInput(PermLimitIncrementBean bean) {

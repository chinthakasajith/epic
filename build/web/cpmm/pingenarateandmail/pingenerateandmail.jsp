<%-- 
    Document   : pingenerateandmail
    Created on : May 4, 2012, 5:06:41 PM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcardembossingform.action = "${pageContext.request.contextPath}/SearchPingenerationAndMailServlet";
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadPingGenarationAndMailServlet";
            ...
            function pinGenerate(cardNo)
            {
                ...
                window.location = "${pageContext.request.contextPath}/generatePinServlet?cardNo=" + cardNo;
        ...
        <script>
            function settitle() {
                ...
                $.post("${pageContext.request.contextPath}/SetNavigationTitleServlet",
                        {pagecode: '<%= PageVarList.PINGENERATIONANDMAIL%>'
                        },
                function (data) {
        ...
        <style>
            ...
            <title>EPIC CMS PIN GENERATION</title>
        </head>
        <body>
                                ...
                                <div id="contenttext">
                                    ...
                                    <form method="POST" action="" name="searchcardembossingform">
                                        ...
                                        <table border="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 180px"> Card Category </td>
                                                        <td>
                                                            <select style="width: 100px" name="categoryCode">
                                                                <option value="" >--SELECT--</option>

                                                                <c:forEach var="category" items="${categoryMap}">
                                                                    <c:if test="${searchembossingbean.categoryKey==category.key}">
                                        ...
                                        <form method="POST" action="" name="visacardform">
                                            ...
                                            <table  border="1"  class="display1" id="tableview">
                                                <thead>
                                                    <tr>

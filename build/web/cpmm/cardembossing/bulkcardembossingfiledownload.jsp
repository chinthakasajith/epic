<%-- 
    Document   : bulkcardembossingfiledownload
    Created on : Sep 19, 2012, 3:49:57 PM
    Author     : chanuka
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeDownload(fileType,fileName,cardType,cardProduct)
            {
                ...
                document.hiddendownloadfile.action="${pageContext.request.contextPath}/BulkDownloadCardEmbossingFileServlet";
                document.hiddendownloadfile.submit();
        ...
        <title>EPIC CMS BULK CARD EMBOSSING ENCODING FILE DOWNLOAD</title>
    </head>
    <body>
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <table class="tit"> <tr> <td   class="center"> <B> BULK CARD EMBOSSING ENCODING MANAGEMENT </B></td> </tr><tr> <td>&nbsp;</td> </tr></table>

<%-- 
    Document   : debitcardembossingfiledownload
    Created on : Sep 18, 2012, 12:27:25 PM
    Author     : chanuka
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeDownload(fileType,fileName,cardType,cardProduct)
            {
                ...
                document.hiddendownloadfile.action="${pageContext.request.contextPath}/DebitDownloadCardEmbossingFileServlet";
                document.hiddendownloadfile.submit();
        ...
        <title>EPIC CMS DEBIT CARD EMBOSSING ENCODING FILE DOWNLOAD</title>
    </head>
    <body>
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <table class="tit"> <tr> <td   class="center"> <B> DEBIT CARD EMBOSSING ENCODING MANAGEMENT </B></td> </tr><tr> <td>&nbsp;</td> </tr></table>

    ...
    <head>
        ...
        <script language="javascript">
            ...
            {   
                ...
                if($('#readstatus').val() == '2'){
                    ...
                    oTable = $('#jsontable').dataTable({
                        "bDestroy" : true,
                        "bServerSide": true,
                        "sAjaxSource": "${pageContext.servletContext.contextPath}/SearchViewAlertServlet",
                        "fnServerData": function ( sSource, aoData, fnCallback ) {
                            ...
                            $.ajax( {
                                "dataType": 'json', 
                                "type": "GET", 
                                "url": "${pageContext.servletContext.contextPath}/SearchViewAlertServlet", 
                                "data": aoData, 
                                "success": fnCallback
                            } );
                        },
                        ...
                        "aoColumns": [
                            ...
                            { "mDataProp": "alertInfo","bVisible": true },
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadViewAlertServlet";

            }
            
            
            function goBack(){
                window.location = "${pageContext.request.contextPath}/SearchViewAlertServlet?isBack="+"back";
            }
            
            function invokeView(id,status)
            {                
                document.searchalertform.action="${pageContext.request.contextPath}/ViewViewAlertServlet?id="+id+"&status="+status;
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.VIEWALERT%>'                                  
                },
                function(data) {
                                        ...
                                        <table cellpadding="0" cellspacing="10">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text"  value="${alertBean.txnID}" name="txnid" maxlength="" id ="txnid"/></td>
                                                    <td></td>
                                                </tr>                                          
                                                <tr>
                                                    <td style="width: 200px;">From Date</td>
                                                    <td>
                                                        <input  name="fromdate" maxlength="16" readonly value="${alertBean.fromDate}" key="fromdate" id="fromdate"  />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input  name="todate" maxlength="16" readonly value="${alertBean.toDate}" key="todate" id="todate"  />
                                                        <script type="text/javascript">
                                                            $(function() {
                                                                $( "#todate" ).datepicker({
                                                                    showOn: "button",
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="readstatus" id="readstatus">
                                                            ...
                                                            <c:if test="${alertBean.readStatus == 2}">
                                                                <option value="2" selected="">Read</option>
                                                            </c:if>
                                                            <c:if test="${alertBean.readStatus != 2}">
                                                                <option value="2" >Read</option>
                                                            </c:if>
                                                            <c:if test="${alertBean.readStatus == 1}">
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td><input type="button" value="Search" name="search" style="width: 100px" onclick="invokeSearch()"/>

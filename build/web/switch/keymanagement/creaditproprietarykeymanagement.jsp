<%-- 
    Document   : creaditproprietarykeymanagement
    Created on : Dec 19, 2012, 10:52:53 AM
    Author     : asela
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVA(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryPVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryPVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryPVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVA(){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryCVVAServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryCVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryIMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryPPKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateTPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateCreditProprietaryTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CREDIT_PROPR_KEY_MGT%>'                                  
                },
                function(data) {

<%-- 
    Document   : ISBOOP
    Created on : Dec 21, 2012, 2:23:16 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISBOOP">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes23"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISBOOP', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : ACCUSE
    Created on : Dec 21, 2012, 3:06:50 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getAqCustomerServiceSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ACCUSE"><p><center><font size="2" style="font-weight: bold;" class="appdes3"></font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" class="appdes3"></font></center><p></p>
                ...
                <a class="menuitem submenuheader" href="#">Call Center</a>

                <div class="submenu">
                    <ul>


                        <li><a href="#" onclick="invokeSetSessionMenu('ACCUSE', '/LoadAccquirCallCenterMgtServlet')">Call Center Home</a></li>

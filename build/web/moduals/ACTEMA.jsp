<%-- 
    Document   : ACTEMA
    Created on : Dec 21, 2012, 3:01:45 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getTerminalMgtSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ACTEMA"><p><center><font size="2" style="font-weight: bold;" class="appdes10"></font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" class="appdes10"></font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ACTEMA', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

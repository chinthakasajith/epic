<%-- 
    Document   : ACMORE
    Created on : Dec 21, 2012, 3:11:01 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getAqMonitoringReportingSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ACMORE"><p><center><font size="2" style="font-weight: bold;" class="appdes6"></font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" class="appdes6"></font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ACMORE', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

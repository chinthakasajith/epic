<%-- 
    Document   : ISPRSE
    Created on : Dec 21, 2012, 10:01:29 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getProductServicesSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISPRSE">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes29"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISPRSE', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

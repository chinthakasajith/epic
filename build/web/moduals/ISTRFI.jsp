<%-- 
    Document   : ISTRFI
    Created on : Dec 21, 2012, 10:02:53 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getTransactionFinanceSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISTRFI">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes31"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISTRFI', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : ISISPR
    Created on : Dec 20, 2012, 4:17:06 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getIssuingPersonalizeSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISISPR">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes26"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISISPR', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

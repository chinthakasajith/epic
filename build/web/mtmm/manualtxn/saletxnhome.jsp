<%-- 
    Document   : saletxnhome
    Created on : Nov 15, 2012, 5:07:56 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            function invokeGO()
            {
                ...
                document.saleTxnForm.action="${pageContext.request.contextPath}/LoadMerchantDetailsServlet";
            ...
            function invokeProceed()
            {
                ...
                if(answer != 0){
                    document.saleTxnForm.action="${pageContext.request.contextPath}/ProceedSaleTxnServlet";
                    document.saleTxnForm.submit();
                }
                else{
       ...
       <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.SALE_TRANSACTION%>'                                  
                },
                function(data) {
                                ...
                                <form action="" method="POST" name="saleTxnForm" >
                                    ...
                                    <table cellpadding="0" cellspacing="10" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Merchant ID</td>
                                                <td><font style="color: red;">*</font>&nbsp;<input type="text" name="merchantID" class="inputfield-mandatory" maxlength="15" value='${saleTxnBean.merchantID}'></td>
                                                <td><input type="submit" style="width: 50px" name="add" value="Go" onclick="invokeGO()" /></td>
                                            </tr>

                                            <tr>
                                                <td>Merchant Name</td>
                                                <td><font style="color: red;">*</font>&nbsp;<input type="text" name="merchantName" class="inputfield-Description-mandatory" readonly="readonly" maxlength="50" value='${saleTxnBean.merchantName}'></td>
                                            </tr>

                                            <tr>
                                                <td width ="200px;">Terminal ID</td>

                                                <td><font style="color: red;">*</font>&nbsp;<select  name="terminalID"  class="inputfield-mandatory" >
                                                        <option value="" selected>--SELECT--</option>
                                                        <c:forEach var="terminal" items="${terminalList}">

                                                            <c:if test="${saleTxnBean.terminalID==terminal.key}">

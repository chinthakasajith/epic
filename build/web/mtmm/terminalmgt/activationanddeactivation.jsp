<%-- 
    Document   : activationanddeactivation
    Created on : May 11, 2012, 12:42:41 PM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeAssignSearch()
            {
                ...
                document.searchterminalform.action="${pageContext.request.contextPath}/SearchActivAndDeactiveServlet";
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadActAndDactServlet";
...
//                    window.location = "${pageContext.request.contextPath}/LoadAllocationAndDeallocation";
            ...
            function activate(terminalId){
                ...
                answer = confirm("Do you really want to Activate "+terminalId+" Terminal?")
    
                if (answer !=0)
                {
                    window.location="${pageContext.request.contextPath}/ActivationServlet?terminalId="+terminalId;
                }
                else
                {
//                    window.location = "${pageContext.request.contextPath}/LoadActAndDactServlet";
            ...
            function deactivate(terminalId){
    
                answer = confirm("Do you really want to Deactivate "+terminalId+" Terminal?")
    
                if (answer !=0)
                {
                    window.location="${pageContext.request.contextPath}/DeactiveTerminalServlet?terminalId="+terminalId;
                }
                else
                {
//                    window.location = "${pageContext.request.contextPath}/LoadActAndDactServlet";
            ...
            function block(terminalId){
    
                answer = confirm("Do you really want to Block "+terminalId+" Terminal?")
    
                if (answer !=0)
                {
                    window.location="${pageContext.request.contextPath}/BlockTerminalServlet?terminalId="+terminalId;
                }
                else
                {
//                    window.location = "${pageContext.request.contextPath}/LoadActAndDactServlet";
       ...
       <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.TRMINAL_ACTIVATION_DEACTIVATION%>'                                  
                },
                function(data) {
                                    ...
                                    <tbody>
                                        <c:forEach var="searchedTerminal" items="${searchList}">
                                            <tr>
                                                ...
                                                <td ><a href='#' onclick="activate('${searchedTerminal.terminalID}')"/>Activate</td>
                                                <td ><a href='#' onclick="deactivate('${searchedTerminal.terminalID}')">Deactivate</td>
                                                <td ><a href='#' onclick="block('${searchedTerminal.terminalID}')">Block</td>

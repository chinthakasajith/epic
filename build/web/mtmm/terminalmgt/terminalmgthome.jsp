    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeAssignSearch()
            {
                ...
                document.searchterminalform.action="${pageContext.request.contextPath}/SearchTerminalDataCaptureServlet";
       ...
       <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.TRMINAL_MGT%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form method="POST" action="" name="searchterminalform">
                                    ...
                                    <table cellpadding="0" cellspacing="10">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="2"><input type="submit" value="Create" style="width: 100px" onclick="invokeCreate()"/>
                                    ...
                                    <tbody>
                                        <c:forEach var="searchedTerminal" items="${searchList}">
                                            <tr>
                                                ...
                                                <td  ><a href='${pageContext.request.contextPath}/ViewTerminalDataCaptureServlet?id=<c:out value="${searchedTerminal.terminalID}"></c:out>&tid=<c:out value="${searchedTerminal.terminalID}"></c:out>&mid=<c:out value="${searchedTerminal.merchantID}"></c:out>'>View</a></td>
                                                <td ><a href='${pageContext.request.contextPath}/LoadUpdateTerminalDataServlet?id=<c:out value="${searchedTerminal.terminalID}"></c:out>&status=<c:out value="${searchedTerminal.terminalStatus}"></c:out>&manu=<c:out value="${searchedTerminal.manufacturer}"></c:out>&mid=<c:out value="${searchedTerminal.merchantID}"></c:out>&isDefault=<c:out value="yes"></c:out>'/>Update</td>
                                                <td ><a href='#' onclick="deleteTerminal('${searchedTerminal.terminalID}','${searchedTerminal.terminalStatus}')">Delete</td>
                                                
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                                <!--   &alSta=<c:out value="${searchedTerminal.merchantID}"></c:out>------------------------- end developer area  --------------------------------                      -->
                            </div>

<%-- 
    Document   : createmerchant
    Created on : Apr 27, 2012, 1:51:57 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script>
            ...
            function invokeUpdate()
            {
                ...
                document.updateForm.action="${pageContext.request.contextPath}/UpdateMerchantCustomerAssignDataServlet";
            ...
            function updateAndNext(){
                ...
                document.updateForm.action="${pageContext.request.contextPath}/UpdateMerchantCustomerServlet";
                document.updateForm.submit();
            }
                        ...
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <c:if test="${operationtype=='ADD'}">   
                                    <form name="createform" method="post" action="<%=request.getContextPath()%>/AddMerchantCustomerServlet">
                                            ...
                                            <div id="tabs-1" >
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<input type="text" id="merchantCustomerNumber" name="merchantCustomerNumber"  maxlength="15" value="${merchantBean.merchantCustomerNumber}" <c:if  test="${readOnly=='true'}"> readonly="readonly" </c:if> <c:if  test="${readOnly!='true'}"></c:if>> </td>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;">Payment maintenance</td> 

                                                        <td><font style="color: red;">*</font>&nbsp;<select name="paymentStatus"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="redempoint"  maxlength="23" value="${merchantBean.redempoint}"></td> 
                                                    </tr>
                                                </table>
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="accountNumber"  maxlength="12" value="${merchantBean.accountNumber}"></td> 
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    <tr>
                                                        <td style="width: 200px;">Application Date</td>
                                            ...
                                            <div id="tabs-2">
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    <tr>
                                                        ...
                                                        <td><input type="submit" name="add"  style="width: 100px; height: 30px;" onclick="selectAllMcc(assignMerchantCategorylist,assignTxnTypeList,assignCurrencyList)" value="Save">
                                        ...
                                        <div class="selector" id="tabs">
                                            ...
                                            <div id="tabs-1" >
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Commission Profile</td>
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select   name="selectCommissionProfile"  >
                                                                <option value="" selected>--SELECT--</option>
                                                                <c:forEach var="comis" items="${sessionScope.SessionObject.commissionList}">
                                                                    <c:if test="${merchantBean.commissionProfile==comis.comProfileCode}">
                                                                        <option value="${comis.comProfileCode}" selected="true" >${comis.description}</option>

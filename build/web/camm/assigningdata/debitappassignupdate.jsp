<%-- 
    Document   : debitappassignupdate
    Created on : Sep 11, 2012, 3:38:07 PM
    Author     : chanuka
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchappassignform.action="${pageContext.request.contextPath}/SearchDebitAppAssignServlet";
     ...
     <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.DEBITASSIGNUPDATE%>'                                  
                },
                function(data) {
        ...
        <title>EPIC CMS UPDATE DEBIT CARD APPLICATION ASSIGN</title>
    </head>
    <body>
                                    ...
                                    <table border="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a  href="#"  onclick="invokeHistory('<%=PageVarList.DEBITASSIGNUPDATE%>')"><img src="<%=request.getContextPath()%>/resources/images/history-icon.gif" width="40" height="40" title="History View"/></a></td>
                                            </tr>

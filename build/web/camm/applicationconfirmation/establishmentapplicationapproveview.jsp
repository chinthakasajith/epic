<%-- 
    Document   : establishmentapplicationapproveview
    Created on : Jul 7, 2016, 9:33:17 AM
    Author     : prageeth_s
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function LoadproductionMode() {
                ...
                var cardProductVal = $("#cardProduct").val();
...
//            }
            ...
            function Reject(applicationid)
            {
                ...
                {
                    document.confirmForm.action = "${pageContext.request.contextPath}/LoadEstablishmentApproveDetailsServlet?applicationid=" + applicationid;
                }
                        ...
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <div class="selector" id="tabs">
                                    <ul>
                                        <li><a href="#tabs-1">Establishment Information </a></li>
                                    ...
                                    <div id="tabs-1" >   
                                        <table cellpadding="0" cellspacing="10" style="height: 200px;" >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b><font color="#000000"> ${currencyAlphaCode} <fmt:formatNumber type="number" value="${establishmentDetailsBean.annualTurnover}"/></font></b>
                                                </td>


                                                <td style="width: 200px;"> Share capital</td>    
                                                <td>
                                                    <b><font color="#000000"> ${currencyAlphaCode} <fmt:formatNumber type="number" value="${establishmentDetailsBean.shareCapital}"/></font></b>
                                                </td>
                                                <td style="width: 100px;"></td> 
                                    ...
                                    <div id="tabs-3" >            
                                        <table cellpadding="0" cellspacing="10" style="height: 200px;" >    
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b><font color="#000000"> ${establishmentDetailsBean.cardTypeDes}</font></b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 200px;">Card Product</td>
                                                <td>
                                                    <b><font color="#000000"> ${establishmentDetailsBean.cardProductDes}</font></b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 200px;">Currency Type</td>
                                                <td>
                                                    <b><font color="#000000"> ${establishmentDetailsBean.currencyDes}</font></b>
                                                </td>
                                            </tr>
                                            <tr></tr>
                                            <tr></tr>
                                ...
                                <form method="POST" action="DownloadLetterServlet" target="downloadform">         
                                    <table cellpadding="0" cellspacing="10"  >                        
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td><a  href="#"  onclick="invokeBreakDown('${establishmentDetailsBean.applicationId}')"><img src="<%=request.getContextPath()%>/resources/images/Break_down.jpg" width="100" height="40" /></a></td>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" name="sysRecomendedCreditLimit" value="${creditLimit}"  style="visibility: hidden"></input>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select  name="cardProduct" id="cardProduct"  class="inputfield-mandatory">
                                    ...
                                    <div class="outset" style="border-style:outset; background-color: #B8B8B8 ;  border-color: #999; width: 100%">
                                        ...
                                        <table cellpadding="0" cellspacing="10"  >      
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="customerTemplate" name="customerTemplate" onchange="loadAccountTemplates('${cardApplicationList.applicationId}', '${establishmentDetailsBean.cardCurrency}', '${cardApplicationList.cardCategoryCode}')"  class="inputfield-mandatory">
                                                        <option value="" selected>-------------SELECT-------------</option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="accountTemplates" name="accountTemplates"  onchange="loadCardTempList('${cardApplicationList.applicationId}', '${establishmentDetailsBean.cardCurrency}')" class="inputfield-mandatory">
                                                        <option value="" selected>-------------SELECT-------------</option>
                                                    </select>
...
<!--                                                        <td><input type="submit" value="Confirm"  onclick="Confirm('${cardApplicationList.applicationId}','${establishmentDetailsBean.cardCurrency}')" style="width: 100px"></input></td>-->

<%-- 
    Document   : creditOfficerReviewAndConfirm
    Created on : Jul 21, 2016, 10:14:18 AM
    Author     : prageeth_s
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcreditofficerform.action="${pageContext.request.contextPath}/SearchCreditOfficerReviewAndConfirmServlet";
            ...
            function invokeReset(){
                ...
                window.location = "${pageContext.request.contextPath}/LoadCreditOfficerReviewAndConfirmServlet";
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CREDITOFFICERREVIEWANDCONFIRM%>'                                  
                },
                function(data) {
                                        ...
                                        <c:forEach var="appDetails" items="${searchList}">
                                            <tr>
                                                ...
                                                <c:if test="${appDetails.applicationCategory == 'M'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadCreditofficerDetailsAndConfirmServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'S'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadSupplementaryCreditofficerDetailsAndConfirmServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'C'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadCorporateCreditOfficerDetailsAndConfirmServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'F'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadCardAgainstFDCreditOfficerDetailsAndConfirmServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if> 
                                                <c:if test="${appDetails.applicationCategory == 'E'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadEstablishmentCreditOfficerDetailsAndConfirmServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>   

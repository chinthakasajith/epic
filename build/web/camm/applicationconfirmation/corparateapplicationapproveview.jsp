<%-- 
    Document   : corparateapplicationapproveview
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form name="sucMessage" id="succForm" style="background: #FFFFFF;padding: 0px;border: 0px"action="${pageContext.request.contextPath}/LoadApplicationApproveTableServlet">
                                ...
                                <form name="confirmForm" action="" method="POST" id="confirmForm">
                                    ...
                                    <input type="hidden" name="businessRegNo" value="${establishmentDetailsBean.businessRegNumber}" hidden="true"/>
                                    <input type="hidden" name="establishmentCreditLimit" value="${esablishmentCard.creditLimit}" hidden="true"/>
...
<!--                                    <table><td><b><font color="#FF0000" id="errorMsgcon"> ${errorMsgcon}</font></b> </td></table>-->
                                        ...
                                        <table  border="0"  class="display" id="tableview1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td >${primaryAppDetails.creditLimit}</td>
                                        ...
                                        <div id="tabs-1" >
                                            ...
                                            <table cellpadding="0" cellspacing="10"  >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b><font color="#000000"> ${personalDetail.designation}</font></b>
                                                    </td>
                                                    <td style="width: 100px;"></td> 
                                                </tr>
                                            </table>
                                        ...
                                        <div id="tabs-3" >
                                            <table cellpadding="0" cellspacing="10"  >  
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b><font color="#000000">${personalDetail.currencyTypeAlphaCode}&nbsp<fmt:formatNumber type="number" value="${personalDetail.creditLimit}"/></font></b>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="10"  >  
                                        ...
                                        <tr>
                                            <td style="width: 200px;">Card Type</td>
                                            <td>
                                                <b><font color="#000000"> ${sysRecomendedDetails.cardtype}</font></b>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 200px;">Credit Limit</td>
                                            <td>
                                                <b><font color="#000000"> ${sysRecomendedDetails.creditLimit}</font></b>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <c:forEach var="products" items="${cardProducts}">
                                                <c:if test="${products.productCode==cardApplicationList.cOfficerRecCardProduct}">
                                                    <td>
                                                        <b><font color="#000000">${products.description}</font></b>
                                                    </td>
                                                </c:if>
                                            </c:forEach>
                                        </tr>
                                        <tr>
                                            <td style="width: 200px;">Credit Limit</td>
                                            <td>
                                                <b><font color="#000000">${personalDetail.currencyTypeAlphaCode}&nbsp<fmt:formatNumber type="number" value="${cardApplicationList.cOfficerRecCrditLimt}"/></font></b>
                                            </td>
                                        </tr>

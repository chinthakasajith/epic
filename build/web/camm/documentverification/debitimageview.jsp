<%-- 
    Document   : debitimageview
    Created on : Dec 13, 2012, 11:02:55 AM
    Author     : chanuka
--%>
    ...
    <body>
        ...
        <div id="container" style="margin:auto">
            <div id="zoom01" class="zoom" data-canzoom="yes" style="height: 200px; border: 1px solid rgb(206, 206, 206); overflow: hidden; width: 100px; ">
                <img style ="width:200px;height:200px" id="image" src="${pageContext.request.contextPath}/LoadUploadedDebitImageServlet?applicationId=<%=request.getParameter("applicationId")%>&documentCategory=<%=request.getParameter("documentCategory")%>&fileName=<%=request.getParameter("fileName")%>"/>
            </div>
        </div>

<%-- 
    ...
    Created on : Mar 1, 2012, 11:20:45 AM
    Author     : chanuka
--%>
    ...
    <body>
        ...
        <div id="container" style="margin:auto">
            <div id="zoom01" class="zoom" data-canzoom="yes" style="height: 200px; border: 1px solid rgb(206, 206, 206); overflow: hidden; width: 100px; ">
                <img style ="width:200px;height:200px" id="image" src="${pageContext.request.contextPath}/LoadUploadedImageServlet?applicationId=<%=request.getParameter("applicationId")%>&documentType=<%=request.getParameter("documentType")%>&verificationCategory=<%=request.getParameter("verificationCategory")%>&fileName=<%=request.getParameter("fileName")%>"/>
            </div>
        </div>

<%-- 
    Document   : inputCaptureData
    Created on : Feb 15, 2012, 8:47:42 AM
    Author     : janaka_h
--%>
            ...
            <div class="main"  >
                ...
                <div id="content1" >
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:10px;" align="left">
                                ...
                                <div class="selector" id="tabs2">
                                    <ul>
                                        ...
                                        <li><a href="#tabs-6">Signature/Recommendation</a></li>
                                        ...
                                        <form name="customerpersonalinfoform" method="POST" action="<%=request.getContextPath()%>/AddCustomerPersonalInfoServlet">
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select name="marital" tabindex="11">
                                                        ...
                                                        <td></td>
                                                        <td><input type="text" name="noOfDependents"  maxlength="32" value="${personalBean.noOfDependens}" onKeyPress="return checkIt(event,'errMsgNoOfDepends')"/>&nbsp;<span id="errMsgNoOfDepends" style="color: red"></span></td>
                                                    <td style="width: 50px;">
                                                        <label style="color: red">${invalidMsgBean.noOfDependens}</label>
                                                    </td> 
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="email" id="email" maxlength="32" value="${personalBean.email}" tabindex="21" style="text-transform: none"></td>
                                                    <td style="width: 50px;" > 
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                ...
                                                <tr>
                                                    <td style="width: 200px;">Email Address</td>
                                                    <td><input type="text" name="spouseMail" id="email" maxlength="50" value="${personalBean.spouseMail}" tabindex="38" style="text-transform: none"></td>
                                                    <td style="width: 50px;" > 
                                                        <label style="color: red">${invalidMsgBean.spouseMail}</label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="spouseMonthIncome"  maxlength="11" value="${personalBean.spouseMonthlyIncome}" tabindex="39" onKeyPress="return checkIt(event,'errMsgSpIncome')">&nbsp;<span id="errMsgSpIncome" style="color: red"></span></td>
                                                    <td style="width: 50px;" > 
                                                        <label style="color: red">${invalidMsgBean.spouseMonthlyIncome}</label>
                                                    </td>
                                            ...
                                            <table cellpadding="0" cellspacing="10">   
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px;">Email Address</td>
                                                    <td></td>
                                                    <td><input type="text" name="relmail"  id="email" maxlength="50" value="${personalBean.relEmail}" tabindex="50" style="text-transform: none"></td>
                                                    <td style="width: 50px;" > 
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="creditLimit"  maxlength="10" value="${personalBean.creditLimit}" tabindex="60"></td>
                                                    <td style="width: 50px;" >
                                    ...
                                    <div id="tabs-2">
                                        <form name="customeremploymentform" method="POST" action="<%=request.getContextPath()%>/AddEmploymentDetailsServlet">
                                            <table cellpadding="0" cellspacing="10"  >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.otherEmploymentType}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.companyName} </label></td>

                                                </tr> 
                                                <tr>
                                                    <td style="width: 200px;">Company Address </td>
                                                    <td><input type="text" name="address1"  maxlength="64" style="width: 300px;" value="${employmentBean.adress1}"></td>
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.adress1} </label></td>

                                                </tr> 
                                                <tr>
                                                    <td style="width: 200px;"> </td>
                                                    <td><input type="text" name="address2"  maxlength="64" style="width: 300px;" value="${employmentBean.adress2}"></td>
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.adress2} </label></td>

                                                </tr> 
                                                <tr>
                                                    <td style="width: 200px;"> </td>
                                                    <td><input type="text" name="address3"  maxlength="64" style="width: 300px;" value="${employmentBean.adress3}"></td>
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.adress3} </label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.officePhone} </label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.designation} </label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.otherBusinessNature}</label>
                                                    </td>


                                                </tr>
                                                <tr>
                                                    <td style="width: 200px">Age of company (years)</td>
                                                    <td>
                                                        <input type="text" name="ageOfCompany" value="${employmentBean.ageOfCompany}"/>
                                                    </td>
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.ageOfCompany}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px">Employment duration</td>
                                                        <td>

                                                            years&nbsp;<select name="durationInYears">
                                                            <c:forEach var="year" begin="0" end="50" step="1">
                                                                <c:if test="${year==employmentBean.employmentDurationInYears}">
                                                        ...
                                                        &nbsp;months&nbsp;<select name="durationInMonths">
                                                            <c:forEach var="month" begin="0" end="11" step="1">
                                                                <c:if test="${month==employmentBean.employmentDurationInMonths}">
                                                    ...
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.employmentDurationInMonths}</label>
                                                    </td>
                                                </tr>
                                                <tr style="width: 200px"></tr>
                                                <tr>
                                                    <td style="width: 200px">Previous employer name</td>
                                                    <td>
                                                        <input type="text" name="nameOfPreviouEmployer" value="${employmentBean.pEmployerName}" style="width: 300px"/>
                                                    </td>
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.pEmployerName}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px">Previous employer address</td>
                                                    <td><input type="text" name="pEmployerAddress1" id="pEmployerAddress1" value="${employmentBean.pEmployerAddress1}" maxlength="32"/></td>
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.pEmployerAddress1}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px"></td>
                                                    <td><input type="text" name="pEmployerAddress2" id="pEmployerAddress2" value="${employmentBean.pEmployerAddress2}" maxlength="32"/></td>
                                                    <td style="width: 100px">
                                                        <label style="color: red">${invalidEmpBean.pEmployerAddress2}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px"></td>
                                                    <td><input type="text" name="pEmployerAddress3" id="pEmployerAddress3" value="${employmentBean.pEmployerAddress3}" maxlength="32"/></td>
                                                    <td style="width: 50px">
                                                        <label style="color: red">${invalidEmpBean.pEmployerAddress3}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 200px">Previous employment duration</td>
                                                    <td>
                                                        years&nbsp;<select name="pEmployementDurationInYears">
                                                            <c:forEach var="year" begin="0" end="50" step="1">
                                                                <c:if test="${year==employmentBean.pEmploymentDurationInYears}">
                                                                    <option value="${year}" selected="true">${year}</option>
                                                                </c:if>
                                                            </c:forEach>
                                                            <c:forEach var="year" begin="0" end="50" step="1">
                                                        ...
                                                        &nbsp;months&nbsp;<select name="pEmployementDurationInMonths">
                                                            <c:forEach var="month" begin="0" end="11" step="1">
                                                                <c:if test="${month==employmentBean.pEmploymentDurationInMonths}">
                                                                    <option value="${month}" selected="true">${month}</option>
                                                                </c:if>
                                                                <c:if test="${month!=employmentBean.pEmploymentDurationInMonths}">
                                                                    <option value="${month}">${month}</option>
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                <tr>
                                                    ...
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.selfEmpCompanyname} </label></td>
                                            ...
                                            <table  cellpadding="0" cellspacing="10"> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="annualturnover"  maxlength="13" value="${employmentBean.annualTurnOver}"></td>
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.annualTurnOver} </label></td>
                                                    <td style="width: 200px;"> Net Profit</td>    
                                                    <td><input type="text" name="netprofit"  maxlength="13" value="${employmentBean.netProfit}"></td>  
                                                    <td style="width: 100px;" > <label style="color: red">${invalidEmpBean.netProfit} </label></td>    
                                                ...
                                                <tr>
                                                    <td style="width: 200px;" ></td>
                                                    <td colspan="3"><input type="submit" name="next" value="Save & Next" style="width: 100px;"/>&nbsp;<input type="button" onclick="invokeReset('${sessionScope.SessionObject.applicationId}')" name="next" value="Reset" style="width: 100px;"/>&nbsp;<input type="button" name="cancel" value="Cancel" onclick="invokeCancel()" style="width: 100px;"/></td>
                                                    <td>&nbsp;</td><td>&nbsp;</td>
                                    ...
                                    <!--   tab 3 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------                                  -->
                                    <div id="tabs-3">
                                        <form name="incomeform" method="POST" action="<%=request.getContextPath()%>/SetIncomeDataToSessionServlet">
                                        ...
                                        <form name="incomeexpensesform" method="POST" action="<%=request.getContextPath()%>/AddIncomeAndExpensesInfoServlet">
                                            <table cellpadding="0" cellspacing="10">
                                                <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <c:forEach var="incomeList" items="${sessionScope.SessionObject.sessionIncomeList}">
                                                                    ...
                                                                    <tr class="gradeC">
                                                                        ...
                                                                        <td >
                                                                            <input type="button" value="Delete" onclick="invokeRemoveIncome('${incomeList.incomeCatogaryCode}')" >
                                                                        </td>
                                            ...
                                            <table  cellpadding="0" cellspacing="10"> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="loanInstallment" id="loanInstallment" maxlength="16" value="${expenseBean.loanInstallmentAmount}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="leaseRental" id="leaseRental"  maxlength="16" value="${expenseBean.leaseAmount}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="creditCardBill" id="creditCardBill" maxlength="16" value="${expenseBean.creditCardbill}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="otherBorrowing" id="otherBorrowing" maxlength="16" value="${expenseBean.otherBorrows}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="insurance" id="insurance" maxlength="16" value="${expenseBean.insuranceInstallment}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="houseHolder" id="houseHolder" maxlength="16" value="${expenseBean.houseHolderExpenses}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="color: red;">*</font></td>
                                                    <td><input type="text" name="otherExpense" id="otherExpense" maxlength="16" value="${expenseBean.otherExpenses}" onkeyup="invorkeSumOfExpenses()"></td>
                                                ...
                                                <tbody>
                                                    <c:forEach var="bankDetailList" items="${sessionScope.SessionObject.sessionBankDetailList}">
                                                        <tr class="gradeC">
                                                            ...
                                                            <td>
                                                                <input type="button" value="Delete" onclick="invokeRemoveBankData('${bankDetailList.bankCode}', '${bankDetailList.accountNumber}')">
                                                            </td>
                                        ...
                                        <form name="completeform" method="POST" action="<%=request.getContextPath()%>/ApplicationCompleteServlet">
                                            ...
                                            <table  cellpadding="0" cellspacing="10">
                                                <tr>
                                                    <td style="width: 200px;">Name</td>
                                                    <td>
                                                        <input type="text" name="recName" id="_recName" value="${recDetailsBean.recName}"/>
                                                    </td>
                                                    <td style="width: 50px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="recCreditCardNum" id="_recCreditCardNum" value="${recDetailsBean.recCreditCardnum}"/>
                                                    </td>
                                                    <td style="width: 50px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="recTpNum" id="_recTpNum" value="${recDetailsBean.recPhone}"/>
                                                    </td>
                                                    <td style="width: 50px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input  name="recDate" id="_recDate" maxlength="16" readonly value="${recDetailsBean.recDate}"/>

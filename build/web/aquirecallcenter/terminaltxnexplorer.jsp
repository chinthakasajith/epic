<%-- 
    Document   : terminaltxnexplorer
    Created on : Feb 14, 2013, 3:22:32 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            $(document).ready(function() {
                ...
                oTable = $('#jsontable').dataTable({
                    "bServerSide": true,
                    "sAjaxSource": "${pageContext.servletContext.contextPath}/LoadTerminalTxnExpServlet",
                    "bProcessing": true,
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_MERCHANT_TERMINAL_TXN_EXPLORER%>'                                  
                },
                function(data) {

...
public class DeleteTaskServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        boolean delResult = deleteTask(taskBean, systemAuditBean);

                        if (delResult) {
                            request.setAttribute("successMsg", taskCode + " " + MessageVarList.TASK_SUCCESS_DELETE);
            ...
            rd = getServletContext().getRequestDispatcher("/administrator/controlpanel/taskmanagement.jsp?errorMsg=" + MessageVarList.SESSION_EXPIRED);
            rd.forward(request, response);
            ...
            //redirect to login page
            rd = getServletContext().getRequestDispatcher("/administrator/controlpanel/taskmanagement.jsp?errorMsg=" + MessageVarList.LAST_SESSION_CLOSE);
            rd.forward(request, response);
        ...
        //set description 
        systemAuditBean.setDescription("Delete task, task code : "+ taskBean.getTaskCode()+" by "+sessionVarlist.getCMSSessionUser().getUserName());      
     ...
     public boolean deleteTask(TaskBean task ,SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            success = taskManager.deleteTask(task ,systemAuditBean);

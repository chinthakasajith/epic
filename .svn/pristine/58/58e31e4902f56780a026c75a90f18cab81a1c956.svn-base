...
public class AddTerminalServlet extends HttpServlet {
    ...
    private String url = "/mtmm/terminalmgt/terminalallocation.jsp";
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        typeList = allocationmanager.getTxnList(terminalBean.getMerchantID());
                        ...
                        if (validateUserInput(terminalBean)) {
                            ...
                            try {
                                ...
                                rd = getServletContext().getRequestDispatcher("/LoadAllocationAndDeallocation");
                        ...
                        request.setAttribute(RequestVarList.CURRENCY_LIST, currencyList);
                        request.setAttribute(RequestVarList.TERMINAL_RISKPROFILE_LIST, riskProfileList);
                        rd = getServletContext().getRequestDispatcher("/SearchmerchantServlet");
                        rd.forward(request, response);
                    }
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            newValue = terminalBean.getTerminalID() + "|" + terminalBean.getMerchantID() + "|" + terminalBean.getMcc() + "|" + terminalBean.getCurrency() + "|" + 
                    terminalBean.getRiskProfileCode() + "|" + terminalBean.getName() + "|" + terminalBean.getAlloStatus() + "|" + terminalBean.getLastUpdateUser();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Terminal. Terminal ID : " + terminalBean.getTerminalID() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

<%-- 
    Document   : modifyEstablishmentInputCaptureData
    Created on : Jul 12, 2016, 2:13:34 PM
    Author     : prageeth_s
--%>
...
//            }
            ...
            function invokeRemoveEstablishmentAssetLiabilityList(assetCode, assetTypeCode, type) {
                ...
                window.location = "${pageContext.request.contextPath}/RemoveEstablishmentAssetLiabilityFromSessionServlet?assetCode=" + assetCode + "&assetTypeCode=" + assetTypeCode + "&type=" + type + "&mode=edit";
            }
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <table cellpadding="0" cellspacing="10">
                                    <tr>
                                        ...
                                        <td><label> Establishment </label> </td>
                                    </tr>
                                </table>
                                ...
                                <div class="selector" id="tabs2">
                                    ...
                                    <div id="tabs-1" >
                                        <form name="customerpersonalinfoform" method="POST" action="<%=request.getContextPath()%>/UpdateEstablishmentDetailServlet">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea id="remark" onfocus="this.rows = 25" cols="50" rows="15" name="remark" style="width: 200px; height: 60px;">
                                                            ${establishmentDetailsBean.remark}
                                                        </textarea>
                                                    </td>
                                                    <td></td>
                                    ...
                                    <div id="tabs-2">
                                        ...
                                        <form name="assetsAndLiabilitiesForm" method="POST" action="<%=request.getContextPath()%>/UpdateAssetAndLiabilityDetailsServlet">
                                            <input type="hidden" name="mode" value="edit" />
                                            <table> 
                                                <tr>
                                                    <td style="width: 200px;">Add Remark</td>
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px"></td>
                                                        <td>
                                                            <input type="submit" name="next" value="Save" style="width: 100px;"/>&nbsp;<input type="button" onclick="invokeReset('${sessionScope.SessionObject.applicationId}', '${sessionScope.SessionObject.cardCategory}', '${sessionScope.SessionObject.applicationTypeCode}')" name="next" value="Reset" style="width: 100px;"/>&nbsp;<input type="button" name="cancel" value="Cancel" onclick="invokeCancel()" style="width: 100px;"/>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>

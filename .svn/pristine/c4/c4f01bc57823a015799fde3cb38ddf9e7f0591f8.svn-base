 ...
 * @author asitha_l
 */
public class UpdateCaseTypetServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.validateUserInput(caseTypeBean)) {
                        ...
                        if (this.updateCaseType(caseTypeBean,systemAuditBean)) {
                            request.setAttribute("successMsg", MessageVarList.SUCCESS_UPDATE + "Case type code '" + caseTypeBean.getCaseTypeCode() + "'");
    ...
    private boolean updateCaseType(CaseTypeBean caseTypeBean,SystemAuditBean systemAuditBean) throws Exception {
        caseMgtManager = new CaseMgtManager();
        boolean success;
        success = caseMgtManager.updateCaseType(caseTypeBean,systemAuditBean);
        return success;
    }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update Case Type Code. Case Type Code: '" + caseTypeBean.getCaseTypeCode() + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            newValue = caseTypeBean.getCaseTypeCode() + "|" + caseTypeBean.getDescription() + "|"
                    + "" + caseTypeBean.getCurrencyTypeCode() + "|" + caseTypeBean.getStatusCode() + "|"
                    + "" + caseTypeBean.getSeverityValue() + "|" + caseTypeBean.getEntryCriteriaCode() + "|"
                    + "" + caseTypeBean.getEntryOverDuePeriodCode() + "|" + caseTypeBean.getOverDueAmountType() + "|"
                    + "" + caseTypeBean.getEntryOverDueAmount() + "|" + caseTypeBean.getOverLimitAmountType() + "|"
                    + "" + caseTypeBean.getEntryOverLimitAmount() + "|" + caseTypeBean.getEntryAccStatusCode() + "|"
                    + "" + caseTypeBean.getEntryCardStatusCode() + "|" + caseTypeBean.getExitOverDueAmount() + "|"
                    + "" + caseTypeBean.getExitOverDuePeriodCode() + "|" + caseTypeBean.getExitOverLimitAmount() + "|"
                    + "" + caseTypeBean.getExitAccStatusCode() + "|" + caseTypeBean.getExitCardStatusCode() + "|"
                    + "" + caseTypeBean.getProcessAutomatedStatus() + "|" + caseTypeBean.getProcessManualStatus() + "|"
                    + "" + caseTypeBean.getRemarks();

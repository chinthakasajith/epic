 ...
 * @author chanuka
 */
public class DeleteCardBinServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cardBinNumber = request.getParameter("cardBinNumber");

            cardBinBean = new CardBinBean();
            cardBinBean.setBinNumber(cardBinNumber);

            this.setAudittraceValue(request);

            String productCode = getProductCode(cardBinNumber);

            if (productCode.equals("")) {
                boolean delResult = deleteCardBin(cardBinBean, systemAuditBean);

                if (delResult) {
                    request.setAttribute("successMsg", cardBinNumber + " " + MessageVarList.CARD_BIN_SUCCESS_DELETE);
    ...
    public boolean deleteCardBin(CardBinBean cardBinBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            cardBinMgtManager = new CardBinMgtManager();
            success = cardBinMgtManager.deleteCardBin(cardBinBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Issuing Bin. Bin Number:" + cardBinBean.getBinNumber() + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

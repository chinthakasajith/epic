 ...
 * @author mahesh_m
 */
public class UpdateATMzmkPanelServlet extends HttpServlet {
    ...
    private String url = "/switch/keymanagement/atmkeymanagement.jsp";
            ...
            if (zmk.length() == 32) {
                if (UserInputValidator.isHexxx(zmk)) {
                    ...
                    try {
                        ...
                        String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_ATM);
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM ZMK and ZMK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

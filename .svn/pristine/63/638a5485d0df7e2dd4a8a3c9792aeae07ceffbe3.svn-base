 ...
 * @author nalin
 */
public class LoadCollectionAssignServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sessionVarlist.setQueueList(queueList);

 ...
 * @author nisansala
 */
public class LoadUpdateCardChangeApproveServlet extends HttpServlet {
...
//    private CardProductMgtManager cardProductMgtManager;
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        reqBean = cdChngMgr.viewOneRequest(cardNumber, reasonCode);
    ...
    private void getPriorityLevels() throws Exception {
     ...
     private void searchRequests(RequestConfirmationBean inputBean) throws SQLException, Exception {
        cdChngMgr = new CardChangeApproveManager();
        searchList = cdChngMgr.searchRequests(inputBean);

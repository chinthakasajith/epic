 ...
 * @author nisansala
 */
public class ChangeCardProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.loadCardProduct(request.getParameter("cardType"));
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROT_LOAD_CARD);

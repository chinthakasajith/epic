 ...
 * @author chanuka
 */
public class AddCardTemplateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
               ...
               // this.getCardProductList(cardBean.getCardType());
                ...
                if (this.validateUserInput(cardBean, request)) {
                    ...
                    if (this.insertCardTemplate(cardBean, systemAuditBean)) {
                        ...
                        request.setAttribute("successMsg", cardBean.getTemplateName()+" "+ MessageVarList.SUCCESS_ADD_CARDDOMAIN);
                        rd = getServletContext().getRequestDispatcher("/LoadAddCardTemplateFormServlet");
    ...
    public void setUserInputToBean(HttpServletRequest request) {
        ...
        newValue = cardBean.getTemplateCode() + "|" + cardBean.getTemplateName() + "|" + cardBean.getValidFrom() + "|" + cardBean.getValidTo() + "|" + cardBean.getProductCode() + "|" + 
                ...
                + cardBean.getCashAdvanceRate() + "|" + cardBean.getFeeProfCode() + "|" + cardBean.getRiskProfCode() + "|" + cardBean.getTxnProfCode() + "|" + cardBean.getCardCategoryCode() + "|" + cardBean.getLastUpdatedTime() + "|" + cardBean.getLastUpdatedUser(); 
...
//    }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Card Template. Template Code: " + cardBean.getTemplateCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author sajith_g
 */
public class ViewPaymentPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (PaymentPlanBean paymentBean : paymentPlanList) {
                if (paymentBean.getPaymentplancode().equals(paymentPlanCode)) {
            ...
            request.setAttribute(MessageVarList.JSP_ERROR, MessageVarList.ERROR_VIEW_PAYMENTPLAN);

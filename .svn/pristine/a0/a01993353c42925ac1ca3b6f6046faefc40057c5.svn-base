 ...
 * @author nalin
 */
public class RejectCorporateEstApplicationDetailsServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.isExistCardApplication(checkedApplicantBean.getApplicationId())) {
                        ...
                        this.updateCorporateEstVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_VERIFY_REJECT, appHistoryBean, systemAuditBean);
                        ...
                        this.setAudittraceValue(request);
                        this.insertCorporateEstVerifyDetailsOfApplication(checkedApplicantBean, StatusVarList.APP_VERIFY_REJECT, appHistoryBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Reject establishment corporate card application, application id: " + checkedApplicantBean.getApplicationId() + " by " + sessionVarlist.getCMSSessionUser().getUserName());

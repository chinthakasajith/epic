 ...
 * @author nalin
 */
public class AddMerchantLocationManualTxnServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        typeList = merchantLocManager.getTxnTypeOfMerchant(merchantId);
                        ...
                        if (validateUserInput(manualBean)) {
                            ...
                            try {
                                boolean success = insertMerchantLocationManualTxn(manualBean, assignTxnTypeList, systemAuditBean);

                                if (success) {
                                    request.setAttribute("successMsg", MessageVarList.MERCHANT_LOCATION_MANUAL_TERMINAL_ADD);
                                }
    ...
    public boolean insertMerchantLocationManualTxn(MerchantLocManualTxnBean manualBean, String[] assignTxnTypeList, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            merchantLocManager = new MerchantLocationManager();
            success = merchantLocManager.insertMerchantLocationManualTxn(manualBean, assignTxnTypeList, systemAuditBean);

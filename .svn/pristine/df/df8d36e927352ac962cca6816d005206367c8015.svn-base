 ...
 * @author ayesh
 */
public class UpdateCardTypeMgtViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute(RequestVarList.CARDTYPE_DATA_BEAN, CardTypeMgtManager.getInctance().getSelectedCradType(id));
            request.setAttribute(RequestVarList.CARDTYPE_ALL_LIST, CardTypeMgtManager.getInctance().getAllCardType());

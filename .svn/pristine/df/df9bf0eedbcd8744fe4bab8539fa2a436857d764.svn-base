 ...
 * @author badrika
 */
public class ViewEmbossFileFormatMgtServlet extends HttpServlet {
    ...
    private EmbossFileFormatBean embean;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewEmbossFileFormatMgtServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 * @author admin
 */
public class UpdateConfiremedChanelConfigurationServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (setUserInputToBean(request)) {
                            if (validateUserInput(channelBean)) {
                                ...
                                successInsert = updateChannel(channelBean, systemAuditBean);
                                request.setAttribute("successMsg", MessageVarList.CHANNEL_SUCCESS_UPDATE + " " + channelBean.getChannelId());
                                ...
                                //System.out.println("//////////////// " + channelBean.getStatusCode());
                        ...
                        ChannelConfigManager chnlforTb = new ChannelConfigManager();
                        channelList = chnlforTb.getChannel();
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            String signonStatus = request.getParameter("selectSignonStatus").trim();
            ...
            String status = request.getParameter("selectStatus").trim();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update Channel Channel Id: " + channelBean.getChannelId() + ";  by : " + sessionVarlist.getCMSSessionUser().getUserName());
     ...
     * @throws Exception 
     */
    public boolean updateChannel(ChannelConfigBean channelBean, SystemAuditBean systemAuditBean) throws Exception {
        boolean success = false;
        try {
            channelManager = new ChannelConfigManager();
            success = channelManager.updateChannel(channelBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;

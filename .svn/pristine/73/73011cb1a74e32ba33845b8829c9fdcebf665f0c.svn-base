 ...
 * @author nalin
 */
public class DeleteRiskProfileMgtServlet extends HttpServlet {
    ...
    private String riskProfileCode= null;
    ...
    private String url = "/administrator/controlpanel/profilemgt/riskprofilemgthome";
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    riskProfileCode = request.getParameter("riskProfCode");
                    riskProfBean = new RiskProfileBean();
                    riskProfBean.setRiskProfCode(riskProfileCode);
                    ...
                    riskManager = new RiskProfileManager();
                        ...
                        for (RiskProfileBean newBean : riskProfList) {
                            ...
                            if (newBean.getRiskProfCode().equals(riskProfileCode)) {
            ...
            oldValue = newBean.getRiskProfCode() + "|" + newBean.getDescription() + "|" + newBean.getStatus() + "|"
                    ...
                    try {
                        boolean delResult = deleteRiskProfile(riskProfBean, systemAuditBean);
                        

                        if (delResult) {
                            request.setAttribute("successMsg", MessageVarList.RISK_PROFILE_SUCCESS_DELETE+": "+riskProfileCode);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Risk Profile Risk Profile Code :" + riskProfBean.getRiskProfCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public boolean deleteRiskProfile(RiskProfileBean riskProfBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            riskManager = new RiskProfileManager();
            success = riskManager.deleteRiskProfile(riskProfBean, systemAuditBean);

 ...
 * @author nalin
 */
public class UpdateCardTemplateProfileServlet extends HttpServlet {
            ...
            if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                ...
                if (this.validateUserInput(cardBean, request)) {
                    ...
                    if (this.updateCardDomain(cardBean, systemAuditBean)) {
                        ...
                        request.setAttribute("successMsg", MessageVarList.SUCCESS_UPDATE_CARDTEMPLATE_PROFILE);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update " + cardBean.getTemplateCode() + " User by " + sessionVarlist.getCMSSessionUser().getUserName());

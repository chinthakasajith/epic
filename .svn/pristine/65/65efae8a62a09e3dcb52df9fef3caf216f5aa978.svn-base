 ...
 * @author chanuka
 */
public class UpdateCardBinFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String cardBinNumber = request.getParameter("cardBinNumber");
            ...
            for (CardBinBean CMScardBinBean : cardBinBeanLst) {
                if (CMScardBinBean.getBinNumber().equals(cardBinNumber)) {

 ...
 * @author asela
 */
public class DeleteCardKeyMgtServlet extends HttpServlet {
            ...
            try {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            deleteStatus = this.deleteCardKeyDetails(id);
    ...
    private int deleteCardKeyDetails(String keyId) throws Exception {
        int num = -1;
        try {
            keyManager = new CardKeyManager();
            num = keyManager.deleteCardKeyDetails(keyId,systemAuditBean);
            return num;
        } catch (Exception ex) {
            throw ex;
        }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Card Keys. Key Id : '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

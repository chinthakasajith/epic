 ...
 * @author upul
 */
public class ManageApplicationPageFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String role=(String) request.getAttribute("selectedsection");
            
            //if redirect from the same jsp page this get as a parameter
            if(role==null){
              
              role=(String) request.getAttribute("selectedsection");
           
            }

            
            this.getPageListBySection(role);
            this.getAllSectionListByApplication(application);

          //  
            request.setAttribute("applicationCode", application);
            request.setAttribute("selectedsection", role);

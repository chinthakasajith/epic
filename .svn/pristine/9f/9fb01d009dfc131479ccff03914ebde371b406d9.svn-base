 ...
 */
package com.epic.cms.switchcontrol.keymgt.cirrus.servlet;
 ...
 * @author mahesh_m
 */
public class UpdateCirrusPVVAPanelServlet extends HttpServlet {
            ...
            if (pvva.length() == 16) {
                if (UserInputValidator.isHexxx(pvva)) {
                    ...
                    try {
                        ...
                        String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_CIRRUS);
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.CIRRUS_KEY_MGT);

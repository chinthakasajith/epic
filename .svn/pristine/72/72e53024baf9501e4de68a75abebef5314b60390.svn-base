<%-- 
    ...
    Created on : Nov 21, 2012, 11:52:49 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getAdminSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ADMINISTRATION"><p><center><font size="2" style="font-weight: bold;">ADMINISTRATOR</font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" >ADMINISTRATOR</font></center><p></p>

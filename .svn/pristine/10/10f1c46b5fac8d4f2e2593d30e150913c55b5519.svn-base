 ...
 * @author mahesh_m
 */
public class UpdateAWKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA AWK and AWK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author janaka_h
 */
public class LoadCustomerTempalteServlet extends HttpServlet {
    ...
    private String url = "/ManageTemplateMgtServlet";
...
//            rd = getServletContext().getRequestDispatcher(url);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LoadCustomerTempalteServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

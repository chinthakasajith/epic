 ...
 * @author chanuka
 */
public class AddCardBinServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.validateUserInput(cardBinBean)) {
                ...
                this.insertCardBin(cardBinBean, systemAuditBean);
    ...
    public boolean insertCardBin(CardBinBean cardBinBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            cardBinMgtManager = new CardBinMgtManager();
            success = cardBinMgtManager.insertCardBin(cardBinBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Issuing Bin. Bin Number: " + cardBinBean.getBinNumber() + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author badrika
 */
public class UpdateBulkCardQualityMgtServlet extends HttpServlet {
    ...
    private String url = "/cpmm/cardembossing/bulkcardqualitymgt.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.BULKCARD_QUALITY_MGT;
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            cardBean.setCardDomain(request.getParameter("cardDomain").trim());
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Quality Fail Bulk Card. Card Number: " + cardBean.getCardNumber() + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.BULKCARD_QUALITY_MGT);

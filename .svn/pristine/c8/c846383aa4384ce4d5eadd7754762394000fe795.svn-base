 ...
 * @author asitha_l
 */
public class UpdateCardBinMgtServlet extends HttpServlet {
            ...
            if (this.validateUserInput(cardBinBean)) {
                ...
                if (cardBinBean.getStatus().equals(StatusVarList.DEACTIVE_STATUS)) {
                    if (productCode.equals("")) {
                        ...
                        this.updateBin(cardBinBean, systemAuditBean);
    ...
    public boolean updateBin(CardBinBean cardBinBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            cardBinMgtManager = new CardBinMgtManager();
            success = cardBinMgtManager.updateBin(cardBinBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;

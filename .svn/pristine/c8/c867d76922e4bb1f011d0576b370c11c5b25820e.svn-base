 ...
 * @author janaka_h
 */
public class SetDocumentTypesOnModifyServlet extends HttpServlet {
...
//            this.getAllDocumentDetails(appliactionId);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SetDocumentTypesOnModifyServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

<%-- 
    Document   : applicationapproveview
    Created on : Mar 12, 2012, 10:43:36 AM
    Author     : mahesh_m
--%>
...
//                }
            ...
            function Reject(applicationid)
            {
                ...
                {
                    document.confirmForm.action = "${pageContext.request.contextPath}/LoadApproveDetailsServlet?applicationid=" + applicationid;
                }

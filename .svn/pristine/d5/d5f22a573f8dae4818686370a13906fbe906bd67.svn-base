 ...
 * @author nisansala
 */
public class ViewNumberFormatServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //get the format code which is to be displayed
            ...
            this.getBinToCardType(formatBean.getCardType(), formatBean.getProductMode());

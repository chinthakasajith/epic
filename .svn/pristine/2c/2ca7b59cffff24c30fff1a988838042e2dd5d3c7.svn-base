<%-- 
    Document   : MERTERMGT
    Created on : Nov 21, 2012, 11:55:56 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getMerterSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            ...
            <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=MERTERMGT">-->
                <p><center><font size="2" style="font-weight: bold;" class="appdes32"></font></center> </p>
                ...
                <div class="submenu">
                     <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('MERTERMGT','<%= url%>')"> <%= pageBean.getDescription()%></a></li>

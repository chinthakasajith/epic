 ...
 * @author badrika
 */
public class UpdateEmbossFileFormatMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (embean != null) {
                ...
                String oldValue = embean.getFormatCode() + "|" + embean.getDescription() + "|" + embean.getRecordCount() + "|"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateEmbossFileFormatMgtLoadServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

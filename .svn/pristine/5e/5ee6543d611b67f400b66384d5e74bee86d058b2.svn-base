 ...
 * @author nalin
 */
public class ViewChanelConfigurationServlet extends HttpServlet {
    ...
    private List<ChannelConfigBean> newChannelList = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //List<ChannelConfigBean> channelList = null;
        try {
            ...
            try {
                ...
                //get transaction type details for table
                ...
                newChannelList = chnl.getChannel();
                for (ChannelConfigBean newChannalBean : newChannelList) {

                    if (newChannalBean.getChannelId().equals(channelId)) {
                        channelBean = newChannalBean;
                    }
                }
                if (channelBean != null) {

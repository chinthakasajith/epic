 ...
 * @author ruwan_e
 */
public class LoadMerchantTxnAdjustment extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    request.setAttribute(RequestVarList.TA_MERCHANT_TRANSACTION_ADJUSTMENTS, transactionAdjustmentManager.getTransactionAdjustmentsByParty(TransactionAdjustmentParty.MERCHANT));

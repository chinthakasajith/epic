 ...
 * @author badrika
 */
public class SetAcquireFieldNameDropDownServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                //retrieve tables according to the question type
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SetAcquireFieldNameDropDownServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 */
package com.epic.cms.switchcontrol.keymgt.visaplus.servlet;
 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusPVVBPanelServlet extends HttpServlet {
                ...
                if (UserInputValidator.isHexxx(pvvb)) {
                    ...
                    try {
                        ...
                        this.setAudittraceValue(request);
                         ...
                         String chanelId = keyMgtmanager.getChanelId(StatusVarList.CHANEL_TYPE_VISA_PLUS);
...
//                rd.forward(request, response);
     ...
     private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS PVVB and PVVB KVC by " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.MASTER_KEY_MGT);

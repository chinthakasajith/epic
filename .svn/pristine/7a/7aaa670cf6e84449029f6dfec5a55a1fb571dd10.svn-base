 ...
 * @author chanuka
 */
public class LoadTxnExpSearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("errorMsg", MessageVarList.ERROR_LOAD_TXN_EXP);
    ...
    private void getAllTransactionTypes() throws Exception {
        ...
        try {
            ...
            txnTypeList = txnExpMgtManager.getAllTransactionTypes();
            sessionVarlist.setOnlineTxnTypeMap(txnTypeList);
        } catch (Exception ex) {
            throw ex;
        }
    }

    private void getAllTransactionStatus() throws Exception {

        try {

            txnExpMgtManager = new TransactionExpMgtManager();
            txnStatusList = txnExpMgtManager.getAllTransactionStatus();
            sessionVarlist.setOnlineTxnStatusMap(txnStatusList);

 ...
 * @author nalin
 */
public class LoadUpdateResponceCodeMappingServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (ResponceCodeMappingBean newMappingBean : mappingList) {

                            if (newMappingBean.getDbCode().equals(dbCode)) {
                                mappingBean = newMappingBean;
                            }
                        }

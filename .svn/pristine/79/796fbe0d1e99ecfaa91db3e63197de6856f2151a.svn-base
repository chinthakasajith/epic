 ...
 * @author mahesh_m
 */
public class UpdateMasterTPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MASTER TPK and TPK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

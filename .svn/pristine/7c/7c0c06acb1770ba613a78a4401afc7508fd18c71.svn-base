 ...
 * @author mahesh_m
 */
public class LoadCardAgainstFDCreditofficerDetailsServlet extends HttpServlet {
    ...
    private String url = "/camm/applicationconfirmation/cardagainstfdcreditofficerview.jsp";

 ...
 * @author sajith_g
 */
 public class LoadBTPaymentConfirmationServlet extends HttpServlet {
    ...
    private BTPaymentPlanManager paymentBTPlanManager;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.APPROVE_BT_PAYMENT;
                String taskCode = TaskVarList.VERIFY;

                //check whethre userrole have an access for this page and task
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {

                    this.getAllActiveBTPaymentPlan();
                    request.setAttribute("paymentPlanList", paymentBTPlanList);
    ...
    private void getAllActiveBTPaymentPlan() throws Exception {
        try {
            paymentBTPlanManager = new BTPaymentPlanManager();
            paymentBTPlanList = paymentBTPlanManager.getAllActivePaymentPlans();
        } catch (Exception ex) {
            throw ex;
        }
    }

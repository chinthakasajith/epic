 ...
 * @author sajith_g
 */
public class LoadLoanOnCardMgtServlet extends HttpServlet {
    ...
    private String url = "/callcenter/card/loanoncardrequest.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("operationtype", "search");
            request.setAttribute("tempBean", loanOnCardPaymentRequestBean);
            request.setAttribute("errorMsg", MessageVarList.ERROR_LOAD_LOANCARDREQ);

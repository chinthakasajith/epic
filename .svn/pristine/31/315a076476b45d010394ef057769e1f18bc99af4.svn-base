 ...
 * @author mahesh_m
 */
public class SearchBulkPinMailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.BULK_PIN_MAIL;
...
//            cardEmbossingVISAList = pinAndmailManager.getAllPinGenerationList(searchBean,DataTypeVarList.CARD_DOMAIN_CREDIT);
     ...
     private void  getSearchList() throws Exception {
         ...
         try {
            ...
            pinAndmailManager = new PinGenerationAndmailManager();
            bulkSearchList = pinAndmailManager.getBulkPinMailSearchList(searchBean);
     ...
     private void getAllUserList() throws Exception {
        try {
            ...
            usersList = appAssignManager.getAllUserList(PageVarList.BULK_PIN_MAIL);

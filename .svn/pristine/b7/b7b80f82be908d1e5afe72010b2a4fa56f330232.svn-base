 ...
 * @author asela
 */
public class UpdateCreditProprietaryIMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update CIRRUS DMK_AC and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

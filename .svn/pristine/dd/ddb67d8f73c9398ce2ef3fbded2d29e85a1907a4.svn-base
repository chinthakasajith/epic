 ...
 * @author prageeth_s
 */
public class CorporateRejectApplicationDetailsServlet extends HttpServlet {
...
//                    bankVerifyBean = sessionVarlist.getBankVerifyBean();
                    ...
                    if (this.isExistCardApplication(checkedApplicantBean.getApplicationId())) {
                        ...
                        this.updateVerifyDetailsOfApplication(checkedApplicantBean, "VREJ", appHistoryBean, systemAuditBean);
                        ...
                        this.setAudittraceValue(request);
                        this.insertVerifyDetailsOfApplication(checkedApplicantBean, "VREJ", appHistoryBean, systemAuditBean);

                        //request.setAttribute("selectedtab", "2");
                        //request.setAttribute("successMsg4", MessageVarList.SUCCES_DOC_REJECT);
...
//            }
    ...
    public void setUserInputToBean(HashMap<String, FileItem> formMap) {
        ...
        appHistoryBean.setRemarks("Application is rejected");
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Reject credit card application,applcation id: " + checkedApplicantBean.getApplicationId() + " by " + sessionVarlist.getCMSSessionUser().getUserName());

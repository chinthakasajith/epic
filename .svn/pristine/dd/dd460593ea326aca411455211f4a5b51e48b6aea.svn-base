 ...
 * @author nalin
 */
public class UpdateResponceCodeMappingServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (setUserInputToBean(request)) {
                            if (validateUserInput(mappingBean)) {
                                ...
                                try {
                                    successInsert = this.updateDBCode(mappingBean, systemAuditBean);

                                    if (successInsert) {

                                        request.setAttribute("successMsg", MessageVarList.DB_CODE_SUCCESS_UPDATE + " " + mappingBean.getDbCode());
    ...
    public boolean updateDBCode(ResponceCodeMappingBean mappingBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            mappingManager = new ResponceCodeMappingManager();
            success = mappingManager.updateDBCode(mappingBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update DB Code. DB Code : " + mappingBean.getDbCode() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

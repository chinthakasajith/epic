 ...
 * @author sajith_g
 */
public class UpdateLOCPaymentPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (LoadOnCardPaymentPlanBean paymentplan : paymentPlanList) {
                if (paymentplan.getPlancode().equals(paymentPlanCode)) {
            ...
            if (paymentplanBean != null) {
                ...
                String oldValue = paymentplanBean.getPlancode()+ "|" + paymentplanBean.getDescription() + "|" +paymentplanBean.getDuration()+"|"+paymentplanBean.getInterestrate()+"|"+paymentplanBean.getStatusCode()+"|"+paymentplanBean.getLastUpdatedUser()+"|"+paymentplanBean.getLastUpdatedTime();

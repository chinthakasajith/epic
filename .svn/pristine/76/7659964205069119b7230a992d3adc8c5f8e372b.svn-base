 ...
 * @author nalin
 */
public class ProceedCallCenterSaleTxnServlet extends HttpServlet {
    ...
    private String url = "/aquirecallcenter/acquiresaletxnhome.jsp";
        ...
        try {
            try {
                ...
                try {
                    ...
                    String pageCode = PageVarList.CALLCENTER_SALE_TRANSACTION;
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            saleTxnBean.setMerchantID(sessionVarlist.getMerchantId());
            saleTxnBean.setTerminalID(this.getManualTerminal(sessionVarlist.getMerchantId()));
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.CALLCENTER_SALE_TRANSACTION);

 ...
 * @author asela
 */
public class ConfirmCorporateDataServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.validateUserInput(appAssignBean, request)) {
                        ...
                        if (this.insertAssignApplication(appAssignBean, appHistoryBean, systemAuditBean)) {
                            ...
                            rd = getServletContext().getRequestDispatcher("/LoadCorporateAssignServlet");
                        } else {
...
//        String appliactionId = request.getParameter("appliactionid").trim();
        ...
        newValue = appAssignBean.getApplicationDomain() + "|" + appAssignBean.getCardCategory() + "|" + appAssignBean.getAssignUser() + "|"
                ...
                + appHistoryBean.getApplicationLevel() + "|" + appHistoryBean.getStatus();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.CORPORATEASSIGN);

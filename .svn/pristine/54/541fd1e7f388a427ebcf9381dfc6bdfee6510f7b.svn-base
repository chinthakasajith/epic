 ...
 * @author chanuka
 */
public class DebitDownloadCardEmbossingFileServlet extends HttpServlet {
    ...
    private String url = "/cpmm/cardembossing/debitcardembossingfiledownload.jsp";
...
//            out.close();
    ...
    private void setAudittraceValue(HttpServletRequest request, String cardType, String cardProduct, String fileName) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Download " + cardProduct + " Emboss file by, file name: " + fileName + " by " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author nalin
 */
public class DeleteListenerConfigurationServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    listenerId = request.getParameter("listenerId");
            ...
            for (ListenerConfigurationBean newListenerBean : listenerList) {
                ...
                if (newListenerBean.getListenerId().equals(listenerId)) {
                    ...
                    try {
                        boolean delResult = listenerDelete(listenerBean, systemAuditBean);

                        if (delResult) {

                            request.setAttribute("successMsg", MessageVarList.LISTENER_SUCCESS_DELETE + " " + listenerBean.getListenerId());
                            sessionObj.setAttribute(SessionVarName.SESSION_OBJ, sessionVarlist);
                            request.setAttribute("operationtype", "ADD");
                            rd = getServletContext().getRequestDispatcher("/LoadListenerConfigurationServlet");
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete Listener. Listener Id : " + listenerBean.getListenerId() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public boolean listenerDelete(ListenerConfigurationBean listenerBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            listenerManager = new ListenerConfigurationManager();
            success = listenerManager.listenerDelete(listenerBean, systemAuditBean);

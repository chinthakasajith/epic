...
/**
 *this servlet use for wrote add operation for credit score
 * @author ayesh
 */
public class AddCreditScoreFieldDifServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            newValue = creditBean.getFieldCode() + "|" + creditBean.getFieldDes() + "|" + creditBean.getFormName() + "|" +
                    creditBean.getFieldName() + "|" + creditBean.getStatus() + "|" + creditBean.getDataType() + creditBean.getLastUpdateUser();
            ...
            if (CreditScoreFieldManager.getCreditScoreFieldInstance().isValidInput(creditBean)) {
                ...
                row = CreditScoreFieldManager.getCreditScoreFieldInstance().addNewCrediScoreField(creditBean, systemAuditBean);
            } else {
                request.setAttribute("flag", "T");
                request.setAttribute("operationtype", "add");
            ...
            if (row == 1) {
                ...
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.CREDITSCORE_FIELD_FIELDDES_ADD_SUCCESS);
            }


            fieldList = CreditScoreFieldManager.getCreditScoreFieldInstance().getCreditScoreFieldID(creditBean.getFormName());
            sysUserOnj = new SystemUserManager();
            statusBean = sysUserOnj.getStatusByUserRole("GENR");
            request.setAttribute(RequestVarList.SECTION_STATUS_LIST, statusBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Add credit scorefield. Field code: " + uniqueId + " by:" + sessionVarlist.getCMSSessionUser().getUserName());

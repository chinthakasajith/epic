 ...
 * @author nalin
 */
public class LoadVoidTxnInfoServlet extends HttpServlet {
    ...
    private String url = "/mtmm/manualtxn/voidtxnhome.jsp";
        ...
        try {
            try {
                ...
                try {
                    ...
                    String pageCode = PageVarList.VOID_TRANSACTION;
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        ...
                        try {
                            ...
                            if (this.validateUserInput(voidBean.getMerchantID())) {

                                this.getActiveTerminalOfMerchant(voidBean.getMerchantID());
                                this.getTerminalTxnInfo(voidBean.getTerminalID(),voidBean.getMerchantID());
    ...
    private List<SaleTxnBean> getTerminalTxnInfo(String terminalID,String merchantId) throws Exception {
        ...
        try {
            ...
            voidList = saleTxnManager.getTerminalTxnInfo(terminalID,merchantId);
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            voidBean.setMerchantID(request.getParameter("merchantID"));
            voidBean.setMerchantName(request.getParameter("merchantName"));
            voidBean.setTerminalID(request.getParameter("terminalID"));

 ...
 * @author badrika
 */
public class UpdateHotlistReasonMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            reasonBean = reasonMgtManager.viewSelectedReason(id);
            if (reasonBean != null) {
                
                request.setAttribute("reasonBean", reasonBean);
                String oldValue = reasonBean.getReasonCode() + "|" + reasonBean.getDescription() + "|" + reasonBean.getStatusDes();

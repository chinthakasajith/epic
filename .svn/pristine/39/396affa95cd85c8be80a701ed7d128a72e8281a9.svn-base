 ...
 * @author chanuka
 */
public class ProcessGenerateAllMasterCardServlet extends HttpServlet {
...
////////                            this.getAllMASTERCardToEmboss(tmp,StatusVarList.CREDIT);
                            this.getAllVISACardToEmboss(tmp, StatusVarList.CREDIT);

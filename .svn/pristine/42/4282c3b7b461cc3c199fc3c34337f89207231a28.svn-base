 ...
 * @author chinthaka_r
 */
public class LoadAssignSchemaToCrdtAppConfirmationUserRole extends HttpServlet {
    ...
    private List<UserRoleBean>notAssignedUserRoleList=null;
    private List<UserRoleBean>assignedUserRoleList=null;
    ...
    private void getUserRoleListNotAssignedBySchemaCode(String schema) throws Exception{
        try {
            ...
            notAssignedUserRoleList=systemUserRoleManager.getUnassignedUserRolesToSchema(schema);
            sessionVarlist.setNotAssignedUserRolesToSchemaList(notAssignedUserRoleList);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    private void getUserRoleListAssignedBySchemaCode(String schema) throws Exception{
        try {
            systemUserRoleManager=new SystemUserRoleManager();
            assignedUserRoleList=systemUserRoleManager.getAssignedUserRolesToSchema(schema);
            sessionVarlist.setAssignedUserRolesToSchemaList(assignedUserRoleList);
        } catch (Exception e) {
            throw e;
        }
    }

 ...
 * @author mahesh_m
 */
public class UpdateAmexIMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update AMEX DMK_AC and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

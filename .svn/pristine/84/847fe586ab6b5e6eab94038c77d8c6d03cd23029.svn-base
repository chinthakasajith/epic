 ...
 * @author nalin
 */
public class UploadSecondarySignatureServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (isMultipart) {
                ...
                try {
                    ...
                    while (itr.hasNext()) {
                        ...
                        if (item.isFormField()) {
                            ...
                            if (item.getFieldName().equals("signatureS")) {
                                ...
                                if (!(item.getSize() > fsize * 1024)) {
                                    ...
                                    if (osType.equals("WINDOWS")) {
                                        rootPath = commonFilePathBean.getScandocument() + File.separator + applicationId + File.separator + "SECONDARY_SIGNATURE";
                                    ...
                                    sessionVarlist.setSecondrySignatureFileName(fileName);
                                    request.setAttribute("successMsg", MessageVarList.FILE_UPLOADED);

                                } else {

                                    invalidMsgBean.setSignatureFileName(MessageVarList.IMAGE_SIZE_TOO_LARGE);
                ...
                } catch (SizeLimitExceededException slex) {
                    throw slex;
                }
            ...
            request.setAttribute("errorMsg", "File Too large");
            //request.setAttribute("sPersonalBean", personalBean);
            request.setAttribute("selectedtab", "1");
...
//          
            ...
            fileName = id + "_SECONDARY_SIGNATURE" + "." + extention;

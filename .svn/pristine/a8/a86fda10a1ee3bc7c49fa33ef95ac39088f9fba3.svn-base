 ...
 * @author chanuka
 */
public class LoadUpdateDebitCardTemplateFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (DebitCardTemplateBean cardTempBean : searchList) {
                if (cardTempBean.getTemplateCode().equals(templateCode)) {
                    debitBean = cardTempBean;
                }
            }
            if (debitBean != null) {
                String oldValue = debitBean.getTemplateCode() + "|" + debitBean.getTemplateName() + "|" + debitBean.getValidFrom() + "|"

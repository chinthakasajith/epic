 ...
 * @author janaka_h
 */
public class SetUpdateAccountDataToSessionServlet extends HttpServlet {
...
//                sessionVarlist.setSessionBankDetailList(bankDetailsBeanLst);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SetUpdateAccountDataToSessionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

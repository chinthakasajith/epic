<%-- 
    Document   : paymentplanhome
    Created on : Jul 26, 2016, 10:29:12 AM
    Author     : sajith_g
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeUpdate()
            {
                ...
                document.updatepaymentplanform.action = "${pageContext.request.contextPath}/UpdateConfirmedPaymentPlanServlet";
                document.updatepaymentplanform.submit();
            }
            function invokeAdd()
            {

                document.addpaymentplanform.action = "${pageContext.request.contextPath}/AddPaymentPlanServlet";
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadPaymentPlanMgtServlet";
            }

            function updateReset(value)
            {

                window.location = "${pageContext.request.contextPath}/UpdatePaymentPlanServlet?paymentplancode=" + value;
            }
            
            function ConfirmDelete(paymentplancode)
            {
                $("#dialog-confirm").html("<p>Do you really want to delete "+paymentplancode+" payment plan ?</p>");
                $("#dialog-confirm").dialog({
                    ...
                    buttons: {
                        ...
                        "Yes": function () {
                            window.location = "${pageContext.request.contextPath}/DeletePaymentPlanServlet?paymentplancode=" + paymentplancode;
                        }
                    }
                });
        ...
        <script >
            function settitle() {
                ...
                $.post("${pageContext.request.contextPath}/SetNavigationTitleServlet",
                        {pagecode: '<%= PageVarList.PAYMENTPLAN%>'
                        },
                function (data) {
        ...
        <title>EPIC CMS PAYMENT PLAN HOME</title>
    </head>
    <body>
                                        ...
                                        <table border="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a  href="#"  onclick="invokeHistory('<%=PageVarList.PAYMENTPLAN%>')"><img src="<%=request.getContextPath()%>/resources/images/history-icon.gif" width="40" height="40" title="History View"/></a></td>
                                                </tr>
                                    ...
                                    <form id="paymentPlanViewForm" action="" method="POST" name="viewpaymentPlanform">
                                        ...
                                        <table border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><a  href="#"  onclick="invokeHistory('<%=PageVarList.PAYMENTPLAN%>')"><img src="<%=request.getContextPath()%>/resources/images/history-icon.gif" width="40" height="40" /></a></td>
                                            </tr>
                                        </table>
                                    ...
                                    <tbody >
                                        <c:forEach var="paymentplan" items="${paymentPlanList}">
                                            <tr>
                                                ...
                                                <td  ><a href='${pageContext.request.contextPath}/ViewPaymentPlanServlet?paymentplancode=<c:out value="${paymentplan.paymentplancode}"></c:out>'>View</a></td>
                                                <td  ><a href='${pageContext.request.contextPath}/UpdatePaymentPlanServlet?paymentplancode=<c:out value="${paymentplan.paymentplancode}"></c:out>'>Update</a></td>

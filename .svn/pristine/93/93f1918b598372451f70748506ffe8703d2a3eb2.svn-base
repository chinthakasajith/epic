 ...
 * @author mahesh_m
 */
public class UpdateMasterPVVAPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MASTER PVVA and PVVA KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

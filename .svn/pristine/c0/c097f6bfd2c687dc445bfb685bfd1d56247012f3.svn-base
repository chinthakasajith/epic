...
/**
 * this is now called transaction alert
 * @author nisansala
 */
public class ViewViewFailAlertServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (rdStatus.equals("1")) {
                    row = vwfailAlertMgr.updateReadStatus(id);
                ...
                rd = getServletContext().getRequestDispatcher("/LoadViewFailAlertServlet");
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Read Transaction Alert. Transaction Alert Code: '" + request.getParameter("txnid") + "' by " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.FAILALERT);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewViewFailAlertServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

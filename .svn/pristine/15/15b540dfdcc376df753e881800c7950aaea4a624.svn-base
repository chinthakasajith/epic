 ...
 * @author nalin
 */
public class AddCommissionProfileServlet extends HttpServlet {
    ...
    private CommissionProfileBean comisBean;
                    ...
                    try {
                        ...
                        if (validateUserInput(comisBean)) {
                            ...
                            try {
                                ...
                                boolean successInsert = this.commissionProfileInsert(comisBean, sessionVarlist.getCommissionTxnList(), systemAuditBean);

                                if (successInsert) {

                                    request.setAttribute("successMsg", MessageVarList.COMMISSION_PROFILE_SUCCESS_ADD + " " + comisBean.getComProfileCode());
    ...
    private boolean commissionProfileInsert(CommissionProfileBean comisBean, List<CommissionProfileBean> comisTxnList, SystemAuditBean systemAuditBean) throws Exception {
        boolean isSuccess = false;

        try {

            comisManager = new CommissionProfileManager();
            isSuccess = comisManager.commissionProfileInsert(comisBean, comisTxnList, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Commission Profile. Commission Profile Code : " + comisBean.getComProfileCode() + "; By : " + sessionVarlist.getCMSSessionUser().getUserName());

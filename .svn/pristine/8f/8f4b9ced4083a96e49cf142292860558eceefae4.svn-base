 ...
 * @author badrika
 */
public class LoadPermLimitIncrementRequestServlet extends HttpServlet {
    ...
    private PermLimitIncrementRequestManager permIncrementManager = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.PERM_LIMIT_INC_REQ;
    ...
    private TempLimitIncrementBean getCardDetails(String cardNumber) throws Exception {
        try {
            ...
            tempBean = permIncrementManager.getCardDetails(cardNumber);
        } catch (Exception ex) {
            throw ex;
        }
        return tempBean;

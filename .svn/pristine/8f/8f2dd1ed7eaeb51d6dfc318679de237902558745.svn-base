 ...
 * @author asitha_l
 */
public class LoadUpdateCaseTypeServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (CaseTypeBean bean : caseList) {
                            if (bean.getCaseTypeCode().equals(caseTypeCode)) {
                                caseTypeBean = bean;
                            }
                        }
                        ...
                        if (caseTypeBean != null) {
                            ...
                            String oldValue = caseTypeBean.getCaseTypeCode() + "|" + caseTypeBean.getDescription() + "|"

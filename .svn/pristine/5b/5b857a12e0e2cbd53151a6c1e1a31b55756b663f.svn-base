<%-- 
    Document   : userrolepageassign
    Created on : Jan 19, 2012, 12:21:07 PM
    Author     : chanuka
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            {
                document.sectionpageassignform.action="${pageContext.request.contextPath}/GetsectionsByApplicationServlet?userrolecode=${userRole}&id=two";
                document.sectionpageassignform.submit();
            }
            function invokeAssignPages()
            {
                document.sectionpageassignform.action="${pageContext.request.contextPath}/GetpagesBySectionServlet?userrolecode=${userRole}&id=one";
                document.sectionpageassignform.submit();
            }
            ...
            function selectAll(selectBox1,selectBox2) {
                ...
                document.sectionpageassignform.action="${pageContext.request.contextPath}/ManageUserRolePageServlet?userRoleCode=${userRole}";
                document.sectionpageassignform.submit();
            }
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form name="sectionpageassignform" action="" method="POST">
                                        ...
                                        <tr>
                                            <td>
                                                <select name="notassignpagelist" style="width: 200px"  id=in multiple="multiple"  size=10>
                                                    <c:forEach  var="page" items="${sessionScope.SessionObject.notAssignUserRolePages}">
                                    ...
                                    <table>
                                        <tr>
                                            <td><input type="submit" onclick="selectAll(notassignpagelist,assignpagelist)" name="assignpage" value="Assign" style="width: 100px"></td>

 ...
 * @author nisansala
 */
public class LoadCardChangeRequestServlet extends HttpServlet {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        try {
                            ...
                            //load card product according to the card type
                            this.loadCardProduct(card.getCardType());
...
//                            sessionVarlist.setCardStatus(card.getCurrentStatus());
    ...
    private void getCardDetails(String cardNo) throws Exception {
        try {
            ...
            card = cdChngMgr.getCardDetails(cardNo);
        } catch (Exception e) {
            throw e;
        }
    }

 ...
 * @author mahesh_m
 */
public class BlockTerminalServlet extends HttpServlet {
   ...
   private String oldValue;
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    for(TerminalDataCaptureBean bean : list){
                        if(bean.getTerminalID().equals(terminalId)){
                            oldValue = bean.getTerminalStatus() + "|"  + bean.getLastUpdateUser();
                        }
                    }
                    
                    newValue = StatusVarList.TERMINAL_BLOCK + "|" +  sessionVarlist.getCMSSessionUser().getUserName(); 
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Blocked " + " Terminal ID = " + terminalId + " by " + sessionVarlist.getCMSSessionUser().getUserName());

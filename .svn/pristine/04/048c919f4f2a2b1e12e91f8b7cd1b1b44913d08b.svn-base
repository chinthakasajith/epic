 ...
 * @author jeevan
 */
public class ApplicationEmboseEncodeReportPdfServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        String path = "/resources/reports/applicationreport/EmbodeAndEmcodeCard.jasper";
...
//                            }
                        ...
                        ex.printStackTrace();
                        request.setAttribute("errorMsg", MessageVarList.ERROR_EM_EN_CD_REPORT_GEN);

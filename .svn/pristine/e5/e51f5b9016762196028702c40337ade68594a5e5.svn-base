<%-- 
    Document   : AQCLCENTER
    Created on : Nov 21, 2012, 11:53:20 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getAcqcallSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=AQCLCENTER"><p><center><font size="2" style="font-weight: bold;">ACQUIRE SERVICE</font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;">ACQUIRE SERVICE</font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('AQCLCENTER', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

 ...
 * @author mahesh_m
 */
public class UpdateCurrencyMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (CurrencyBean currencyBean : sessionVarlist.getCurrencyDetailList()) {

                            if (currencyBean.getCurrencyCode().equals(currencyCode)) {
                        ...
                        if (currency != null) {
                            ...
                            String oldValue = currency.getCurrencyCode() + "|" + currency.getCurrencyAlphaCode() + "|" + currency.getExponent()+ "|" +

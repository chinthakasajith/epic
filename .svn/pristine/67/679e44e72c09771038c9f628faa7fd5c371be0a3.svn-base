 ...
 * @author asela
 */
public class UpdateCreditProprietaryPPKPanelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ppk.length() == 32) {
                if (UserInputValidator.isHexxx(ppk)) {
                    securityModule = new ConnectionToSecurityModule();
                    try {
                        String KVC = securityModule.getServerMsg(StatusVarList.PPK_PREFIX + ppk).substring(4);
                        ...
                        if (chanelId == null) {
                            ...
                            if (keyMgtmanager.isChanelAvailable(chanelId)) {
                                keyMgtmanager.updateppk(ppk, KVC, chanelId, systemAuditBean);
                            } else {
                                keyMgtmanager.addppk(ppk, KVC, chanelId, systemAuditBean);
                            }
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MASTER PPK and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

                    ...
                    try {
                        ...
                        if (standingOrderBean != null) {
                            String oldValue = standingOrderBean.getOrderID() + "|" + standingOrderBean.getOrderName() + "|"
                                    + "" + standingOrderBean.getCategory() + "|" + standingOrderBean.getUtilityProvider()+ "|"
                                    + "" + standingOrderBean.getAccNumber()+ "|" + standingOrderBean.getBranchCode()+ "|"
                                    + "" + standingOrderBean.getContactPerson()  + "|" + standingOrderBean.getContactNumber() + "|"
                                    + "" + standingOrderBean.getFeeType() + "|" + standingOrderBean.getCurrencyType() + "|"
                                    + "" + standingOrderBean.getMaxTransactionAmt()+ "|" + standingOrderBean.getMaxTransactionAmt() + "|"
                                    + "" + standingOrderBean.getStatusCode()+ "|" +standingOrderBean.getBankCode();

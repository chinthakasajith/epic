 ...
 * @author janaka_h
 */
public class RemoveUpdateBankDataFromSessionServlet extends HttpServlet {
...
//          
            ...
            if (sessionVarlist.getApplicationTypeCode().equals(StatusVarList.CARD_AGAINST_FD_CODE)) {
                LoadApplicationStatus.loadDefaultCardagainstFDApplicationStatusInUpdate(sessionVarlist.getApplicationId(), sessionVarlist, request, Boolean.FALSE, 1, false);
                ...
                LoadApplicationStatus.loadDefaultEstablishmentApplicationStatusInUpdate(sessionVarlist.getApplicationId(), sessionVarlist, request, Boolean.FALSE, null, 2, false);
...
//                sessionVarlist.setSessionBankDetailList(bankDetailsBeanLst);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveUpdateBankDataFromSessionServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 * @author jeevan
 */
public class AddTerminalManufacServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success > 0) {
                ...
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.CODE_ADD_SUCCESS+" code "+bean.getManufactureCode());
            }
    ...
    private boolean validateUserInput(TerminalBean bean) throws Exception {
        ...
        try {
            ...
            if (bean.getManufactureCode().contentEquals("") || bean.getManufactureCode().length() <= 0) {
                ...
                isValidate = false;
                errorMessage = MessageVarList.TER_CODE_INVALID;
            }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Add Terminal Manufacture. Code: " + uniqueId + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    private int insertNewCode() throws Exception {
        try {

            terminalMgtManager = new TerminalMgtManager();
            int i = terminalMgtManager.insertNewCode(systemAuditBean, bean);
            return i;

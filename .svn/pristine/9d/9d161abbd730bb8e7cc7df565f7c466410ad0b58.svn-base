 ...
 * @author prageeth_s
 */
public class UpdateCustomerContactDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cardNumber=sessionVarlist.getCallcenterSearchCardCardNo();
            ...
            if (validateCustomerContactDetails()) {
                ...
                callCenterMgtManager.addCustomerDetailChangeRequest(customerPersonalBean, changeTracker, cardNumber, cardCategory);
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.SUCCESS_UPDATE_COMMON);
    ...
    private void getCustomerContactDetails(HttpServletRequest request) {
        ...
        customerPersonalBean.setIdentificationNumber(request.getParameter("identificationNumber"));

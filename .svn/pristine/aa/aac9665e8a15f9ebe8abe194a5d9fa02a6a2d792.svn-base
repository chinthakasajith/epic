 ...
 * @author nisansala
 */
public class SetCustomerTemplateDropDownServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SetCustomerTemplateDropDownServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

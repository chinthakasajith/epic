 ...
 * @author admin
 */
public class UpdateAtmTPKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update ATM TPK and TPK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

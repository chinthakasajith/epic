<%-- 
    Document   : CARDEMBOSS
    Created on : Nov 21, 2012, 11:55:06 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getCardembossSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=CARDEMBOSS">-->
                    <p><center><font size="2" style="font-weight: bold;">CARD PERSONALIZE</font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('CARDEMBOSS', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

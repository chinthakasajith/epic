 ...
 * @author nalin
 */
public class UpdateBulkCardPinDistributionServlet extends HttpServlet {
...
//                                distBean.setLastUpdatedUser(sessionUser.getUserName());
                                ...
                                try {
                                    ...
                                    if (opType.equals("card")) {
                                        successUpdate = bulkManager.proceedCardDistribution(distributeList, systemAuditBean);

                                        if (successUpdate) {

                                            request.setAttribute("successMsg", MessageVarList.BULK_CARD_DISTRIBUTION_SUCCESS);

                                        }
                                    }
                                    if (opType.equals("pin")) {
                                        successUpdate = bulkManager.proceedPinDistribution(distributeList, systemAuditBean);

                                        if (successUpdate) {

                                            request.setAttribute("successMsg", MessageVarList.BULK_CARD_PIN_DISTRIBUTION_SUCCESS);
                            ...
                            if (opType.equals("card")) {
                                ...
                                request.setAttribute("errorMsg", MessageVarList.SELECTED_BATCH_NULL);
                                rd = getServletContext().getRequestDispatcher(url);

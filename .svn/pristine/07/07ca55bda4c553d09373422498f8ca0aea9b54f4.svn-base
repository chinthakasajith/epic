 ...
 * @author nalin
 */
public class LoadCallCenterCardTxnUpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getAssignedTxnType(cardNo);
            this.getNotAssignedTxnType(cardNo);
    ...
    private List<TypeMgtBean> getNotAssignedTxnType(String cardNo) throws Exception {
        notAssignedTxnList = new ArrayList<TypeMgtBean>();
        try {

            cardManager = new CardTxnMgtManager();
            notAssignedTxnList = cardManager.getNotAssignedTxnType(cardNo);
    ...
    private List<TypeMgtBean> getAssignedTxnType(String cardNo) throws Exception {
        assignedTxnList = new ArrayList<TypeMgtBean>();
        try {

            cardManager = new CardTxnMgtManager();
            assignedTxnList = cardManager.getAssignedTxnType(cardNo);

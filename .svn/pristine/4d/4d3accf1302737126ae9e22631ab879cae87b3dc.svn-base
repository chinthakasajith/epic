 ...
 * @author ayesh
 */
public class DeleteExchangeRateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            exChangeRateBean.setFromCurrency(Integer.parseInt(store[0]));
            exChangeRateBean.setToCurrency(Integer.parseInt(store[1]));

            this.setAudittraceValue(request, exChangeRateBean);
            int row = ExchangeRateManager.getExchangeRateManager().deleteExchangeRate(exChangeRateBean, systemAuditBean);

            if (row == 1) {
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.EXCHANGERATE_DELETE_SUCCESS);
            }
    ...
    private void setAudittraceValue(HttpServletRequest request, ExChangeRateBean bean) throws Exception {


        try {
            systemAuditBean = new SystemAuditBean();
            ////get unique Id from the page.It may be the primary key---------------
            String uniqueId = String.valueOf(bean.getFromCurrency());
            String toCur = String.valueOf(bean.getToCurrency());
            ...
            //set description 
            systemAuditBean.setDescription("DELETE " + uniqueId + " Exchange rate  by " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            //add remarks here
            systemAuditBean.setRemarks(uniqueId + " - " + toCur);

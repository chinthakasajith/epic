 ...
 * @author badrika
 */
public class UpdateMerchantCustomerMgtServlet extends HttpServlet {
...
//                errorMessage = MessageVarList.POSTAL_CODE_NULL;
                ...
                errorMessage = MessageVarList.NAME_INVALID;
            ...
            } else if (!UserInputValidator.isAlpha(merchantBean.getCpLastName())) {
                isValidate = false;
            ...
            } else if (!UserInputValidator.isNumeric(merchantBean.getTpNumber())) {
                isValidate = false;
            ...
            } else if (!UserInputValidator.isNumeric(merchantBean.getFax())) {
                isValidate = false;
...
//                errorMessage = MessageVarList.RISK_PROFILE_NULL;
            ...
            } else if (!UserInputValidator.isAlphaNumeric(merchantBean.getAccountNumber())) {
                isValidate = false;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update: '" + merchantBean.getMerchantCustomerNumber() + "' Merchant Customer Number by : " + sessionVarlist.getCMSSessionUser().getUserName());
            ...
            systemAuditBean.setPageCode(PageVarList.CALLCENTER_MERCHANT_CUSTOMER_UPDATE);

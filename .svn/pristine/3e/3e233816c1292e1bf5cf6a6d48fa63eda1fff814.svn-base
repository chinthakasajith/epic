 ...
 * @author mahesh_m
 */
public class UpdateMasterIMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MASTER DMK_AC and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

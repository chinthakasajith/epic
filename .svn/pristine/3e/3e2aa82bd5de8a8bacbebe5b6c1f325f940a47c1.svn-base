 ...
 * @author badrika
 */
public class GetCardProductToRenewServlet extends HttpServlet {
    ...
    private HashMap<String, String> cardProductList;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getAllCardProductByCardType(cardSearchBean.getcType());

 ...
 * @author nalin
 */
public class UploadPrimarySignatureServlet extends HttpServlet {
        ...
        try {
            ...
            if (isMultipart) {
                ...
                String identificationNumber = request.getParameter("identificationNumber");
                 if (request.getContentLength() < fsize * 1024) {
                            ...
                            if (item.getFieldName().equals("signature")) {
                                ...
                                if (!(item.getSize() > fsize * 1024)) {
                                    ...
                                    if (osType.equals("WINDOWS")) {
                                        rootPath = commonFilePathBean.getScandocument() + File.separator + applicationId + File.separator + "PRIMARY_SIGNATURE";
...
//          
            ...
            fileName = id + "_PRIMARY_SIGNATURE" + "." + extention;

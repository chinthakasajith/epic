 ...
 * @author mahesh_m
 */
public class LoadInterestProfileServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        request.setAttribute("transactionDetails", transactionTypeDetails);
    ...
    private void getAllStatus(String categoryCode) throws Exception {
      ...
      private void getTransactionTypeDetails() throws Exception{
        try {
             interestProfileManager = new InterestProfileManager();
             transactionTypeDetails = interestProfileManager.getTransactionTypekDetails();
        } catch (Exception e) {
             throw e;
        }
    }

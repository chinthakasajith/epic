 ...
 * @author nisansala
 */
public class LoadCardCloseServlet extends HttpServlet {
            ...
            try {
                ...
                try {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        request.setAttribute("operationType", "close");
                        try {
                            //get the details of the given card number
    ...
    private void getCardDetails(String cardNo) throws Exception {
        try {
            ...
            card = cdClskMgr.getCardDetails(cardNo);
        } catch (Exception e) {
            throw e;
        }
    }
    
    private void getReasons() throws Exception {
        try {

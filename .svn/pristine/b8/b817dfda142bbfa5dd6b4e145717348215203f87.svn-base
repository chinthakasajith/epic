 ...
 * @author mahesh_m
 */
public class UpdateVisaPlusZCMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA PLUS ZCMK and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

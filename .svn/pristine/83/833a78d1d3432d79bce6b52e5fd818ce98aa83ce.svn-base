<%-- 
    Document   : searchdebitcardapplications
    Created on : Aug 22, 2012, 4:35:14 PM
    Author     : janaka_h
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeAssignSearch()
            {
                ...
                document.searchuserassignform.action="${pageContext.request.contextPath}/SearchDebitCardApplicationServlet";
                                    ...
                                    <tbody>
                                        <c:forEach var="assignapp" items="${sessionScope.SessionObject.userAssignDebitAppList}">
                                            <tr>
                                                ...
                                                <td  ><a href='${pageContext.request.contextPath}/LoadDebitCardApplicationFormServlet?applicationid=${assignapp.applicationId}&cardcategory=${assignapp.cardCategory}'>Edit</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>

 ...
 * @author ayesh
 */
public class DeleteSectionMgtServlet extends HttpServlet {
    ...
    private String url = "/LoadSectionMgtServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int rowcount = SectionManager.getInstance().deleteSection(sectionID, systemAuditBean);

            if (rowcount == 1) {
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.SECTION_DELETE_SUCCESS);
            } else {
                request.setAttribute(MessageVarList.JSP_ERROR, MessageVarList.SECTION_DELETE_ERROR);
            }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Delete section, section code : " + uniqueId + " by " + sessionVarlist.getCMSSessionUser().getUserName());

<%-- 
    Document   : visakeymanagement
    Created on : Apr 24, 2012, 3:45:16 PM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVA(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterPVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterPVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterPVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVA(){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/UpdateMasterCVVAServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterCVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterIMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterPPKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateTPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMasterTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.MASTER_KEY_MGT%>'                                  
                },
                function(data) {

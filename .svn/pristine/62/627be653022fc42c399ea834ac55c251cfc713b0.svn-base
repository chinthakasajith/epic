 ...
 * @author nisansala
 */
public class LoadSequrityQuestionServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    tables = securityQuesMgr.tablesToCardCategory(cardCategoryLst.get(0).getCategoryCode());
                    sessionObj.setAttribute(SessionVarName.SESSION_OBJ, sessionVarlist);
                    request.setAttribute("tableList", tables);
                    request.setAttribute("cardCategory", cardCategoryLst.get(0).getCategoryCode());

 ...
 * @author mahesh_m
 */
public class UpdateZCMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update VISA ZCMK and KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

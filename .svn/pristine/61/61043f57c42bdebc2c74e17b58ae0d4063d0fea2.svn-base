 ...
 * @author mahesh_m
 */
public class LoadTaskMgtServlet extends HttpServlet {

    private RequestDispatcher rd;
    private SessionVarList sessionVarlist = null;
    private TaskMgtManager taskMnager;
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    try {
                        ...
                        this.getDataFromTaskTable();
                        sessionVarlist.setTaskDetails(taskDetails);
                        sessionObj.setAttribute(SessionVarName.SESSION_OBJ, sessionVarlist);
    ...
    private void getDataFromTaskTable() throws Exception {
        try {
            taskMnager = new TaskMgtManager();
            taskDetails = taskMnager.getTaskDetails();
        } catch (Exception e) {
            throw e;
        }
    }

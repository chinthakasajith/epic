 ...
 * @author badrika
 */
public class SearchBulkCardQualityMgtServlet extends HttpServlet {
                    ...
                    try {
                        ...
                        if (validateUserInput(cardNumber)) {
                            ...
                            try {
                                ...
                                cardBean = cardManager.getBulkCardDetails(cardNumber);
    ...
    public boolean validateUserInput(String cardNumber) throws Exception {
        ...
        try {
            ...
            } else if (!UserInputValidator.isNumeric(cardNumber)) {
                isValidate = false;
                errorMessage = MessageVarList.CARD_NUMBER_NULL;
            }

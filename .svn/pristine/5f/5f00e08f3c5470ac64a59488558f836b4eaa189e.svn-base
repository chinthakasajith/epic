 ...
 * @author nalin
 */
public class LoadRiskProfileMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ///// get Status list
            List<StatusBean> statusList = sysUserObj.getStatusByUserRole(StatusVarList.GENESTATUCAT);
            sessionVarlist.setStatusList(statusList);

            ///////////////////////risk type set to the session list///////////////////////////////////
            
            riskManager = new RiskProfileManager();
            riskTypeList = new ArrayList<RiskProfileTypeBean>();
            riskTypeList = riskManager.getRiskProfileType();
            
            sessionVarlist.setRiskTypeList(riskTypeList);
            
            ///////////////////////////////////////
            //get risk profile details for table view

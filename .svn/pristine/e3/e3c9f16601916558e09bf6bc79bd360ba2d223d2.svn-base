...
public class UpdateUserRoleServlet extends HttpServlet {
    ...
    private SystemUserLevelManager systemUserLevelManager=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userRoleBean != null) {
                ...
                String oldValue = userRoleBean.getUserRoleCode() + "|" + userRoleBean.getDescription() + "|" + userRoleBean.getStatusCode()+"|"+userRoleBean.getUserLevelID();

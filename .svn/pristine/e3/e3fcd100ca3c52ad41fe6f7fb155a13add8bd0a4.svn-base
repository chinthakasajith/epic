 ...
 * @author badrika
 */
public class AddAquireBinManagementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (this.validateUserInput(aqbean)) {
                ...
                this.insertAquireBin(aqbean, systemAuditBean);

                request.setAttribute("successMsg", aqbean.getBinNumber() + " " + MessageVarList.BIN_ADD_SUCCESS);
...
//                errorMessage = MessageVarList.PAY_TYPE_EMPTY;
    ...
    public boolean insertAquireBin(AquireBinBean aqBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            AquireBinManager = new AquireBinManagementManager();
            success = AquireBinManager.insertAquireBin(aqBean, systemAuditBean);
        } catch (Exception ex) {
            throw ex;
        }
        return success;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Acquiring Bin. Bin Number: " + aqbean.getBinNumber() + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

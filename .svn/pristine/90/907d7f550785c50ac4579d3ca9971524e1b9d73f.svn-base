 ...
 * @author mahesh_m
 */
public class UpdateMaestroZMKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update MAESTRO ZMK and ZMK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

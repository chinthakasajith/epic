 ...
 * @author nalin
 */
public class ViewBulkCardNumberGenerationServlet extends HttpServlet {
    ...
    private BulkCardRequestBean numGenViewBean = null;
    private BulkCardNumberGenerationManager bulkNumGenManager = null;
    private String batchID = null;
    private String url = "/prem/bulkcardmgt/bulkcardnumbergenerationview.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            numGenViewBean = bulkNumGenManager.getBulkCardBatch( batchID);

            request.setAttribute("numGenViewBean", numGenViewBean);

 ...
 * @author asitha_l
 */
public class DeleteStandingOrderTypeServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        boolean delResult = deleteStandingOrder(id, systemAuditBean);

                        //if the deletion is success, proceed
                        if (delResult) {
                            this.getAllStandingOrderData();
                            request.setAttribute("standingOrderList", standingOrderList);
                            request.setAttribute("successMsg", " " + "Successfully deleted Standing Order " + id);
     ...
     * @throws Exception 
     */
    public boolean deleteStandingOrder(String id, SystemAuditBean systemAuditBean) throws Exception {
        boolean success = false;

       standingOrderTypesManager = new StandingOrderTypesManager();
       success = standingOrderTypesManager.deleteStandingOrder(id, systemAuditBean);

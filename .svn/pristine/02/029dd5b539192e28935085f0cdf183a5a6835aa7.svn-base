 ...
 * @author badrika
 */
public class DeleteHotlistReasonMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HotlistReasonBean reasonBean = reasonMgtManager.viewSelectedReason(id);           
            
           oldValue = reasonBean.getReasonCode() + "|" + reasonBean.getDescription() + "|" + reasonBean.getStatusDes();            
            
            this.setAudittraceValue(request);

            int success = deleteReason(id);

            if (success > 0) {

                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.REASON_DELETE_SUCCESS);
            }
     ...
     * @throws Exception 
     */
    public int deleteReason(String id) throws Exception {
        int i =-1;
        try {
            reasonMgtManager = new HotlistReasonMgtManager();
            i= reasonMgtManager.deleteReason(id, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Delete Hot List Reason. Reason Code: " + id + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());

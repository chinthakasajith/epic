 ...
 * @author sajith
 */
public class ViewEmailConfServlet extends HttpServlet {
    ...
    private EmailBean templateBean = null;
    private String url = "/administrator/templatemgt/emailtemplate/emailtemplateview.jsp";
    private String domainHomeUrl = "/administrator/templatemgt/emailtemplate/emailhome.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                this.getSelectedEmailConfTemplate(request.getParameter("templatecode"));
    ...
    private void getSelectedEmailConfTemplate(String id) throws Exception {
        try {

            domainManager = new EmailConfMgtManager();
            templateBean = domainManager.viewSelectedEmailConf(id);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewEmailConfServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 * @author jeevan
 */
public class UpdateAregMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = areaMgtManager.vireSelectedData(id);

            this.getProvinceType(bean.getProvinceName()); 
            request.setAttribute("districtList", areaBeanList);
            
            if (bean != null) {
                request.setAttribute("areaBean", bean);

                String oldValue = bean.getAreaCode() + "|" + bean.getAreaDescription() + "|" + bean.getProvinceName()
                        + "|" + bean.getDistriceName();

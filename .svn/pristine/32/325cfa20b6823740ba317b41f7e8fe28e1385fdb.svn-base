 ...
 * @author mahesh_m
 */
public class SearchDebitPinMailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String pageCode = PageVarList.DEBIT_PINMAIL;
...
//            searchBean.setEmbossType(embossType);
    ...
    private void getAllPinMailList() throws Exception {
        try {
            ...
            pinAndmailManager = new PinGenerationAndmailManager();
            pingMailList = pinAndmailManager.getAllPinMailList(searchBean,DataTypeVarList.CARD_DOMAIN_DEBIT);

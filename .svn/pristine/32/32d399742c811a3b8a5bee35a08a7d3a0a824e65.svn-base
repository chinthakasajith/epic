 ...
 * @author nalin
 */
public class AddListenerConfigurationServlet extends HttpServlet {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        if (validateUserInput(listenerBean)) {
                            ...
                            try {
                                successInsert = listenerInsert(listenerBean, systemAuditBean);

                                if (successInsert) {

                                    request.setAttribute("successMsg", MessageVarList.LISTENER_SUCCESS_ADD);
    ...
    public boolean validateUserInput(ListenerConfigurationBean listenerBean) throws Exception {
        ...
        try {
            ...
            if (listenerBean.getListenerType().contentEquals("") || listenerBean.getListenerType().length() <= 0) {
                isValidate = false;
            ...
            } else if (listenerBean.getStablishPort().equals(listenerBean.getTerminatedPort())) {

                isValidate = false;

                errorMessage = MessageVarList.RER_PORT_TER_PORT_SAME;
    ...
    public boolean listenerInsert(ListenerConfigurationBean listenerBean, SystemAuditBean systemAuditBean) throws Exception {
        ...
        try {
            ...
            listenerManager = new ListenerConfigurationManager();
            success = listenerManager.listenerInsert(listenerBean, systemAuditBean);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Listener. Listener Id : " + listenerBean.getListenerId() + "; by : " + sessionVarlist.getCMSSessionUser().getUserName());

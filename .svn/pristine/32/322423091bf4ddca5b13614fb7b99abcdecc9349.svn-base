...
public class ViewQueueServlet extends HttpServlet {
    ...
    private  List<CaseTypeBean> assignedCases = null;
    QueueBean queueBean;
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        assignedCases = queueManager.getAssignedCases(queueBean.getCode());
                        
                        if (queueBean != null) {
                            request.setAttribute("operationtype", "view");
                            request.setAttribute("queueBean", queueBean);

                            request.setAttribute("assignedCases", assignedCases);                       
    ...
    private ArrayList<QueueBean> getAllQueues() throws Exception {
        try {

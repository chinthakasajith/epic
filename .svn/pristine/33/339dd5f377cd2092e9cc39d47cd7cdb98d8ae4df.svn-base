 ...
 * @author nalin
 */
public class ProceedCallCenterCashAdvancedServlet extends HttpServlet {
    ...
    public Boolean setUserInputToBean(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            cashAdvancedBean.setMerchantID(sessionVarlist.getMerchantId());
            cashAdvancedBean.setTerminalID(this.getManualTerminal(sessionVarlist.getMerchantId()));
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setPageCode(PageVarList.CALLCENTER_CASH_ADVANCED_TRANSACTION);

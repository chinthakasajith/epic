<%-- 
    Document   : acquirecashadvancedtxnhome
    Created on : Apr 17, 2013, 4:46:54 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeTxnInfo()
            {
                ...
                document.saleTxnForm.action="${pageContext.request.contextPath}/LoadCashAdvancedTxnInfoServlet";
            ...
            function invokeProceed()
            {
                ...
                if(answer != 0){
                    document.saleTxnForm.action="${pageContext.request.contextPath}/ProceedCallCenterCashAdvancedServlet";
                    document.saleTxnForm.submit();
                }
                else{
       ...
       <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_CASH_ADVANCED_TRANSACTION%>'                                  
                },
                function(data) {
                        ...
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <table  border="1"  class="display" id="tableview">
                                    ...
                                    <tbody >
                                        <c:forEach var="sale" items="${cashAdvancedList}">
                                            <tr>

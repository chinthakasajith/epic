...
/**
 *  to load the bin numbers according to the card product type
 * @author nisansala
 */
public class SetBinToCardTypeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.getCardProductBins(cardProductBean.getCardType(), cardProductBean.getDomainCode());

            if (BinList.isEmpty()) {
                request.setAttribute("errorMsg", MessageVarList.NO_BINS);
    ...
    private void getCardProductBins(String category, String domain) throws Exception {
        try {

            cardProductMgtManager = new CardProductMgtManager();
            BinList = cardProductMgtManager.getCardProductBins(category, domain);

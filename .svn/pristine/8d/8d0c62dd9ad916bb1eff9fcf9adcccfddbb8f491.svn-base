<%-- 
    Document   : ACBOOP
    Created on : Dec 21, 2012, 3:09:54 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getAqBackOfficeSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ACBOOP"><p><center><font size="2" style="font-weight: bold;" class="appdes2"></font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" class="appdes2"></font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ACBOOP', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

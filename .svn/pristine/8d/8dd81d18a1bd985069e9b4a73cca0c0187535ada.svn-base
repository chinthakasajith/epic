<%-- 
    Document   : cardAgainstFDdocumentviewhome
    Created on : Jun 20, 2016, 10:06:26 AM
    Author     : prageeth_s
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeCancel() {
                ...
                window.location = "${pageContext.request.contextPath}/camm/documentverification/cardAgainstFDdocumentviewhome.jsp";

            }
            function invokeVerify()
            {

                document.applicantverifyform.action = "${pageContext.request.contextPath}/CardagainstFDVerifyApplicantDetailsServlet";
            ...
            function invokeReject()
            {
                ...
                document.applicantverifyform.action = "${pageContext.request.contextPath}/CardagainstFDRejectApplicationDetailsServlet";
                document.applicantverifyform.submit();

            }
            function invokeOnhold() {

                document.applicantverifyform.action = "${pageContext.request.contextPath}/CardagainstFDOnholdApplicationDetailsServlet";
                document.applicantverifyform.submit();
            }
            ...
            function invokeCheckIn(applicationId,type)
            {
                ...
                {
                    window.location = "${pageContext.request.contextPath}/LoadCardagainstFDVerifyFormServlet?applicationid="+applicationId;
                }
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <div class="selector" id="tabs">
                                    ...
                                    <div id="tabs-1" >
                                        ...
                                        <form method="POST" action="${pageContext.request.contextPath}/CardagainstFDUploadCribFileServlet" name="applicantverifyform" enctype="multipart/form-data">
                                    ...
                                    <div id="tabs-2">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <c:forEach var="verifypoint" items="${sessionScope.SessionObject.verificationPointsBeanList}">
                                                    <c:if test="${verifypoint.fieldName =='COLLATERALCONFIRMATIONLETTER'}">
                                                        <c:if test="${checkedApplicantBean.collateralConfirmationLetter =='YES' || previousCheckedBean.collateralConfirmationLetter =='YES'}"> <td style="width: 25px"> <input type="checkbox" name="checkcollateralConfirmationLetter" checked="true" value="ON" style="width: 25px"/></td></c:if>
                                                        <c:if test="${checkedApplicantBean.collateralConfirmationLetter !='YES' && previousCheckedBean.collateralConfirmationLetter !='YES'}"> <td style="width: 25px"> <input type="checkbox" name="checkcollateralConfirmationLetter" value="ON" style="width: 25px"/></td></c:if>
                                                                    <td style="width: 300px">
                                                                    <c:if test="${verifypoint.isMandatory ==true}">
                                                                        <font style="color: red;">*</font>
                                                                    </c:if>

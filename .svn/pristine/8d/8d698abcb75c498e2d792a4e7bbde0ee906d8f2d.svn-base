...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function loadCardTempList(applicationId,currency,cardCategoryCode){
                ...
                var currency = currency;
                var cardCategoryCode = cardCategoryCode;
                                    ...
                                    <div class="outset" style="border-style:outset; background-color: #B8B8B8 ;  border-color: #999; width: 100%">
                                        ...
                                        <table cellpadding="0" cellspacing="10"  >      
                                            ...
                                            <tr>
                                                <td style="width: 200px;">Card Products</td>
                                                <td>
                                                    <select id="cardProduct" name="cardProduct"  onchange="LoadBinProfiles()" class="inputfield-mandatory" >
                                            ...
                                            <tr>
                                                <td style="width: 200px;">Credit Limit in ${currencyAlphaCode}</td>

                                                <td>
                                                    <input type="text" id="creditLmt" name="creditLimit" style="width: 178px;" value="${creditLimit}"></input>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width: 200px;">Customer Template</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="accountTemplates" name="accountTemplates"  onchange="loadCardTempList('${cardApplicationList.applicationId}','${personalDetail.cardCurrency}','${cardApplicationList.cardCategoryCode}')" class="inputfield-mandatory">
                                                        <option value="" selected>-------------SELECT-------------</option>
                                                    </select>

 ...
 * @author ayesh
 */
public class UpdateBankBrachMgtLoadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BankBranchBean bean = null;
            bean = BankBranchMgtManager.getInstance().getSelectedBranch(id, bankCode);
            if (bean != null) {
                request.setAttribute(RequestVarList.BRANCH_DATA_BEAN, bean);

                String oldValue = bean.getBranchName() + "|" + bean.getDescription() + "|" + bean.getBankCode() + "|" + bean.getAddress1() + "|"
                        + bean.getAddress2() + "|" + bean.getAddress3() + "|" + bean.getContactPer() + "|" + bean.getContactNo() + "|"
                        + bean.getDisplayDigit() + "|" + bean.getLastupdateuser()+ "|" + bean.getLastupdatetime();

...
import com.epic.cms.camm.applicationproccessing.cooperate.businesslogic.CorporateCardManager;
 ...
 * @author badrika
 */
public class SearchCorporateCardApplicationServlet extends HttpServlet {
    ...
    private CorporateCardManager coManager;
    ...
    private String url = "/camm/capturedata/searchcorporatecardapplication.jsp";
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.validateUserInput(searchBean, request)) {
                        ...
                        this.corparateCardApplicationsSearch(searchBean);
    ...
    private void corparateCardApplicationsSearch(SearchUserAssignAppBean searchBean) throws Exception {

        try {

            coManager = new CorporateCardManager();
            searchList = coManager.corparateCardApplicationsSearch(searchBean);

 ...
 * @author nalin
 */
public class LoadListenerConfigurationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ///////////////////////////////////////////////
            // get Listener Type List
            listenerManager = new ListenerConfigurationManager();
            List<ListenerTypeBean> listenerTypeList = listenerManager.getListenerType();
            sessionVarlist.setListenerTypeList(listenerTypeList);

            // get Running Mode
            listenerManager = new ListenerConfigurationManager();
            HashMap<String, String> runningModeList = listenerManager.getRunningMode();
            sessionVarlist.setRunningModeList(runningModeList);

            ///// get  Statustype list
            listenerManager = new ListenerConfigurationManager();
            List<StatusTypeBean> statusTypeList = listenerManager.getStatusType();
            sessionVarlist.setStatusTypeList(statusTypeList);

            //// get key Id List

            HashMap<String, String> keyId = listenerManager.getKeyId(StatusVarList.LISTNER_COMMUNICATION_TYPE);

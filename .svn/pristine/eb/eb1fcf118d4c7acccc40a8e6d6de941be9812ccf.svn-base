 ...
 * @author jeevan
 */
public class DeleteEODFileInfoMgtServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success > 0) {
                ...
                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.FILE_INFO_DELETE_SUCCESS + " Code : " + id);
            } else {
    ...
    private int deleteFileInfo(String id) throws Exception {
        try {

            fileInfoManager = new FileInfoManager();
            int i = fileInfoManager.deleteFileInfo(id, systemAuditBean);
            return i;

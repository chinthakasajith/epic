 ...
 * @author nalin
 */
public class LordUpdateFeeMgtServlet extends HttpServlet {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    try {
                        ...
                        for (FeeBean newFeeBean : feeList) {

                            if (newFeeBean.getFeeCode().equals(feeCode)) {
                                feeBean = newFeeBean;

                            }
                        }
                        this.setOldUpdateValue(feeBean);
...
//                sessionVarlist.setUserPageTaskList(userTaskList);
    ...
    private void setOldUpdateValue(FeeBean oldBean) throws Exception {
        String oldValue = null;
        try {

            oldValue = oldBean.getFeeCode() + "|" + oldBean.getFeeDes() + "|" + oldBean.getFeeCategory() + "|"
                    + oldBean.getFeeType() + "|" + oldBean.getCurrency() + "|" + oldBean.getCrordr() + "|"
                    + oldBean.getFlatFee() + "|" + oldBean.getPercentage() + "|" + oldBean.getMinAmount() + "|"
                    + oldBean.getMaxAmount() + "|" + oldBean.getStatus();

            feeBean.setOldValue(oldValue);
        } catch (Exception ex) {
            throw ex;

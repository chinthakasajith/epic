<%-- 
    Document   : suplimentoryapplication
    Created on : Apr 10, 2012, 11:15:39 AM
    Author     : janaka_h
--%>
                        ...
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <div class="selector" id="tabs2">
                                    ...
                                    <div id="tabs-1" >
                                        <form name="customerpersonalinfoform" method="POST" action="<%=request.getContextPath()%>/AddSuplimentoryPersonalInfoServlet">
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                <tr>
                                                    <td style="width: 200px;"></td>
                                                    <td><input type="submit" name="savenext" value="Save & Next"  style="width: 100px;"/>&nbsp;<input type="button" onclick="invokeReset('${sessionScope.SessionObject.applicationId}')" name="next" value="Reset" style="width: 100px;"/>&nbsp;<input type="button" name="cancel" value="Cancel" onclick="invokeCancel()" style="width: 100px;"/></td>
                                    ...
                                    <div id="tabs-2">
                                        ...
                                        <form method="POST" action="<%=request.getContextPath()%>/UploadDocumentCompleteServlet">
                                            <table  cellpadding="0" cellspacing="10">
                                                ...
                                                <tr>
                                                    <td style="width: 200px;"></td>
                                                    <td><input type="submit" name="next" value="Next" style="width: 100px;"/>&nbsp;<input type="button" onclick="invokeReseto('add')" name="next" value="Reset" style="width: 100px;"/>&nbsp;<input type="button" name="cancel" value="Cancel" onclick="invokeCancel()" style="width: 100px;"/></td>
                                    ...
                                    <div id="tabs-3">
                                        ...
                                        <form name="completeform" method="POST" action="<%=request.getContextPath()%>/ApplicationCompleteServlet">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="width: 200px;"></td>
                                                    <td><input type="submit" name="next" value="Complete" style="width: 100px;"/>&nbsp;<input type="button" onclick="invokeReseto('add')" name="next" value="Reset" style="width: 100px;"/>&nbsp;<input type="button" name="cancel" value="Cancel" onclick="invokeCancel()" style="width: 100px;"/></td>

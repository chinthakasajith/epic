 ...
 * @author nisansala
 */
public class ViewChangePasswordServlet extends HttpServlet {
    ...
    private void setAudittraceValue(HttpServletRequest request, SystemUserBean userBean) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add System user '" + userBean.getUserName() + "' by :" + sessionVarlist.getCMSSessionUser().getUserName());

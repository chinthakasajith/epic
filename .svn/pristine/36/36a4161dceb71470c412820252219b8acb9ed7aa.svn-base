 ...
 * @author sajith_g
 */
public class LoadLetterConfTempMgtServlet extends HttpServlet {

    private RequestDispatcher rd;
    private SystemUserManager systemUserManager;
    private LetterConfMgtManager letterMgtManager;
    private SessionVarList sessionVarlist;
    HttpSession sessionObj;
    private SessionUser sessionUser;
    private List<StatusBean> statusList;
    private List<LetterBean> searchList;
    ...
    private void searchLetterConfMgt() throws Exception {
        ...
        try {
            ...
            letterMgtManager = new LetterConfMgtManager();
            searchList = letterMgtManager.getLetterConfs();
        } catch (Exception ex) {
            throw ex;

 ...
 * @author nisansala
 */
public class DeleteChannelTxnMgtServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    this.setAudittraceValue(request,channelId);                        

                        int delResult = channelMgr.deleteChannelTxn(channelId, systemAuditBean);
     ...
     * @throws Exception 
     */
    private void setAudittraceValue(HttpServletRequest request,String channelId) throws Exception {

        try {
            systemAuditBean = new SystemAuditBean();
            ////get unique Id from the page.It may be the primary key---------------
            String uniqueId = channelId;
            ...
            //set description 
            systemAuditBean.setDescription("Delete Channel Txn. Channel Txn Code: '" + uniqueId + "' by: " + sessionVarlist.getCMSSessionUser().getUserName());

...
public class UpdateCardPinDistributionServlet extends HttpServlet {
    ...
    private String[] distributeAppIdList = null;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (distributeList.length > 0) {
                                ...
                                distributeAppIdList= request.getParameterValues("checkedAppId");
                                ...
                                try {
                                    ...
                                    if (opType.equals("card")) {
                                        successUpdate = cardManager.proceedCardDistribution(distributeList,distributeAppIdList, systemAuditBean);

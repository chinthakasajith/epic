<%-- 
    Document   : terminalblock
    Created on : Dec 14, 2012, 10:34:21 AM
    Author     : nalin
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function invokeBlock(terminalID)
            {
                window.location = "${pageContext.request.contextPath}/BlockCallCenterTerminalServlet?terminalID="+terminalID;
            }
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_TERMINAL_BLOCK%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form method="POST" action="" name="addterminalform">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="10">
                                        ...
                                        <td><input type="button" value="Block" name="block" style=" width:100px " onclick="invokeBlock('${trmnlBean.terminalID}')"/></td>

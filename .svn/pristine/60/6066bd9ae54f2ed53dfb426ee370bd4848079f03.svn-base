 ...
 * @author mahesh_m
 */
public class UpdateAmexIWKPanelServlet extends HttpServlet {
...
//                rd.forward(request, response);
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update AMEX IWK and IWK KVC by " + sessionVarlist.getCMSSessionUser().getUserName());

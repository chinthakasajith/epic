 ...
 * @author badrika
 */
public class UpdateBillingStatementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success > 0) {
                ...
                rd = request.getRequestDispatcher("/LoadBillingStatementServlet");
    ...
    private void setValuesToBean(HttpServletRequest request) throws Exception {
        try {
            ...
            newValue = billingStmtProfbean.getProfileCode() + "|" + billingStmtProfbean.getDescription() + "|" + billingStmtProfbean.getGracePeroid() + "|"
                    ...
                    + billingStmtProfbean.getStatus() + "|" + new Timestamp(billingStmtProfbean.getLastUpdatedTime().getTime()) + "|" + billingStmtProfbean.getLastUpdatedUser();
            
            this.getBillingStatementProfDetails();

            for (BillingStatementProfileBean cmsbillingStmtBean : billingStatementList) {
                if (cmsbillingStmtBean.getProfileCode().equals(billingStmtProfbean.getProfileCode())) {
            oldValue = cmsbillingStmtBean.getProfileCode() + "|" + cmsbillingStmtBean.getDescription() + "|" + cmsbillingStmtBean.getGracePeroid() + "|"
                    + cmsbillingStmtBean.getMinimumDueFlatAmount() + "|" + cmsbillingStmtBean.getMinimumDuePercentage() + "|"
                    + cmsbillingStmtBean.getMinimumDueCombination() + "|" + cmsbillingStmtBean.getStatementGenerationStatus() + "|"
                    + cmsbillingStmtBean.getStatus() + "|" + cmsbillingStmtBean.getLastUpdatedTime() + "|" + billingStmtProfbean.getLastUpdatedUser();
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Update Billing Statement Profile. Profile Code: " + uniqueId + "; by: " + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    public int updateProfile() throws Exception {
        try {
            billingStatementProfileManager = new BillingStatementProfileManager();
            int i = billingStatementProfileManager.updateProfile(systemAuditBean, billingStmtProfbean);
            return i;
        } catch (Exception e) {
            throw e;
        }

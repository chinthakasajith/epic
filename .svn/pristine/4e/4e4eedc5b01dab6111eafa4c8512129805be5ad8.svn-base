 ...
 * @author chanuka
 */
public class DownloadCardEmbossingFileServlet extends HttpServlet {
    ...
    private String url = "/cpmm/cardembossing/cardembossingfiledownload.jsp";
...
//            out.close();
    ...
    private void setAudittraceValue(HttpServletRequest request, String cardType, String cardProduct, String fileName) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Download " + cardProduct + " " + fileName + " emboss file, file name: " + fileName + " by " + sessionVarlist.getCMSSessionUser().getUserName());

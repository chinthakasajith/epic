 ...
 * @author badrika
 */
public class AddGeneralLedgerMgtServlet extends HttpServlet {
                    ...
                    if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                        try {
                            ...
                            if (this.validateUserInput(glbean)) {
                                ...
                                try {
                                    success = glmanager.addNewglAccont(systemAuditBean, glbean);
                            ...
                            if (success > 0) {
                                ...
                                request.setAttribute("operationtype", "add");
                                request.setAttribute(MessageVarList.JSP_SUCCESS, "Account No:" + glbean.getGlAccNo() + " " + MessageVarList.GLACCOUNT_ADD_SUCCESS);
                            }
    ...
    public boolean validateUserInput(GeneralLedgerMgtBean bean) throws Exception {
        ...
        try {
            ...
            }else if (!UserInputValidator.isValidGlAccNum(bean.getGlAccNo())) {
                isValidate = false;
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Add GL Account. GL Account Code: " + uniqueId + "; by:  " + sessionVarlist.getCMSSessionUser().getUserName());

 ...
 * @author chanuka
 */
public class SearchUserAssignDataServlet extends HttpServlet {
    ...
    private String url = "/camm/capturedata/userassignapplication.jsp";
            ...
            try {
                ...
                if (this.isValidAccess(sessionUser.getUserRole(), pageCode, taskCode)) {
                    ...
                    if (this.validateUserInput(searchBean, request)) {
                        ...
                        this.userAssignApplicationsSearch(searchBean, systemAuditBean);
    ...
    private void userAssignApplicationsSearch(SearchUserAssignAppBean searchBean, SystemAuditBean systemAuditBean) throws Exception {

        try {

            captureDataManager = new CaptureDataManager();
            searchList = captureDataManager.userAssignApplicationsSearch(searchBean, systemAuditBean);

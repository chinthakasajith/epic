 ...
 * @author ayesh
 */
public class DeleteApplicationRejectServlet extends HttpServlet {
    ...
    private ApplicationRejectReasonBean arrbean = null;
    /** 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            arrbean = ApplicationRejectReasonManager.getInstance().getSelectedRejectReason(id);            
           
            oldValue = arrbean.getReasonCode() + "|" + arrbean.getDescription() + "|" + sessionVarlist.getCMSSessionUser().getUserName();            
            
            if (!id.isEmpty()) {
                this.setAudittraceValue(request);
                int row = ApplicationRejectReasonManager.getInstance().deleteAppRejectReason(systemAuditBean, id);

                if (row == 1) {
                    request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.APP_REJECT_DELETE_SUCCESS);
                }
    ...
    private void setAudittraceValue(HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            systemAuditBean.setDescription("Delete Reject Reason Reason Code :" + uniqueId + ";  by " + sessionVarlist.getCMSSessionUser().getUserName());

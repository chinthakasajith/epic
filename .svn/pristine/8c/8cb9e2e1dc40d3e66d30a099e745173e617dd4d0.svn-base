 ...
 * @author sajith_g
 */
public class UpdateConfirmedPaymentPlanServlet extends HttpServlet {
     ...
     * @throws Exception 
     */
    public boolean validateUserInput(PaymentPlanBean paymentPlanBean) throws Exception {
     ...
     * @throws Exception 
     */
    public boolean updateUserLevel(PaymentPlanBean paymentplanBean, SystemAuditBean systemAuditBean) throws Exception {
    ...
    private void setAudittraceValue(HttpServletRequest request,String oldValue, String newValue) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Update payment plan privilage. privilage code: " + paymentPlanBean.getPaymentplancode()+ " by : " + sessionVarlist.getCMSSessionUser().getUserName());

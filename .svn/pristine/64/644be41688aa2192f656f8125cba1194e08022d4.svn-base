 ...
 * @author badrika
 */
public class GetCardProductsServlet extends HttpServlet {
    
    //private HashMap<String, String> cardProducts = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String cardDomain = request.getParameter("cDomain");
            ...
            try {
                ...
                cardProducts = manager.getCardProducts(cardDomain, cardType);

                jObject.put("", "------SELECT------");
                for (int i = 0; i < cardProducts.size(); i++) {
                    jObject.put(cardProducts.get(i).getProductCode(), cardProducts.get(i).getDescription());
                }

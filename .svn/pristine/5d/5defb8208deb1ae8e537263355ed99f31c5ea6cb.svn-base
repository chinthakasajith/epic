 ...
 * @author janaka_h
 */
public class AddTemplateMgtServlet extends HttpServlet {
...
//                templateBean.setProductCode(request.getParameter("product"));
                ...
                if (valied == null) {
                    ...
                    if (isAdd == 1) {
                        request.setAttribute("successMsg", "Sucssesfully added customer template.");
                        request.setAttribute("operation", "add");
                        rd = getServletContext().getRequestDispatcher("/LoadCustomerTempalteMgtServlet");
                        rd.forward(request, response);
                    } else {

                        request.setAttribute("templateBean", templateBean);
                        request.setAttribute("operation", "add");
                        request.setAttribute("errorMsg", "Faild adding customer template.");
    ...
    private void setAudittraceValue(HttpServletRequest request, CustomerTempBean templateBean) throws Exception {
        ...
        try {
            ...
            //set description 
            systemAuditBean.setDescription("Add Customer Template. Customer Template Code: '" + templateBean.getTemplateCode() + "' by:" + sessionVarlist.getCMSSessionUser().getUserName());
    ...
    private String isValiedTemplate(CustomerTempBean templateBean) throws Exception {
        ...
        try {
            ...
            //---------------------------------------------------------------------------- 
//            else if (templateBean.getProductCode().isEmpty()) {
//                if (msg.equals("")) {
//                    msg = "Select Product Type";
//                } else {
//                    msg = msg + ", Select Product Type";
//                }
//            } 
//            
            //---------------------------------------------------------------------------- 

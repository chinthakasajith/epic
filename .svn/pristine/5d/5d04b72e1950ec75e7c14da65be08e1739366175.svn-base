 ...
 * @author sajith
 */
public class DeleteAlertMgtServlet extends HttpServlet {
        ...
        try {
            ...
            id = request.getParameter("id");
             ...
             for(AlertBean bean: alertlist) {
                 if(bean.getAlertType().equals(id)){
             oldValue = bean.getAlertType()+ "|" + bean.getDescription()+ "|" + bean.getStatus()+ "|" + bean.getLastUpdatedDate() + "|" + bean.getLastUpdatedUser();                    
                 }
             }

            int success = deleteBank(id);

            if (success > 0) {

                request.setAttribute(MessageVarList.JSP_SUCCESS, MessageVarList.ALERT_DELETE_SUCCESS + " Type: "+id);
            }
            this.getAlertDetails();
    ...
    public int deleteBank(String id) throws Exception {
        try {
            ...
            int i = alertMgtManager.deleteAlert(id);
            return i;
        } catch (Exception e) {
            throw e;
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteAlertMgtServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(DeleteAlertMgtServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

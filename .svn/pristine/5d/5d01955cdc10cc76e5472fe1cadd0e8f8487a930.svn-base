<%-- 
    Document   : approvebtpayment
    Created on : Sep 7, 2016, 4:01:13 PM
    Author     : sajith_g
--%>
...
<html >
    <head>
        ...
        <script type="text/javascript">
            function BackToLoad() {
                window.location = "${pageContext.request.contextPath}/LoadBTPaymentConfirmationServlet";
            }

            function viewCard(reqid, txnid) {
                window.location = "${pageContext.request.contextPath}/SearchBTPaymentRequestServlet?reqid=" + reqid + "&txnid=" + txnid + "&view=view";
            }

            function ApproveInc() {
                document.approveform.action = "${pageContext.request.contextPath}/SearchBTPaymentRequestServlet?view=approve";
                document.approveform.submit();
//                window.location = "${pageContext.request.contextPath}/ConfirmPermLimitIncrementServlet";
            }
            
            function Reject() {
                document.approveform.action = "${pageContext.request.contextPath}/SearchBTPaymentRequestServlet?view=reject";
                document.approveform.submit();
            }
        ...
        <script>
            function settitle() {
                ...
                $.post("${pageContext.request.contextPath}/SetNavigationTitleServlet",
                        {pagecode: '<%= PageVarList.APPROVE_BT_PAYMENT%>'
                        },
                function(data) {
                        ...
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <c:if test="${operationtype=='search'}" >
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/SearchBTPaymentRequestServlet?view=search">
                                ...
                                <c:if test="${operationtype=='view'}" >
                                    ...
                                    <form method="POST" name="approveform" action="${pageContext.request.contextPath}/SearchBTPaymentRequestServlet?view=approve">
                                        <table border="0" cellpadding="0" cellspacing="10">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:${permBean2.otherbankCardNumber}</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td>&emsp;Expiry Date</td>
                                                    <td>:${permBean2.otherbankCardExpiryMonth}/${permBean2.otherbankCardExpiryYear}</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td>&emsp;Name On Card</td>
                                                    <td>:${permBean2.otherbankNameOnCard}</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td>&emsp;Issuer</td>
                                                    <td>:${permBean2.bankcode}</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td>&emsp;Due Date</td>
                                                    <td>:${permBean2.dueDate}</td>
                                                </tr>

<%-- 
    Document   : debitcardnumbergenaration
    Created on : Sep 10, 2012, 4:06:02 PM
    Author     : janaka_h
--%>
    ...
    <head>
        ...
        <script language = "javascript">
                ...
                function(data) {
                    if(data!=''){
                        ...
                        for(var x=0;x < codes.length;x++){
                            if(codes[x] == '${searchBean.cardProduct}'){
                                $('#cardproduct').append(
            ...
            function invokeReset(){
                ...
                window.location = "${pageContext.request.contextPath}/LoadDebitCardNumberGenarationServlet";
        ...
        <script language = "javascript">
            function invokeGenarate(isAll){
                ...
                if(isAll=='set'){
                    ...
                    if(array.length > 0){
                        document.genarateanumberform.action="${pageContext.request.contextPath}/StartDebitNumberGenarationServlet?hiddenarray="+array;
                ...
                if(isAll=='all'){
                    ...
                    //alert(isAll);
                    if(${searchList ==null} ){
                       alert("Please search at least one application");
                    }else{
                         
                    document.genarateanumberform.action="${pageContext.request.contextPath}/StartDebitNumberGenarationServlet";
                    document.genarateanumberform.submit();
                    }
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.DEBIT_NUMBERGEN%>'                                  
                },
                function(data) {
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form method="POST" action="<%=request.getContextPath()%>/SearchDebitNumberGenarationSevlet" name="searchuserassignform" >
                                    <table cellpadding="0" cellspacing="10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"  value="${searchBean.nameOnCard}" name="nameoncard" maxlength="32"></td>
                                                <td></td>
                                            </tr>
                                                ...
                                                <td>
                                                    <select  name="cardtype" id="cardtype"  onchange="changeProducts(value)" onload="changeProducts('VISA')">
                                                        ...
                                                        <c:forEach var="cardTypeList" items="${sessionScope.SessionObject.cardTypeList}" >
                                                            ...
                                                            <c:if test="${searchBean.cardType==cardTypeList.cardTypeCode}">
                                ...
                                <form method="POST" action="<%=request.getContextPath()%>/SearchDebitNumberGenarationSevlet" name="genarateanumberform" >    
                                    ...
                                    <table cellpadding="0" cellspacing="10">
                                        <tr></tr>
                                        <tr><td ><input type="hidden" id="hiddenarray1" name="hiddenarray1"> </td></tr>
                                        <tr>

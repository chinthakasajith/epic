<%-- 
    Document   : cardagainstfdcreditofficerview
    Created on : Jul 20, 2016, 11:04:26 AM
    Author     : chinthaka_r
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeReset() {
                ...
                <%-- window.location = "${pageContext.request.contextPath}/LoadCardAgainstFDCreditofficerDetailsServlet"; --%>
            ...
            function resetLetterField()
            {
                ...
                //$("#crdtOfficerRecProduct").replaceWith("<select   id='crdtOfficerRecProduct' class='inputfield-mandatory'>");
                                            ...
                                            <td>
                                                <select  name="crdtOfficerRecProduct" id="crdtOfficerRecProduct" class="inputfield-mandatory">
                                                    ...
                                                    <c:forEach var="products" items="${cardProducts}">
                                                        ...
                                                        <c:if test="${cproduct == products.productCode}">
                                                            <option value="${products.productCode}" selected>${products.description}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </select>
                                            </td>

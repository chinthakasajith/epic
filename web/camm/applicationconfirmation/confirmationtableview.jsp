    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcreditofficerform.action="${pageContext.request.contextPath}/SearchApplicationApproveServlet";
            ...
            function invokeReset(){
                ...
                window.location = "${pageContext.request.contextPath}/LoadApplicationApproveTableServlet";
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.APPLICATONAPPROVE%>'                                  
                },
                function(data) {
                                    ...
                                    <tbody>
                                        <c:forEach var="appDetails" items="${searchList}">
                                            <tr>
                                                ...
                                                <td >${appDetails.identityTypeName}</td>
                                                ...
                                                <c:if test="${appDetails.applicationCategory == 'M'}">
                                                     <td  ><a href='${pageContext.request.contextPath}/LoadApproveDetailsServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'S'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadSupplementaryApproveDetailsServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'C'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadCorporateApproveDetailsServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'F'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadCardAgainstFDApproveDetailsServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>
                                                <c:if test="${appDetails.applicationCategory == 'E'}">
                                                    <td><a href='${pageContext.request.contextPath}/LoadEstablishmentApproveDetailsServlet?applicationid=${appDetails.applicationId}'>View</a></td>
                                                </c:if>                                                     
                                                <c:if test="${!(appDetails.applicationCategory == 'M' || appDetails.applicationCategory == 'S' || appDetails.applicationCategory == 'C' || appDetails.applicationCategory == 'F' || appDetails.applicationCategory == 'E')}">
                                                    <td><a href='#'>View</a></td>
                                                </c:if>

<%-- 
    Document   : cardagainstfdcreditofficerreviewandconfirm
    Created on : Jul 28, 2016, 10:49:47 AM
    Author     : chinthaka_r
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function Reject(applicationid)
            {
                ...
                {
                    document.confirmForm.action = "${pageContext.request.contextPath}/LoadCardAgainstFDCreditOfficerDetailsAndConfirmServlet?applicationid=" + applicationid;
                }
        ...
        <title>EPIC CMS CREDIT OFFICER REVIEW AND CONFIRMATION</title>
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <table>
                                    <tr>
                                        <td colspan="3"><font color="#FF0000" id="errMsg1"><b><c:out value="${errorMsg}"></c:out></b></font>
                                            <font color="green" id="succMsg1"><b><c:out value="${successMsg}"></c:out></b></font>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <form  ENCTYPE="multipart/form-data"  METHOD=POST name="recommendLetter">                  
                                    ...
                                    <table cellpadding="0" cellspacing="10"  >
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 100px;"> Blood Group</td>    
                                            <td>
                                        ...
                                        <c:if test="${isConfirmMode==0}">
                                            ...
                                            <tr>
                                                <td style="width: 100px;">Credit Limit (LKR)</td>
                                    ...
                                    <form method="POST" action="DownloadLetterServlet" target="downloadform">         
                                        <table cellpadding="0" cellspacing="10"  >                        
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b><font color="#000000">${currencyAlphaCode}&nbsp;<fmt:formatNumber type="number" value="${cardApplicationList.cOfficerRecCrditLimt}"/></font></b>
                                                </td>
                                            </tr>
                                            <tr>

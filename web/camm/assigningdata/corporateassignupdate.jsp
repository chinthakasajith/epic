<%-- 
    Document   : corporateassignupdate
    Created on : May 9, 2013, 4:13:19 PM
    Author     : asela
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchappassignform.action="${pageContext.request.contextPath}/SearchCorporateAssignDataServlet";
     ...
     <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CORPORATEASSIGNDATAUPDATE%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <tr><td style="height: 5px"></td></tr>    -->
                                            ...
                                            <tr>
                                                ...
                                                <td><a  href="#"  onclick="invokeHistory('<%=PageVarList.CORPORATEASSIGNDATAUPDATE%>')"><img src="<%=request.getContextPath()%>/resources/images/history-icon.gif" width="40" height="40" title="History View"/></a></td>
                                            </tr>

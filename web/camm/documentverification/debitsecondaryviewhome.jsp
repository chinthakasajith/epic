<%-- 
    Document   : debitsecondaryviewhome
    Created on : Aug 29, 2012, 9:41:08 AM
    Author     : chanuka
--%>
    ...
    <head>
        ...
        <script>
            ...
            function updateOnhold(){
                ...
                document.verifyform.action="${pageContext.request.contextPath}/VerifyDebitSecondaryServlet?option=onhold";
                document.verifyform.submit();
            }
            function updateVerify(){
                
                document.verifyform.action="${pageContext.request.contextPath}/VerifyDebitSecondaryServlet?option=verify";
                document.verifyform.submit();
            }
            function updateReject(){
                
                document.verifyform.action="${pageContext.request.contextPath}/VerifyDebitSecondaryServlet?option=reject";
                document.verifyform.submit();
            }
                                    ...
                                    <div id="tabs-1" >
                                        ...
                                        <form method="POST" action="" name="verifyform" >
                                            ...
                                            <table cellpadding="0" cellspacing="10">
                                                <tr style="height: 10px"></tr>
                                                <tr>
                                                    <td style="width: 200px;"><font style="color: #999"> signature</font></td>
                                            ...
                                            <table cellpadding="0" cellspacing="10" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="button" name="next"  class="nexttab" style="width: 100px;" value="Next" >
                                        ...
                                        <form method="POST" action="" name="verifyform" >
                                            <table cellpadding="0" cellspacing="10"  >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select name="idType" disabled="true">
                                                            ...
                                                            <c:forEach var="identity" items="${sessionScope.SessionObject.identityTypeList}">
                                                                <c:if test="${sessionScope.SessionObject.debitDetailsBean.sidentificationType==identity.key}">
                                                                    <option value="${identity.key}" selected>${identity.value}</option>
                                                                </c:if>
                                                                <c:if test="${sessionScope.SessionObject.debitDetailsBean.sidentificationType != identity.key}">
                                                                    <option value="${identity.key}" >${identity.value}</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label name="identificationNo" >${sessionScope.SessionObject.debitDetailsBean.sidentificationNo}</label></td>
                                                    <td style="width: 100px;"> </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select name="title" disabled="true">
                                                            ...
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Mr'}"> <option selected="true" value="Mr">Mr</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Mr'}"> <option value="Mr">Mr</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Mrs'}"> <option selected="true" value="Mrs">Mrs</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Mrs'}"> <option value="Mrs">Mrs</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Ms'}"> <option selected="true" value="Ms">Ms</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Ms'}"> <option value="Ms">Ms</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Dr'}"> <option selected="true" value="Dr">Dr</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Dr'}"> <option value="Dr">Dr</option></c:if>                                                
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Prof'}"> <option selected="true" value="Prof">Prof</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Prof'}"> <option value="Prof">Prof</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Rev'}"> <option selected="true" value="Rev">Rev</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Rev'}"> <option value="Rev">Rev</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Hon'}"> <option selected="true" value="Hon">Hon</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Hon'}"> <option value="Hon">Hon</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle =='Ven'}"> <option selected="true" value="Ven">Ven</option></c:if>
                                                            <c:if test="${sessionScope.SessionObject.debitDetailsBean.stitle !='Ven'}"> <option value="Ven">Ven</option></c:if>
                                                        ...
                                                        <!--              ------------------------------------------------------------------------------------------------------------------------------------                       -->
                                                        <td style="width: 200px;">Date Of Birth</td>
                                                        <td><lable>${sessionScope.SessionObject.debitDetailsBean.sdateOfBirth}</lable></td>
                                                <td style="width: 100px;"></td> 
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px;">First Name</td>
                                                    <td><lable>${sessionScope.SessionObject.debitDetailsBean.sfirstName}</lable></td>  
                                                <td style="width: 100px;"> </td>
                                                <!--              ------------------------------------------------------------------------------------------------------------------------------------                       -->                                          


                                                <td style="width: 200px;"> Address</td>    
                                                <td>${sessionScope.SessionObject.debitDetailsBean.saddress}</td>    
                                                <td style="width: 100px;"> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px;"> Middle Name</td>    
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.smiddleName}</td>  
                                                    <td style="width: 100px;"></td> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px;">Last name</td>
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.slastName}</td>
                                                    <td style="width: 100px;"></td>  
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px;">Name on the Card</td>
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.snameOnCard}</td>
                                                    <td style="width: 100px;"></td> 
                                                    ...
                                                    <td><select name="title" disabled="true">
                                                            ...
                                                            <c:forEach var="area" items="${sessionScope.SessionObject.areaList}">
                                                                ...
                                                                <c:if test="${sessionScope.SessionObject.debitDetailsBean.sarea==area.areaCode}">
                                                                    <option value="${area.areaCode}" selected="true" >${area.description}</option>
                                                                </c:if>
                                                                <c:if test="${sessionScope.SessionObject.debitDetailsBean.sarea!=area.areaCode}">
                                                                    <option value="${area.areaCode}">${area.description}</option>
                                                ...
                                                <tr>
                                                    <td style="width: 200px;"> Mothers Maiden Name</td>    
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.smothersMaidenName}</td>
                                                    ...
                                                    <td style="width: 200px;"> Mobile Number</td>    
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.smobileNo}</td>
                                                    </td>  
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Res. Phone No</td>
                                                    <td>${sessionScope.SessionObject.debitDetailsBean.shomeTel}</td>
                                                </tr>
                                            ...
                                            <table  cellpadding="0" cellspacing="10" >
                                                ...
                                                <tr>
                                                    ...
                                                    <c:if test="${sessionScope.SessionObject.debitUploadDocsBean.isJointSignatureUpload =='YES'}">   <td style="width: 25px" ><a href="#" onClick="invokeWindow('Scanned Document','${sessionScope.SessionObject.debitUploadDocsBean.applicationId}','SECONDARY_SIGNATURE','${sessionScope.SessionObject.debitUploadDocsBean.joinSignFileName}'); return false"><img  style="width: 20px ; height: 15px" src="${pageContext.request.contextPath}/resources/images/windowimages/right.jpg"/></a></td></c:if>

                                                    <c:if test="${sessionScope.SessionObject.debitUploadDocsBean.isJointSignatureUpload =='NO'}">  <td style="width: 25px"><img  style="width: 20px ; height: 15px" src="${pageContext.request.contextPath}/resources/images/windowimages/realcross.jpg"/></td></c:if>
                                                    </tr>
                                                ...
                                                <table cellpadding="0" cellspacing="10">  
                                                    ...
                                                    <tr>
                                                    <c:if test="${verifyBean.sNic =='NO' || verifyBean.sNic == null}"><td style="width: 25px"> <input type="checkbox" name="checksnic"  value="ON" /></td></c:if>
                                                    <c:if test="${verifyBean.sNic =='YES'}"><td style="width: 25px"> <input type="checkbox" name="checksnic"  checked="true" value="ON" /></td></c:if>
                                                        <td style="width: 165px;">NIC</td>


                                                    <c:if test="${sessionScope.SessionObject.debitUploadDocsBean.isJointNicUpload =='YES'}">   <td style="width: 25px" ><a href="#" onClick="invokeWindow('Scanned Document','${sessionScope.SessionObject.debitUploadDocsBean.applicationId}','SECONDARY_NIC','${sessionScope.SessionObject.debitUploadDocsBean.joinNicFileName}'); return false"><img  style="width: 20px ; height: 15px" src="${pageContext.request.contextPath}/resources/images/windowimages/right.jpg"/></a></td></c:if>

                                                    <c:if test="${sessionScope.SessionObject.debitUploadDocsBean.isJointNicUpload =='NO'}">  <td style="width: 25px"><img  style="width: 20px ; height: 15px" src="${pageContext.request.contextPath}/resources/images/windowimages/realcross.jpg"/></td></c:if>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    <tr style="height: 12px"></tr>
                                                    <tr>
                                                    <c:if test="${verifyBean.sAccNo =='NO' || verifyBean.sAccNo == null}"><td style="width: 25px"> <input type="checkbox" name="checksaccno"  value="ON" /></td></c:if>
                                                    <c:if test="${verifyBean.sAccNo =='YES'}"><td style="width: 25px"> <input type="checkbox" name="checksaccno" checked="true" value="ON" /></td></c:if>
                                                        <td style="width: 150px;">Account Number</td>


                                                    </tr>
                                                    <tr>
                                                    <c:if test="${verifyBean.sId =='NO' || verifyBean.sId == null}"> <td style="width: 25px"> <input type="checkbox" name="checksid"  value="ON" /></td></c:if>
                                                    <c:if test="${verifyBean.sId =='YES'}"> <td style="width: 25px"> <input type="checkbox" name="checksid"  checked="true" value="ON" /></td></c:if>
                                                        <td style="width: 150px;">ID</td>
                                                    </tr>
                                                    <tr>
                                                    <c:if test="${verifyBean.sName =='NO' || verifyBean.sName == null}"><td style="width: 25px"> <input type="checkbox" name="checksname"  value="ON" /></td></c:if>
                                                    <c:if test="${verifyBean.sName =='YES'}"><td style="width: 25px"> <input type="checkbox" name="checksname" checked="true" value="ON" /></td></c:if>
                                                        <td style="width: 150px;">Name</td>
                                            ...
                                            <table cellpadding="0" cellspacing="10" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="button" name="onhold"  style="width: 100px;" value="Onhold" onclick="updateOnhold()">
                                                        ...
                                                        <input type="button" name="previous"  class="previoustab" style="width: 100px;" value="Previous" >
                                                        <input type="button" name="cancel"  style="width: 100px;" onclick="invokeBack()" value="Cancel">
                                                    </td>
                                                </tr>
                                                <tr><td><input type="hidden" name="applicationid" value="${sessionScope.SessionObject.debitDetailsBean.applicationId}"></td></tr>

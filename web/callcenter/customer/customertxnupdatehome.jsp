<%-- 
    Document   : customertxnupdatehome
    Created on : Feb 20, 2013, 3:53:22 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CUSTOMER_TRANSACTION%>'                                  
                },
                function(data) {
                                ...
                                <form action="" method="POST" name="updateCustomerTxn" >
                                    ...
                                    <table cellpadding="0" cellspacing="10">
                                        <tbody>
                                            <tr>
                                                <td>Customer ID :</td>
                                                <td><label><c:out value="${sessionScope.SessionObject.customerId}"/> </label></td>
                                            </tr>
                                        </tbody>
                                    </table>

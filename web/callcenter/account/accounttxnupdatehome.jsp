<%-- 
    Document   : accounttxnupdatehome
    Created on : Feb 22, 2013, 9:23:47 AM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate()
            {
                ...
                document.updateAccountTxn.action="${pageContext.request.contextPath}/UpdateCallCenterAccountTxnUpdateServlet";
                document.updateAccountTxn.submit();
            ...
            function invokeReset()
            {
                ...
                window.location="${pageContext.request.contextPath}/LoadCallCenterAccountTxnUpdateServlet";
            ...
            function invokeCancel()
            {
                ...
                window.location="${pageContext.request.contextPath}/ViewCustomerMgtServlet?section=CCACCO";
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.ACCOUNT_TRANSACTION%>'                                  
                },
                function(data) {
                    ...
                    <div id="content" align="center">
                        <div id="contenttext">
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form action="" method="POST" name="updateAccountTxn" >

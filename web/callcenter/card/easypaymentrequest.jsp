                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="easyPaymentReq" items="${easyPaymentReqList}">
                                                <tr>
                                                    ...
                                                    <td >${easyPaymentReq.formattedTxnAmount}</td>
                                                    <td >${easyPaymentReq.txnCurrency}</td>
                                                    <td >${easyPaymentReq.statusDes}</td>
                                                    <td ><a  href='#' onclick="InvokeSetup('${easyPaymentReq.txnId}', '${easyPaymentReq.rrn}', '${easyPaymentReq.txnAmount}', '${easyPaymentReq.formattedTxnAmount}', '${easyPaymentReq.txnCurrencyCode}')">Setup</a></td>

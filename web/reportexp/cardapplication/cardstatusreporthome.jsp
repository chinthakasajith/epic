<%-- 
    Document   : cardstatusreporthome
    Created on : Dec 5, 2012, 8:25:23 AM
    Author     : nisansala
--%>
    ...
    <head>
        ...
        <script language="javascript">
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadCardStatusReportServlet";

            }

            function invokeViewPdf() {
                document.searchform.action = "${pageContext.request.contextPath}/ApplicationCardStatusReportPdfServlet";
            ...
            function invokeSearch()
            {
                ...
                document.searchform.action = "${pageContext.request.contextPath}/SearchCardStatusReportServlet";
                document.searchform.submit();
            ...
            function invokeView(value) {
                ...
                $.post("${pageContext.request.contextPath}/ViewCardStatusReportServlet", {id: value},
                function (data) {
                    if (data == "success") {

                        $.colorbox({href: "${pageContext.request.contextPath}/reportexp/cardapplication/viewcardstatusreport.jsp", iframe: true, height: "80%", width: "80%", overlayClose: false});
                    }
        ...
        <script>
            function settitle() {
                ...
                $.post("${pageContext.request.contextPath}/SetNavigationTitleServlet",
                        {pagecode: '<%= PageVarList.CD_STATUS%>'
                        },
                function (data) {
                                    ...
                                    <table cellpadding="0" cellspacing="10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><select  name="domain" id="domain" onchange="loadCdProduct('STATUS')" style="width: 163px">
                                                        <option value="">--------------ALL--------------</option>  
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 30px"></td>
                                                <td>Card Type</td>
                                                <td><select  name="type" id="type" onchange="loadCdProduct('STATUS')" style="width: 163px">
                                                        <option value="">--------------ALL--------------</option>  
                                            ...
                                            <tr>
                                                ...
                                                <td><select  name="status" style="width: 163px">
                                                        ...
                                                        <c:forEach var="status" items="${statusList}">
                                                            <c:if test="${appBean.status==status.key}">

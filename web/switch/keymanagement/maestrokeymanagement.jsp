<%-- 
    Document   : maestrokeymanagement
    Created on : Jun 11, 2012, 4:13:29 PM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVA(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroPVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroPVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroPVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVA(){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/UpdateMaestroCVVAServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroCVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroIMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroPPKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateTPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateMaestroTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.MAESTRO_KEY_MGT%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <div class="selector" id="tabs">
                                    <ul>
                                        ...
                                        <li><a href="#tabs-3">CVV Verification Key</a></li>
                                    ...
                                    <div id="tabs-2" >
                                        ...
                                        <div id="pvv" class="outset" style="border-style:outset;  background-color: #E0E0E0 ; border-color: #999; width: 600px; margin-left: 90px; margin-bottom: 30px;">

                                            <form name="pvvbPanelForm" style="padding: 20px;" id="pvvID">
                                                <table>
                                                    <tr>

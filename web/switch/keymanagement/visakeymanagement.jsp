    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdatePVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateIMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdatePPKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateTPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.VISA_KEY_MGT%>'                                  
                },
                function(data) {

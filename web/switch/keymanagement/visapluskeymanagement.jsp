<%-- 
    Document   : visapluskeymanagement
    Created on : Jun 11, 2012, 2:24:02 PM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVA(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusPVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusPVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusPVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVA(){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusCVVAServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusCVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusIMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusPPKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateTPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateVisaPlusTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.VISA_PLUS_KEY_MGT%>'                                  
                },
                function(data) {

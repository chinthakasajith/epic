    ...
    <head>
        ...
        <script  type="text/javascript" charset="utf-8">
            ...
            function invokeUpdate(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmZMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateAWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmAWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIWK(){
                ...
                //                window.location = "${pageContext.request.contextPath}/RecalculateCreditScoreServlet?applicationId="+applicationId;
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmIWKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVA(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmPVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmPVVBanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePVV(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmPVVPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVA(){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/UpdateAtmCVVAPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateCVVB(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmCVVBPanelServlet",
                    type: "POST",
            ...
            function invokeUpdateIMK_AC(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmIMKPanelServlet",
                    type: "POST",
                    ...
                    success : function(data){
                        ...
                        //                        ar=data;
                        if(ar[0] == 'success'){
                            $("#successimk_ac").text("KVC of the IMK_AC Succesfully genarated");
                            $("#imk_ackvc").val(ar[1]);
                        }else{
            ...
            function invokeUpdateZCMK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmZCMKPanelServlet",
                    type: "POST",
            ...
            function invokeUpdatePPK(){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmPPKPanelServlet",
                    type: "POST",
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/UpdateAtmTPKPanelServlet",
                    type: "POST",
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.ATM_KEY_MGT%>'                                  
                },
                function(data) {
                                            ...
                                            <form name="pvvPanelForm" style="padding: 20px;" id="pvvID">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>PVK</td>
                                                        <td style="width: 15px;"></td>
                                                        <td><input type="text" name="pvvb" value="${keyDetails.pvv}" disabled="" id="pvvEnable" maxlength="32" size="35"/></td>
                                                        <td style="width: 15px;"></td>
                                                        <td>KVC</td>
                                                        <td style="width: 15px;"></td>

<%-- 
    Document   : CARDMGT
    Created on : Nov 21, 2012, 11:55:24 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getCardmgtSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=CARDMGT">-->
                <p><center><font size="2" style="font-weight: bold;">CARD MANAGEMENT</font></center> </p> 
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('CARDMGT', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getIssuingAdminSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISADMN">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes21"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISADMN', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

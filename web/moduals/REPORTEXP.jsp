<%-- 
    Document   : REPORTEXP
    Created on : Nov 21, 2012, 11:56:33 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getReportexpSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=REPORTEXP">-->
                    <p><center><font size="2" style="font-weight: bold;">REPORT EXPLORER</font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('REPORTEXP', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

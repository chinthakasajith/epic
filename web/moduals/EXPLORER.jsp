<%-- 
    Document   : EXPLORER
    Created on : Nov 21, 2012, 11:55:41 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getExplorerSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <p><center><font size="2" style="color: #3D87D8;font-weight: bold;">EPIC CMS</font></center> </p>
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ADMINISTRATION">-->
                    <p><center><font size="2" style="font-weight: bold;">ADMINISTRATOR</font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ADMINISTRATION', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : COSYCO
    Created on : Dec 21, 2012, 5:02:58 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getCommonConfigSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=COSYCO">-->
                    <p><center><font size="2" style="font-weight: bold;">COMMON CONFIGURATION</font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('COSYCO', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : ISSESE
    Created on : Dec 21, 2012, 10:02:22 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getSecurityServicesSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISSESE">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes30"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISSESE', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

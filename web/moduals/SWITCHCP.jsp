<%-- 
    Document   : SWITCHCP
    Created on : Nov 21, 2012, 11:57:06 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getSwitchSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=SWITCHCP">-->
                    <p><center><font size="2" style="font-weight: bold;">SWITCH</font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('SWITCHCP', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

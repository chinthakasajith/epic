<%-- 
    Document   : ACMEMA
    Created on : Dec 21, 2012, 2:41:08 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getMerchantMgtSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ACMEMA"><p><center><font size="2" style="font-weight: bold;" class="appdes4"></font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" class="appdes4"></font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ACMEMA', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : ISISSE
    Created on : Dec 21, 2012, 11:44:47 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getIssuerServiceSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISISSE">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes27"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISISSE', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

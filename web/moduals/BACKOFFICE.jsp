<%-- 
    Document   : BACKOFFICE
    Created on : Nov 21, 2012, 11:53:43 AM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getBackofficeSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=BACKOFFICE"><p><center><font size="2" style="font-weight: bold;">BACK OFFICE</font></center> </p></a>-->
                <p></p><center><font size="2" style="font-weight: bold;" >BACK OFFICE</font></center><p></p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('BACKOFFICE', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

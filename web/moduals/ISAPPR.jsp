<%-- 
    Document   : ISAPPR
    Created on : Dec 20, 2012, 4:17:59 PM
    Author     : janaka_h
--%>
...
<!--        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nagging-menu.js" charset="utf-8"></script>-->
        ...
        <%
            ...
            if (user != null) {
                ...
                sectionPageList = sessinvarlist.getApplicationProcessingSectionPageList();
            }
        %>
        ...
        <div id="menu" class="default">
            <div class="glossymenu">
                ...
                <!--<a href="${pageContext.request.contextPath}/ApplicationLogin?appCode=ISAPPR">-->
                    <p><center><font size="2" style="font-weight: bold;" class="appdes22"></font></center> </p>
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li><a href="#" onclick="invokeSetSessionMenu('ISAPPR', '<%= url%>')"> <%= pageBean.getDescription()%></a></li>

<%-- 
    Document   : terminaldeactivation
    Created on : Dec 13, 2012, 10:24:35 AM
    Author     : nalin 
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function invokeDeActivate(terminalID)
            {
                window.location = "${pageContext.request.contextPath}/DeActivateCallCenterTerminalServlet?terminalID="+terminalID;
            }
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_TERMINAL_DEACTIVATION%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form method="POST" action="" name="addterminalform">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="10">
                                        ...
                                        <td><input type="button" value="De-Activate" name="activate" style=" width:100px " onclick="invokeDeActivate('${trmnlBean.terminalID}')"/></td>

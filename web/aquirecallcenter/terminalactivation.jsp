<%-- 
    Document   : terminalactivation
    Created on : Dec 13, 2012, 9:03:26 AM
    Author     : nalin
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function invokeActivate(terminalID)
            {
                window.location = "${pageContext.request.contextPath}/ActivateCallCenterTerminalServlet?terminalID="+terminalID;
            }
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_TERMINAL_ACTIVATION%>'                                  
                },
                function(data) {
                            ...
                            <div class="bodytext" style="padding:12px;" align="left">
                                ...
                                <form method="POST" action="" name="addterminalform">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="10">
                                        ...
                                        <td><input type="button" value="Activate" name="activation" style=" width:100px " onclick="invokeActivate('${trmnlBean.terminalID}')"/></td>

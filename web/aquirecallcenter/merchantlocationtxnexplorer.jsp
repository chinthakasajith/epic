<%-- 
    Document   : merchantlocationtxnexplorer
    Created on : Feb 14, 2013, 3:01:22 PM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            $(document).ready(function() {
                ...
                oTable = $('#jsontable').dataTable({
                    "bServerSide": true,
                    "sAjaxSource": "${pageContext.servletContext.contextPath}/LoadMerchantLocationTxnExpServlet",
                    "bProcessing": true,
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CALLCENTER_MERCHANT_LOCATION_TXN_EXPLORER%>'                                  
                },
                function(data) {

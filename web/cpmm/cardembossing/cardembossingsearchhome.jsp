<%-- 
    Document   : cardembossingsearchhome
    Created on : Apr 23, 2012, 3:59:11 PM
    Author     : chanuka
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcardembossingform.action = "${pageContext.request.contextPath}/SearchCardEmbossingServlet";
        ...
        <title>EPIC CMS CREDIT CARD EMBOSSING ENCODING MANAGEMENT HOME</title>
    </head>
    <body>
                                ...
                                <form method="POST" action="" name="searchcardembossingform">
                                    ...
                                    <table border="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 180px">Card Type <font style="color: red;">*</font> </td>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 174px">Emboss Type <font style="color: red;">*</font></td>
                                                ...
                                                <tr><td></td>
                                                <c:if test="${searchembossingbean.embossType =='all'}"><td>  <input style="width: 25px" type="radio" name="embosstype" value="all" checked="true"/></td></c:if>
                                                <c:if test="${searchembossingbean.embossType !='all'}"><td>  <input style="width: 25px" type="radio" name="embosstype" value="all"/></td></c:if>
                                                    <td>All</td>
                                                    <td></td>
                                                </tr>
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a  href="#"  onclick="invokeHistory('<%=PageVarList.CPCECE%>')"><img src="<%=request.getContextPath()%>/resources/images/history-icon.gif" width="40" height="40" title="History View"/></a></td>
                                            </tr>

                                            <tr><td style="height: 10px"></td><input type="hidden" name="hiddencarddomain" value="CREDIT"/></tr>     

<%-- 
    Document   : cardqualitymgthome
    Created on : Aug 2, 2012, 9:30:22 AM
    Author     : nalin
--%>
    ...
    <head>
        ...
        <script> 
            ...
            <%--var oTable = $('#example').dataTable();--%>
                ...
                function invokeReset(){
                    ...
                    window.location = "${pageContext.request.contextPath}/LoadQualityMgtServlet";
                ...
                function invokeSearch()
                {
                    ...
                    document.searchQualityManagementForm.action="${pageContext.request.contextPath}/SearchQualityMgtServlet";
                ...
                function invokeQualityFail()
                {
                    ...
                    if (answer !=0)
                    {
                        document.updateQualityManagementForm.action="${pageContext.request.contextPath}/UpdateQualityMgtServlet";
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.CARD_QUALITY_MGT%>'                                  
                },
                function(data) {
                                    ...
                                    <form action="" method="POST" name="searchQualityManagementForm">
                                        ...
                                        <table border="0" cellspacing="10">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Name On Card</td>
                                                    <td><input type="text" name="nameOnCard" disabled value="${cardBean.nameOnCard}" maxlength="100"/></td>
                                    ...
                                    <form action="" method="POST" name="updateQualityManagementForm">
                                        ...
                                        <table border="0" cellspacing="10">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Name On Card</td>
                                                    <td><input type="text" name="nameOnCard" readonly  value="${cardBean.nameOnCard}" maxlength="100"/></td>

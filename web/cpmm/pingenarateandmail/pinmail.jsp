<%-- 
    Document   : pinmail
    Created on : May 9, 2012, 11:37:05 AM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcardembossingform.action="${pageContext.request.contextPath}/SearchPinMailServlet";
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadPinMailServlet";
            ...
            function pinMail(cardNo)
            {
                ...
                window.location = "${pageContext.request.contextPath}/GeneratePinMailServlet?cardNo="+cardNo;

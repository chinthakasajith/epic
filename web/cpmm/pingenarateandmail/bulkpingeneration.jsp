<%-- 
    Document   : bulkpingeneration
    Created on : Sep 19, 2012, 9:27:07 AM
    Author     : mahesh_m
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function invokeSearch()
            {
                ...
                document.searchcardembossingform.action="${pageContext.request.contextPath}/SearchBulkPingenerationServlet";
            ...
            function getProductByType(value)
            {
                ...
                document.searchcardembossingform.action="${pageContext.request.contextPath}/GetCardProductByTypeBulkPinGen?cardtype="+value;
                document.searchcardembossingform.submit();
            ...
            function invokeReset()
            {
                ...
                window.location = "${pageContext.request.contextPath}/LoadBulkPinGenerationServlet";

            }
            
        
            function pinGenerate(batchNo)
            {
             
                window.location = "${pageContext.request.contextPath}/generateBulkPinServlet?batchNo="+batchNo;
        ...
        <script>
            function settitle(){
                ...
                { pagecode:'<%= PageVarList.BULK_PIN_GENERATION%>'                                  
                },
                function(data) {
...
<!--                                <table class="tit"> <tr> <td   class="center"> <B> PIN GENERATION DETAILS </B></td> </tr><tr> <td>&nbsp;</td> </tr></table>-->
                                        ...
                                        <tbody>
                                             <c:forEach var="pin" items="${searchList}">
                                                <tr>
                                                    ...
                                                    <td  >
                                                         <input type="button" name="pinGenarate" value="Generate" onclick="pinGenerate('${pin.batchId}')"/>

<%-- 
    Document   : createmerchantlocation
    Created on : May 11, 2012, 9:52:25 AM
    Author     : nalin
--%>
...
<html>
    <head>
        ...
        <script >
            ...
            function loadRedemPoint(){
                $('#redempoint').empty();
                var sval=$("#selectMerchantCus").val();
                $.getJSON("${pageContext.servletContext.contextPath}/SetRedemPointValueServlet", 
                { selectMerchantCus : sval},
                function(jsonobject) {
                        $('#redempoint').val(jsonobject.combo1);
                });
            }
                                    ...
                                    <form name="createform" method="post" action="">
                                        ...
                                        <div class="selector" id="tabs">
                                            ...
                                            <div id="tabs-1" >
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="merchantId"  maxlength="15" value="${merchantLocBean.merchantId}" <c:if  test="${readOnly=='true'}"> readonly="readonly" </c:if> <c:if  test="${readOnly!='true'}"></c:if>></td>

                                                        <td style="width: 200px;">Area</td>

                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select  name="selectArea"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select name="selectCountry"  >
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select id="selectMerchantCus"  name="selectMerchantCustomerName" class="inputfield-mandatory" onchange="loadRedemPoint()" >
                                                                <option value="" selected>--SELECT--</option>
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select name="selectTitle" value=""  >
                                                                <option value="" selected >--SELECT--</option>
                                                        ...
                                                        <td style="width: 200px;">TP Number</td>
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select name="selectFeeProfile"  >
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;">Commission Profile</td>
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select name="selectCommisionProfile"  >
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px;"><font style="color: red;">*</font>&nbsp;<select  name="selectRiskProfile"  >
                                                                <option value="" selected>--SELECT--</option>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Statement Cycle</td> 

                                                        <td><font style="color: red;">*</font>&nbsp;<select name="selectStatementCycle"  >
                                                                <option value="" selected>--SELECT--</option>
                                                        ...
                                                        <td style="width: 200px;">Generate Statement</td> 

                                                        <td><font style="color: red;">*</font>&nbsp;<select name="statementStatus"  >
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Payment Cycle</td> 

                                                        <td><font style="color: red;">*</font>&nbsp;<select  name="selectPaymentCycle"  >
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select  id="selectPaymentMode"  name="selectPaymentMode"  onchange="loadBank()">
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Redemption Point</td>
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="redempoint" id="redempoint"  maxlength="23" value="${merchantLocBean.redempoint}"></td> 
                                                    </tr>
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select   name="selectBank" id="selectBank" class="inputfield-mandatory" onchange="lordBranch()">
                                                                <option value="" selected>--SELECT--</option>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select  name="selectBankBranch" id="selectBankBranch" class="inputfield-mandatory">
                                                                <option value="" selected>--SELECT--</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="accountNumber"  maxlength="12" value="${merchantLocBean.accountNumber}"></td> 
                                                        <td style="width: 200px;">Account Type</td>
                                                        <td><font style="color: red;">*</font>&nbsp;<select   name="selectAccountType"  >
                                                                <option value="" selected>--SELECT--</option>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Manual Auth Allowed</td>
                                                        <td><font style="color: red;">*</font>&nbsp;<select  name="manualTxnStatus"  >

                                                                <option value="" selected>--SELECT--</option>
                                                                <c:if test="${merchantLocBean.manualTxnStatus=='YES'}">
                                                                    <option value="${'YES'}" selected="true" >YES</option>
                                                                </c:if>
                                                                <c:if test="${merchantLocBean.manualTxnStatus!='YES'}">
                                                                    <option value="${'YES'}">YES</option>
                                                                </c:if>
                                                                <c:if test="${merchantLocBean.manualTxnStatus=='NO'}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font style="color: red;">*</font>&nbsp;<select name="selectStates"  >
                                                                <option value="" selected>--SELECT--</option>
                                                ...
                                                <table>
                                                    ...
                                                    <tr celspacing="5">
                                                        ...
                                                        <td><input type="button" name="add"  style="width: 100px; height: 30px;" value="Save & Next" onclick="saveAndNext()">
                                                            <input type="button" name="reset"  style="width: 100px; height: 30px;" onclick="invokeReset('add')" value="Reset">
                                            ...
                                            <div id="tabs-2">
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <select name="merchantCategoryList" style="width: 200px"  id=in multiple="multiple"  size=10>
                                                                <c:forEach  var="merchant" items="${merchantCategoryList}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <select name="assignMerchantCategorylist" style="width: 200px" id=out multiple="multiple"   size=10>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    <tr>
                                                        <td><input type="button" name="add"  style="width: 100px; height: 30px;" onclick="selectAllMcc(assignMerchantCategorylist,assignTxnTypeList,assignCurrencyList)" value="Save">
                                        ...
                                        <div class="selector" id="tabs">
                                            ...
                                            <div id="tabs-1" >
                                                ...
                                                <table cellpadding="0" cellspacing="10"  >
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Merchant Customer Name</td>
                                                        <td><font style="color: red;">*</font>&nbsp;<select name="selectMerchantCustomerName" class="inputfield-mandatory" onchange="valueSet('${"UPDATE"}')" >
                                                                <option value="" selected>--SELECT--</option>
                                                                <c:forEach var="mcbl" items="${merchantCustomerList}">
                                                                    <c:if test="${merchantLocBean.merchantCustomerNumber==mcbl.merchantCustomerNumber}">
                                                                        <option value="${mcbl.merchantCustomerNumber}" selected="true" >${mcbl.merchantName}</option>
                                                ...
                                                <table cellpadding="0" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        <td style="width: 200px;">Redemption Point</td>
                                                        <td><font style="color: red;">*</font>&nbsp;<input type="text" name="redempoint"  maxlength="23" value="${merchantLocBean.redempoint}"></td> 
                                                    </tr>
